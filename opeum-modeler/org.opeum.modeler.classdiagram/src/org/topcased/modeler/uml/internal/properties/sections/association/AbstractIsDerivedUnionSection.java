...
import org.topcased.modeler.uml.internal.properties.sections.property.PropertyIsDerivedUnionSection;

/**
 * The section for the isDerivedUnion property of a Property associated with an Association Object.
 * 
 * Creation 26 févr. 07
 * 
 * @author <a href="mailto:jacques.lescot@anyware-tech.com">Jacques LESCOT</a>
 */
public abstract class AbstractIsDerivedUnionSection extends PropertyIsDerivedUnionSection
{
    /**
    ...
    {
        return getProperty((Association) getEObject()).isDerivedUnion();
    }
