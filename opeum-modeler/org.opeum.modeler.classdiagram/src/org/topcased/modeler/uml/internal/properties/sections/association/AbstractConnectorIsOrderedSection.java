/*****************************************************************************
 * 
 * AbstractConnectorIsOrderedSection.java
 * 
...
import org.topcased.modeler.uml.internal.properties.sections.multiplicityelement.MultiplicityElementIsOrderedSection;

/**
 * The section for the isOrdered property of a Property associated with a Connector Object.
 */
public abstract class AbstractConnectorIsOrderedSection extends MultiplicityElementIsOrderedSection
{
    /**
    ...
    protected boolean getFeatureValue()
    {
        if ((getEnd((Connector) getEObject())) != null)
        {
            ...
            return getEnd((Connector) getEObject()).isOrdered();
        }
        else
        {
