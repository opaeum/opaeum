...
import org.topcased.modeler.commands.ReconnectEdgeToSourceCommand;
...
import org.topcased.modeler.uml.alldiagram.commands.PackageMergeEdgeCreationCommand;
...
/**
 * PackageMerge edge creation <br>
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class PackageMergeEdgeCreationEditPolicy extends AbstractEdgeCreationEditPolicy
{
    /**
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    {
        return new PackageMergeEdgeCreationCommand(domain, edge, source);
    }
    ...
    {
        return Utils.getElement(edge) instanceof PackageMerge;
    }
    ...
    {
        return command instanceof PackageMergeEdgeCreationCommand;
    }
    ...
    protected SourceTargetData getSourceTargetData(GraphElement source, GraphElement target)
    {
        ...
        if (sourceObject instanceof org.eclipse.uml2.uml.Package && targetObject instanceof org.eclipse.uml2.uml.Package)
        {
            return new SourceTargetData(false, false, SourceTargetData.SOURCE, "org.eclipse.uml2.uml.Package", "packageMerge", "receivingPackage", "mergedPackage", null, null, null, null);
        }
        return null;
    }
    ...
    protected Command getReconnectSourceCommand(ReconnectRequest request)
    {
        ...
        if (connection instanceof PackageMergeEditPart)
        {
            final PackageMergeEditPart edit = (PackageMergeEditPart) connection;
            ...
            if (checkSource(newSource))
            {
                ...
                ReconnectEdgeToNodeCommand command = new ReconnectEdgeToSourceCommand(edit, "receivingPackage")
                {
    ...
    protected Command getReconnectTargetCommand(ReconnectRequest request)
    {
        ...
        if (connection instanceof PackageMergeEditPart)
        {
            ...
            {
                final GraphElement graphElt = (GraphElement) edit.getModel();
                ReconnectGraphEdgeCommand command = new ReconnectEdgeToTargetCommand(edit, "mergedPackage")
                {
                    protected EObject getObjectToUpdate()
                    {
                        return Utils.getElement(graphElt);
