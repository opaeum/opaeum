 ...
 * @generated
 */
public class SignalEventPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return ClassDiagramPreferenceConstants.SIGNALEVENT_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ClassDiagramPreferenceConstants.SIGNALEVENT_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ClassDiagramPreferenceConstants.SIGNALEVENT_DEFAULT_FOREGROUND_COLOR;
	}
