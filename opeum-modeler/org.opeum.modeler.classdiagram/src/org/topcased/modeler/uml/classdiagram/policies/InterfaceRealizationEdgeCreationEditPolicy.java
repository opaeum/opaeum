...
import org.topcased.modeler.uml.classdiagram.commands.InterfaceRealizationEdgeCreationCommand;
...
/**
 * InterfaceRealization edge creation <br>
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class InterfaceRealizationEdgeCreationEditPolicy extends AbstractEdgeCreationEditPolicy
{
    /**
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    {
        return Utils.getElement(edge) instanceof InterfaceRealization;
    }
    ...
    protected boolean checkTargetForSource(GraphElement source, GraphElement target)
    {
        ...
        if (sourceObject instanceof org.eclipse.uml2.uml.BehavioredClassifier && targetObject instanceof org.eclipse.uml2.uml.Interface)
        {
    ...
    {
        return command instanceof InterfaceRealizationEdgeCreationCommand;
    }
    ...
    protected SourceTargetData getSourceTargetData(GraphElement source, GraphElement target)
    {
        ...
        if (sourceObject instanceof org.eclipse.uml2.uml.BehavioredClassifier && targetObject instanceof org.eclipse.uml2.uml.Interface)
        {
            return new SourceTargetData(false, false, SourceTargetData.SOURCE, "org.eclipse.uml2.uml.BehavioredClassifier", "interfaceRealization", null, "contract", null, null, null, null);
        }
        return null;
    }
    ...
    protected Command getReconnectSourceCommand(ReconnectRequest request)
    {
        ...
        if (connection instanceof InterfaceRealizationEditPart)
        {
            final InterfaceRealizationEditPart edit = (InterfaceRealizationEditPart) connection;
            ...
            if (checkSource(newSource))
            {
                ...
                ReconnectGraphEdgeCommand command = new ReconnectSourceToEdgeCommand(edit, "interfaceRealization")
                {
    ...
    protected Command getReconnectTargetCommand(ReconnectRequest request)
    {
        ...
        if (connection instanceof InterfaceRealizationEditPart)
        {
            InterfaceRealizationEditPart edit = (InterfaceRealizationEditPart) connection;
            ...
            {
                final GraphElement graphElt = (GraphElement) edit.getModel();
                ReconnectEdgeToNodeCommand command = new ReconnectEdgeToTargetCommand(edit, "contract")
                {
                    protected EObject getObjectToUpdate()
                    {
                        return Utils.getElement(graphElt);
