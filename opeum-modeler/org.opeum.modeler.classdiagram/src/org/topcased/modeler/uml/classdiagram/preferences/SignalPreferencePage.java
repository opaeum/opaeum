 ...
 * @generated
 */
public class SignalPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return ClassDiagramPreferenceConstants.SIGNAL_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ClassDiagramPreferenceConstants.SIGNAL_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ClassDiagramPreferenceConstants.SIGNAL_DEFAULT_FOREGROUND_COLOR;
	}
