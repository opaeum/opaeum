...
import org.topcased.modeler.uml.classdiagram.figures.InterfaceRealizationFigure;
import org.topcased.modeler.uml.classdiagram.preferences.ClassDiagramPreferenceConstants;
import org.topcased.modeler.utils.Utils;

/**
 * InterfaceRealization controller <br>
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class InterfaceRealizationEditPart extends EMFGraphEdgeEditPart
{
     ...
     * @generated
     */
    public InterfaceRealizationEditPart(GraphEdge model)
    {
        super(model);
    }
    ...
    {
        InterfaceRealizationFigure connection = new InterfaceRealizationFigure();
    ...
    public IEdgeObjectFigure getEdgeObjectFigure(EdgeObject edgeObject)
    {
        ...
        {
            return ((InterfaceRealizationFigure) getFigure()).getStereotypeEdgeObjectFigure();
        }
        return null;
    }
    ...
    {
        ((Label) ((InterfaceRealizationFigure) getFigure()).getStereotypeEdgeObjectFigure()).setText(UMLLabel.getStereotypesNotation((Element) getEObject(), getPreferenceStore()));
    }
    ...
    {
        return getPreferenceStore().getString(ClassDiagramPreferenceConstants.INTERFACEREALIZATION_EDGE_DEFAULT_ROUTER);
    }
    ...
    {
        String preferenceForeground = getPreferenceStore().getString(ClassDiagramPreferenceConstants.INTERFACEREALIZATION_EDGE_DEFAULT_FOREGROUND_COLOR);
    ...
    {
        String preferenceFont = getPreferenceStore().getString(ClassDiagramPreferenceConstants.INTERFACEREALIZATION_EDGE_DEFAULT_FONT);
