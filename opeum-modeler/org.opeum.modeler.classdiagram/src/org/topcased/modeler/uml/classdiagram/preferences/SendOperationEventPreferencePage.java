 ...
 * @generated
 */
public class SendOperationEventPreferencePage extends
	...
	protected String getNodeBackgroundColor() {
		return ClassDiagramPreferenceConstants.SENDOPERATIONEVENT_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ClassDiagramPreferenceConstants.SENDOPERATIONEVENT_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ClassDiagramPreferenceConstants.SENDOPERATIONEVENT_DEFAULT_FOREGROUND_COLOR;
	}
