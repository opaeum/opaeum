...
import org.topcased.modeler.uml.usecasediagram.commands.IncludeEdgeCreationCommand;
...
public class IncludeEdgeCreationEditPolicy extends AbstractEdgeCreationEditPolicy
{
    ...
    {
        return Utils.getElement(edge) instanceof Include;
    }
    ...
    protected SourceTargetData getSourceTargetData(GraphElement source, GraphElement target)
    {
        ...
        if (sourceObject instanceof org.eclipse.uml2.uml.UseCase && targetObject instanceof org.eclipse.uml2.uml.UseCase)
        {
            return new SourceTargetData(false, false, SourceTargetData.SOURCE, "org.eclipse.uml2.uml.UseCase", "include", null, "addition", null, null, null, null);
        }
        return null;
    }
    ...
    protected Command getReconnectSourceCommand(ReconnectRequest request)
    {
        ...
        if (connection instanceof IncludeEditPart)
        {
            final IncludeEditPart edit = (IncludeEditPart) connection;
            ...
            if (checkSource(newSource))
            {
                ...
                ReconnectGraphEdgeCommand command = new ReconnectSourceToEdgeCommand(edit, "include")
                {
    ...
    protected Command getReconnectTargetCommand(ReconnectRequest request)
    {
        ...
        if (connection instanceof IncludeEditPart)
        {
            ...
            {
                final GraphElement graphElt = (GraphElement) edit.getModel();
                ReconnectGraphEdgeCommand command = new ReconnectEdgeToTargetCommand(edit, "addition")
                {
                    protected EObject getObjectToUpdate()
                    {
                        return Utils.getElement(graphElt);
