 ...
 * @generated
 */
public class ExtendPreferencePage extends AbstractEdgePreferencePage
{
    /**
    ...
    {
        return UseCaseDiagramPreferenceConstants.EXTEND_EDGE_DEFAULT_FONT;
    }
    ...
    {
        return UseCaseDiagramPreferenceConstants.EXTEND_EDGE_DEFAULT_FOREGROUND_COLOR;
    }
    ...
    {
        return UseCaseDiagramPreferenceConstants.EXTEND_EDGE_DEFAULT_ROUTER;
    }
    ...
    protected List<String> getHiddenElements()
    {
        ...
        if (!ps.getBoolean(UseCaseDiagramPreferenceConstants.EXTEND_NAME_EDGE_OBJECT_DEFAULT_VISIBILITY))
        {
            choiceOfValues.add(UseCaseEdgeObjectConstants.NAME_EDGE_OBJECT_ID);
        }
        if (!ps.getBoolean(UseCaseDiagramPreferenceConstants.EXTEND_EXTENSION_EDGE_OBJECT_DEFAULT_VISIBILITY))
        {
            choiceOfValues.add(UseCaseEdgeObjectConstants.EXTENSION_EDGE_OBJECT_ID);
        }
    ...
    protected List<String> getDefaultHiddenElements()
    {
        List<String> choiceOfValues = new ArrayList<String>();
        IPreferenceStore ps = getPreferenceStore();
        if (!ps.getDefaultBoolean(UseCaseDiagramPreferenceConstants.EXTEND_NAME_EDGE_OBJECT_DEFAULT_VISIBILITY))
        {
            choiceOfValues.add(UseCaseEdgeObjectConstants.NAME_EDGE_OBJECT_ID);
        }
        if (!ps.getDefaultBoolean(UseCaseDiagramPreferenceConstants.EXTEND_EXTENSION_EDGE_OBJECT_DEFAULT_VISIBILITY))
        {
            choiceOfValues.add(UseCaseEdgeObjectConstants.EXTENSION_EDGE_OBJECT_ID);
        }
        return choiceOfValues;
    ...
    protected void storeEdgeObjectVisibility(List<String> visibleElement)
    {
        ...
        {
            ps.setValue(UseCaseDiagramPreferenceConstants.EXTEND_NAME_EDGE_OBJECT_DEFAULT_VISIBILITY, true);
        }
        else
        {
            ps.setValue(UseCaseDiagramPreferenceConstants.EXTEND_NAME_EDGE_OBJECT_DEFAULT_VISIBILITY, false);
        }
        if (visibleElement.contains(UseCaseEdgeObjectConstants.EXTENSION_EDGE_OBJECT_ID))
        {
            ps.setValue(UseCaseDiagramPreferenceConstants.EXTEND_EXTENSION_EDGE_OBJECT_DEFAULT_VISIBILITY, true);
        }
        else
        {
            ps.setValue(UseCaseDiagramPreferenceConstants.EXTEND_EXTENSION_EDGE_OBJECT_DEFAULT_VISIBILITY, false);
        }
    }
