...
public class GeneralizationPreferencePage extends AbstractEdgePreferencePage
{
    ...
    {
        return UseCaseDiagramPreferenceConstants.GENERALIZATION_EDGE_DEFAULT_FONT;
    }
    ...
    {
        return UseCaseDiagramPreferenceConstants.GENERALIZATION_EDGE_DEFAULT_FOREGROUND_COLOR;
    }
    ...
    {
        return UseCaseDiagramPreferenceConstants.GENERALIZATION_EDGE_DEFAULT_ROUTER;
    }
    ...
    protected List<String> getHiddenElements()
    {
        ...
        if (!ps.getBoolean(UseCaseDiagramPreferenceConstants.GENERALIZATION_STEREOTYPE_EDGE_OBJECT_DEFAULT_VISIBILITY))
        {
    ...
    protected List<String> getDefaultHiddenElements()
    {
        List<String> choiceOfValues = new ArrayList<String>();
        IPreferenceStore ps = getPreferenceStore();
        if (!ps.getDefaultBoolean(UseCaseDiagramPreferenceConstants.GENERALIZATION_STEREOTYPE_EDGE_OBJECT_DEFAULT_VISIBILITY))
        {
            choiceOfValues.add(UseCaseEdgeObjectConstants.STEREOTYPE_EDGE_OBJECT_ID);
        }
        return choiceOfValues;
    ...
    protected void storeEdgeObjectVisibility(List<String> visibleElement)
    {
        ...
        {
            ps.setValue(UseCaseDiagramPreferenceConstants.GENERALIZATION_STEREOTYPE_EDGE_OBJECT_DEFAULT_VISIBILITY, true);
        }
        else
        {
            ps.setValue(UseCaseDiagramPreferenceConstants.GENERALIZATION_STEREOTYPE_EDGE_OBJECT_DEFAULT_VISIBILITY, false);
        }
    }
