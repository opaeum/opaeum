...
public class JsfListBooleanPrimeColumnBuilder implements IJsfPropertyFieldPrimeColumnBuilder {

	private static final String ATTRIBUTES_THAT_ARE_SET_KEY = UIComponentBase.class.getName() + ".attributesThatAreSet";
	private PropertyField pf;
	private ClassifierUserInteraction ui;

	public JsfListBooleanPrimeColumnBuilder(ClassifierUserInteraction ui, PropertyField pf) {
		super();
		this.ui = ui;
		this.pf = pf;
	}
