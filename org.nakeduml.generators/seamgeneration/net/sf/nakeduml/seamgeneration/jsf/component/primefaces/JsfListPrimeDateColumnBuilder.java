...
public class JsfListPrimeDateColumnBuilder implements IJsfPropertyFieldPrimeColumnBuilder {

	private static final String ATTRIBUTES_THAT_ARE_SET_KEY = UIComponentBase.class.getName() + ".attributesThatAreSet";
	private PropertyField pf;
	private ClassifierUserInteraction ui;

	public JsfListPrimeDateColumnBuilder(ClassifierUserInteraction dc, PropertyField pf) {
		super();
		this.ui = dc;
		this.pf = pf;
	}
	...
	public Column createColumn() {
		...
		setSettedAttributes(column, "width", "resizable");
