...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Query Invocation Editor</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.opaeum.uim.editor.impl.QueryInvocationEditorImpl#getLinkedUmlResource <em>Linked Uml Resource</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class QueryInvocationEditorImpl extends AbstractEditorImpl implements QueryInvocationEditor {
	/**
	 ...
	 * @generated
	 */
	protected QueryInvocationEditorImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EditorPackage.Literals.QUERY_INVOCATION_EDITOR;
	}
	...
	public void setLinkedUmlResource(String newLinkedUmlResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EditorPackage.QUERY_INVOCATION_EDITOR__LINKED_UML_RESOURCE, oldLinkedUmlResource, linkedUmlResource));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EditorPackage.QUERY_INVOCATION_EDITOR__LINKED_UML_RESOURCE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == UimRootElement.class) {
			switch (derivedFeatureID) {
				case EditorPackage.QUERY_INVOCATION_EDITOR__LINKED_UML_RESOURCE: return UimPackage.UIM_ROOT_ELEMENT__LINKED_UML_RESOURCE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == UimRootElement.class) {
			switch (baseFeatureID) {
				case UimPackage.UIM_ROOT_ELEMENT__LINKED_UML_RESOURCE: return EditorPackage.QUERY_INVOCATION_EDITOR__LINKED_UML_RESOURCE;
				default: return -1;
			}
		}
