...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Uim List Box</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.opaeum.uim.control.impl.UimListBoxImpl#getRows <em>Rows</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class UimListBoxImpl extends UimLookupImpl implements UimListBox {
	/**
	...
	protected EClass eStaticClass() {
		return ControlPackage.Literals.UIM_LIST_BOX;
	}
	...
	public void setRows(Integer newRows) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ControlPackage.UIM_LIST_BOX__ROWS, oldRows, rows));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ControlPackage.UIM_LIST_BOX__ROWS:
				return getRows();
		}
