...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Uim Link</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.opaeum.uim.action.impl.UimLinkImpl#getPreferredWidth <em>Preferred Width</em>}</li>
 *   <li>{@link org.opaeum.uim.action.impl.UimLinkImpl#getPreferredHeight <em>Preferred Height</em>}</li>
 *   <li>{@link org.opaeum.uim.action.impl.UimLinkImpl#getFillHorizontally <em>Fill Horizontally</em>}</li>
 *   <li>{@link org.opaeum.uim.action.impl.UimLinkImpl#getFillVertically <em>Fill Vertically</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class UimLinkImpl extends UimComponentImpl implements UimLink {
	...
	protected EClass eStaticClass() {
		return ActionPackage.Literals.UIM_LINK;
	}
	...
	public void setPreferredWidth(Integer newPreferredWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionPackage.UIM_LINK__PREFERRED_WIDTH, oldPreferredWidth, preferredWidth));
	}
	...
	public void setPreferredHeight(Integer newPreferredHeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionPackage.UIM_LINK__PREFERRED_HEIGHT, oldPreferredHeight, preferredHeight));
	}
	...
	public void setFillHorizontally(Boolean newFillHorizontally) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionPackage.UIM_LINK__FILL_HORIZONTALLY, oldFillHorizontally, fillHorizontally));
	}
	...
	public void setFillVertically(Boolean newFillVertically) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionPackage.UIM_LINK__FILL_VERTICALLY, oldFillVertically, fillVertically));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Outlayable.class) {
			switch (derivedFeatureID) {
				case ActionPackage.UIM_LINK__PREFERRED_WIDTH: return PanelPackage.OUTLAYABLE__PREFERRED_WIDTH;
				case ActionPackage.UIM_LINK__PREFERRED_HEIGHT: return PanelPackage.OUTLAYABLE__PREFERRED_HEIGHT;
				case ActionPackage.UIM_LINK__FILL_HORIZONTALLY: return PanelPackage.OUTLAYABLE__FILL_HORIZONTALLY;
				case ActionPackage.UIM_LINK__FILL_VERTICALLY: return PanelPackage.OUTLAYABLE__FILL_VERTICALLY;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Outlayable.class) {
			switch (baseFeatureID) {
				case PanelPackage.OUTLAYABLE__PREFERRED_WIDTH: return ActionPackage.UIM_LINK__PREFERRED_WIDTH;
				case PanelPackage.OUTLAYABLE__PREFERRED_HEIGHT: return ActionPackage.UIM_LINK__PREFERRED_HEIGHT;
				case PanelPackage.OUTLAYABLE__FILL_HORIZONTALLY: return ActionPackage.UIM_LINK__FILL_HORIZONTALLY;
				case PanelPackage.OUTLAYABLE__FILL_VERTICALLY: return ActionPackage.UIM_LINK__FILL_VERTICALLY;
				default: return -1;
			}
		}
