...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Uim Action</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.opaeum.uim.action.impl.UimActionImpl#getPreferredWidth <em>Preferred Width</em>}</li>
 *   <li>{@link org.opaeum.uim.action.impl.UimActionImpl#getPreferredHeight <em>Preferred Height</em>}</li>
 *   <li>{@link org.opaeum.uim.action.impl.UimActionImpl#getFillHorizontally <em>Fill Horizontally</em>}</li>
 *   <li>{@link org.opaeum.uim.action.impl.UimActionImpl#getFillVertically <em>Fill Vertically</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class UimActionImpl extends UimComponentImpl implements UimAction {
	/**
	...
	protected EClass eStaticClass() {
		return ActionPackage.Literals.UIM_ACTION;
	}
	...
	public void setPreferredWidth(Integer newPreferredWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionPackage.UIM_ACTION__PREFERRED_WIDTH, oldPreferredWidth, preferredWidth));
	}
	...
	public void setPreferredHeight(Integer newPreferredHeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionPackage.UIM_ACTION__PREFERRED_HEIGHT, oldPreferredHeight, preferredHeight));
	}
	...
	public void setFillHorizontally(Boolean newFillHorizontally) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionPackage.UIM_ACTION__FILL_HORIZONTALLY, oldFillHorizontally, fillHorizontally));
	}
	...
	public void setFillVertically(Boolean newFillVertically) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionPackage.UIM_ACTION__FILL_VERTICALLY, oldFillVertically, fillVertically));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActionPackage.UIM_ACTION__PREFERRED_WIDTH:
				return getPreferredWidth();
			case ActionPackage.UIM_ACTION__PREFERRED_HEIGHT:
				return getPreferredHeight();
			case ActionPackage.UIM_ACTION__FILL_HORIZONTALLY:
				return getFillHorizontally();
			case ActionPackage.UIM_ACTION__FILL_VERTICALLY:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Outlayable.class) {
			switch (derivedFeatureID) {
				case ActionPackage.UIM_ACTION__PREFERRED_WIDTH: return PanelPackage.OUTLAYABLE__PREFERRED_WIDTH;
				case ActionPackage.UIM_ACTION__PREFERRED_HEIGHT: return PanelPackage.OUTLAYABLE__PREFERRED_HEIGHT;
				case ActionPackage.UIM_ACTION__FILL_HORIZONTALLY: return PanelPackage.OUTLAYABLE__FILL_HORIZONTALLY;
				case ActionPackage.UIM_ACTION__FILL_VERTICALLY: return PanelPackage.OUTLAYABLE__FILL_VERTICALLY;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Outlayable.class) {
			switch (baseFeatureID) {
				case PanelPackage.OUTLAYABLE__PREFERRED_WIDTH: return ActionPackage.UIM_ACTION__PREFERRED_WIDTH;
				case PanelPackage.OUTLAYABLE__PREFERRED_HEIGHT: return ActionPackage.UIM_ACTION__PREFERRED_HEIGHT;
				case PanelPackage.OUTLAYABLE__FILL_HORIZONTALLY: return ActionPackage.UIM_ACTION__FILL_HORIZONTALLY;
				case PanelPackage.OUTLAYABLE__FILL_VERTICALLY: return ActionPackage.UIM_ACTION__FILL_VERTICALLY;
				default: return -1;
			}
		}
