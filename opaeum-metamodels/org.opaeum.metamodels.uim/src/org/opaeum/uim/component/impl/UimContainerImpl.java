...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Uim Container</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.opaeum.uim.component.impl.UimContainerImpl#getEditability <em>Editability</em>}</li>
 *   <li>{@link org.opaeum.uim.component.impl.UimContainerImpl#getChildren <em>Children</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class UimContainerImpl extends UimComponentImpl implements UimContainer {
	...
	protected EClass eStaticClass() {
		return ComponentPackage.Literals.UIM_CONTAINER;
	}
	...
	public NotificationChain basicSetEditability(UserInteractionConstraint newEditability, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ComponentPackage.UIM_CONTAINER__EDITABILITY, oldEditability, newEditability);
	...
	public void setEditability(UserInteractionConstraint newEditability) {
		if (newEditability != editability) {
			...
			if (editability != null)
				msgs = ((InternalEObject)editability).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ComponentPackage.UIM_CONTAINER__EDITABILITY, null, msgs);
			if (newEditability != null)
				msgs = ((InternalEObject)newEditability).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ComponentPackage.UIM_CONTAINER__EDITABILITY, null, msgs);
			msgs = basicSetEditability(newEditability, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentPackage.UIM_CONTAINER__EDITABILITY, newEditability, newEditability));
	}
	...
	public EList<UimComponent> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<UimComponent>(UimComponent.class, this, ComponentPackage.UIM_CONTAINER__CHILDREN);
		}
		return children;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == EditableConstrainedObject.class) {
			switch (derivedFeatureID) {
				case ComponentPackage.UIM_CONTAINER__EDITABILITY: return ConstraintPackage.EDITABLE_CONSTRAINED_OBJECT__EDITABILITY;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == EditableConstrainedObject.class) {
			switch (baseFeatureID) {
				case ConstraintPackage.EDITABLE_CONSTRAINED_OBJECT__EDITABILITY: return ComponentPackage.UIM_CONTAINER__EDITABILITY;
				default: return -1;
			}
		}
