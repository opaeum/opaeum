...
import org.opaeum.uim.impl.UserInterfaceEntryPointImpl;
 ...
 * <ul>
 *   <li>{@link org.opaeum.uim.wizard.impl.AbstractWizardImpl#getUmlElementUid <em>Uml Element Uid</em>}</li>
 ...
 * @generated
 */
public abstract class AbstractWizardImpl extends UserInterfaceEntryPointImpl implements AbstractWizard {
	/**
	...
	public void setUmlElementUid(String newUmlElementUid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WizardPackage.ABSTRACT_WIZARD__UML_ELEMENT_UID, oldUmlElementUid, umlElementUid));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == UmlReference.class) {
			switch (derivedFeatureID) {
				case WizardPackage.ABSTRACT_WIZARD__UML_ELEMENT_UID: return UimPackage.UML_REFERENCE__UML_ELEMENT_UID;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == UmlReference.class) {
			switch (baseFeatureID) {
				case UimPackage.UML_REFERENCE__UML_ELEMENT_UID: return WizardPackage.ABSTRACT_WIZARD__UML_ELEMENT_UID;
				default: return -1;
			}
		}
