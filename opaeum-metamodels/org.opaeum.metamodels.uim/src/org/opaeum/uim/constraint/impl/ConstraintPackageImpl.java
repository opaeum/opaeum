...
public class ConstraintPackageImpl extends EPackageImpl implements ConstraintPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getRootUserInteractionConstraint_RequiresGroupOwnership(), theEcorePackage.getEBoolean(), "requiresGroupOwnership", "true", 0, 1, RootUserInteractionConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRootUserInteractionConstraint_RequiresOwnership(), theEcorePackage.getEBoolean(), "requiresOwnership", "false", 0, 1, RootUserInteractionConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRootUserInteractionConstraint_OpenToPublic(), ecorePackage.getEBooleanObject(), "openToPublic", "false", 0, 1, RootUserInteractionConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
