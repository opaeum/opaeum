...
public class StereotypeNames{
	...
	public static final String FACES_TYPE = "FacesType";
	public static final String MODEL = "Model";
	public static final String NUMERIC_TYPE = "NumericType";
	public static final String PACKAGE = "Package";
	public static final String PROFILE = "Profile";
	public static final String PARAMETER = "Parameter";
	public static final String POWER_TYPE_INSANCE = "PowerTypeInstance";
	public static final String PRIMITIVE = "Primitive";
	public static final String ASSOCIATION_END = "AssociationEnd";
	public static final String ATTRIBUTE = "Attribute";
	public static final String SIGNAL = "Signal";
	public static final String STRUCTURED_DATA_TYPE = "StructuredDataType";
	public static final String VALUE_TYPE = "ValueType";
	public static final String TIME_EVENT = "TimeEvent";
	public static final String LOOP_INPUT_COLLECTION = "LoopInputCollection";
	public static final String LOOP_OUTPUT_COLLECTION = "LoopOutputCollection";
	...
	public static String SECURITY_ON_EDIT = "SecurityOnEdit";
