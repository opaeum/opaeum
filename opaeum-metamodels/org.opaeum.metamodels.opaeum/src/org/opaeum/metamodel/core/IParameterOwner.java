...
public interface IParameterOwner extends PreAndPostConstrained,INakedElement/*,IOperation*/{
	 ...
	 */
	List<INakedParameter> getOwnedParameters();
	/**
	 ...
	 * parameters
	 */
	List<INakedParameter> getArgumentParameters();
	/**
	 ...
	 */
	List<INakedParameter> getExceptionParameters();
	/**
	 ...
	 */
	List<INakedParameter> getResultParameters();
	/**
