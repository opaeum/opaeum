 ...
 * <ul>
 *   <li>{@link org.drools.drools._5._0.process.impl.ImportsTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.drools.drools._5._0.process.impl.ImportsTypeImpl#getImport <em>Import</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ImportsTypeImpl extends EObjectImpl implements ImportsType {
	...
	protected EClass eStaticClass() {
		return ProcessPackage.Literals.IMPORTS_TYPE;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, ProcessPackage.IMPORTS_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<ImportType> getImport() {
		return getGroup().list(ProcessPackage.Literals.IMPORTS_TYPE__IMPORT);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ProcessPackage.IMPORTS_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case ProcessPackage.IMPORTS_TYPE__IMPORT:
