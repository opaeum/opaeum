...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Value Type Literal</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.opaeum.metamodels.simulation.simulation.impl.ValueTypeLiteralImpl#getStringValue <em>String Value</em>}</li>
 *   <li>{@link org.opaeum.metamodels.simulation.simulation.impl.ValueTypeLiteralImpl#getRuntimeStrategyFactory <em>Runtime Strategy Factory</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ValueTypeLiteralImpl extends LiteralStringImpl implements LiteralSimpleType {
	/**
	 ...
	 * @generated
	 */
	protected ValueTypeLiteralImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SimulationPackage.Literals.VALUE_TYPE_LITERAL;
	}
	...
	public void setStringValue(String newStringValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.VALUE_TYPE_LITERAL__STRING_VALUE, oldStringValue, stringValue));
	}
	...
	public void setRuntimeStrategyFactory(String newRuntimeStrategyFactory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.VALUE_TYPE_LITERAL__RUNTIME_STRATEGY_FACTORY, oldRuntimeStrategyFactory, runtimeStrategyFactory));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SimulationPackage.VALUE_TYPE_LITERAL__STRING_VALUE:
				return getStringValue();
			case SimulationPackage.VALUE_TYPE_LITERAL__RUNTIME_STRATEGY_FACTORY:
