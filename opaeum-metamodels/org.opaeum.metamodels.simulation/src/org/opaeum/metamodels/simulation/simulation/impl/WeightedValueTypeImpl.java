...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Weighted Value Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.opaeum.metamodels.simulation.simulation.impl.WeightedValueTypeImpl#getStringValue <em>String Value</em>}</li>
 *   <li>{@link org.opaeum.metamodels.simulation.simulation.impl.WeightedValueTypeImpl#getWeight <em>Weight</em>}</li>
 *   <li>{@link org.opaeum.metamodels.simulation.simulation.impl.WeightedValueTypeImpl#getRuntimeStrategyFactory <em>Runtime Strategy Factory</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class WeightedValueTypeImpl extends SimulatedValueImpl implements WeightedSimpleTypeValue {
	/**
	 ...
	 * @generated
	 */
	protected WeightedValueTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SimulationPackage.Literals.WEIGHTED_VALUE_TYPE;
	}
	...
	public void setStringValue(String newStringValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.WEIGHTED_VALUE_TYPE__STRING_VALUE, oldStringValue, stringValue));
	}
	...
	public void setWeight(Double newWeight) {
		...
		weight = newWeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.WEIGHTED_VALUE_TYPE__WEIGHT, oldWeight, weight));
	}
	...
	public void setRuntimeStrategyFactory(String newRuntimeStrategyFactory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.WEIGHTED_VALUE_TYPE__RUNTIME_STRATEGY_FACTORY, oldRuntimeStrategyFactory, runtimeStrategyFactory));
	}
