...
public class JsfBodySource extends AbstractJsfSource {
	...
	public JsfBodySource(UIViewRoot uiViewRoot, int depthFromRoot, Properties namespaceProperties) {
	...
	protected void startComposition() {
		...
		stringBuilder.append("    xmlns:fn=\"http://java.sun.com/jsp/jstl/functions\"\n");
