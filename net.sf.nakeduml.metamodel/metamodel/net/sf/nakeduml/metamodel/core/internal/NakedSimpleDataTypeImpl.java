...
/**
 * A simple data type, i.e. a data type that can not be broken down into smaller
 * bits like attributes. See ValueType and Primitive Typically it would be
 * represented in one column in the database. It would be represented in one
 * UIInput in JSF
 * 
 */
public abstract class NakedSimpleDataTypeImpl extends NakedClassifierImpl implements INakedSimpleType {
	...
	private AbstractStrategyFactory strategies=new AbstractStrategyFactory() {
	};
