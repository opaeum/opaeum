 ...
 * <ul>
 *   <li>{@link org.drools.drools._5._0.process.impl.VariablesTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.drools.drools._5._0.process.impl.VariablesTypeImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariablesTypeImpl extends EObjectImpl implements VariablesType {
	...
	protected EClass eStaticClass() {
		return ProcessPackage.Literals.VARIABLES_TYPE;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, ProcessPackage.VARIABLES_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<VariableType> getVariable() {
		return getGroup().list(ProcessPackage.Literals.VARIABLES_TYPE__VARIABLE);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ProcessPackage.VARIABLES_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case ProcessPackage.VARIABLES_TYPE__VARIABLE:
