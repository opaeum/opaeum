 ...
 * <ul>
 *   <li>{@link org.drools.drools._5._0.process.impl.ImportTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ImportTypeImpl extends EObjectImpl implements ImportType {
	...
	protected EClass eStaticClass() {
		return ProcessPackage.Literals.IMPORT_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.IMPORT_TYPE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ProcessPackage.IMPORT_TYPE__NAME:
				return getName();
		}
