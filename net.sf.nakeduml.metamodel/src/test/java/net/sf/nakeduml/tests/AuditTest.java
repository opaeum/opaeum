...
public class AuditTest extends net.sf.nakeduml.pomgeneration.AbstractMavenProjectProcess {
	...
	public static void transform(Class<? extends TransformationStep>... classes) throws Exception, IOException, FileNotFoundException {
		transform("../nakedumltest/audittests", "testmodels/AuditTests.uml", false, classes);
	}
