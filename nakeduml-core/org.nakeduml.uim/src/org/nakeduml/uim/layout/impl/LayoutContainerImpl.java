...
import org.nakeduml.uim.impl.UimContainerImpl;
 ...
 * <ul>
 *   <li>{@link org.nakeduml.uim.layout.impl.LayoutContainerImpl#getLayout <em>Layout</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class LayoutContainerImpl extends UimContainerImpl implements LayoutContainer {
	...
	protected EClass eStaticClass() {
		return LayoutPackage.Literals.LAYOUT_CONTAINER;
	}
	...
	public NotificationChain basicSetLayout(UimLayout newLayout, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LayoutPackage.LAYOUT_CONTAINER__LAYOUT, oldLayout, newLayout);
	...
	public void setLayout(UimLayout newLayout) {
		if (newLayout != layout) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, LayoutPackage.LAYOUT_CONTAINER__LAYOUT, newLayout, newLayout));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LayoutPackage.LAYOUT_CONTAINER__LAYOUT:
				if (layout != null)
					msgs = ((InternalEObject)layout).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LayoutPackage.LAYOUT_CONTAINER__LAYOUT, null, msgs);
