 ...
 * <ul>
 *   <li>{@link org.nakeduml.uim.impl.FormPanelImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.nakeduml.uim.impl.FormPanelImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link org.nakeduml.uim.impl.FormPanelImpl#getEditability <em>Editability</em>}</li>
 *   <li>{@link org.nakeduml.uim.impl.FormPanelImpl#getLayout <em>Layout</em>}</li>
...
public class FormPanelImpl extends UmlReferenceImpl implements FormPanel {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UimPackage.FORM_PANEL__NAME, oldName, name));
	}
	...
	public NotificationChain basicSetVisibility(SecurityConstraint newVisibility, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UimPackage.FORM_PANEL__VISIBILITY, oldVisibility, newVisibility);
	...
	public void setVisibility(SecurityConstraint newVisibility) {
		if (newVisibility != visibility) {
			...
			if (visibility != null)
				msgs = ((InternalEObject)visibility).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UimPackage.FORM_PANEL__VISIBILITY, null, msgs);
			if (newVisibility != null)
				msgs = ((InternalEObject)newVisibility).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UimPackage.FORM_PANEL__VISIBILITY, null, msgs);
			msgs = basicSetVisibility(newVisibility, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UimPackage.FORM_PANEL__VISIBILITY, newVisibility, newVisibility));
	}
	...
	public NotificationChain basicSetEditability(SecurityConstraint newEditability, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UimPackage.FORM_PANEL__EDITABILITY, oldEditability, newEditability);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEditability(SecurityConstraint newEditability) {
		if (newEditability != editability) {
			NotificationChain msgs = null;
			if (editability != null)
				msgs = ((InternalEObject)editability).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UimPackage.FORM_PANEL__EDITABILITY, null, msgs);
			if (newEditability != null)
				msgs = ((InternalEObject)newEditability).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UimPackage.FORM_PANEL__EDITABILITY, null, msgs);
			msgs = basicSetEditability(newEditability, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UimPackage.FORM_PANEL__EDITABILITY, newEditability, newEditability));
	}
	...
	public NotificationChain basicSetLayout(UimLayout newLayout, NotificationChain msgs) {
		...
		layout = newLayout;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UimPackage.FORM_PANEL__LAYOUT, oldLayout, newLayout);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLayout(UimLayout newLayout) {
		if (newLayout != layout) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, UimPackage.FORM_PANEL__LAYOUT, newLayout, newLayout));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UimPackage.FORM_PANEL__LAYOUT:
				if (layout != null)
					msgs = ((InternalEObject)layout).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UimPackage.FORM_PANEL__LAYOUT, null, msgs);
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == UserInteractionElement.class) {
			switch (derivedFeatureID) {
				case UimPackage.FORM_PANEL__NAME: return UimPackage.USER_INTERACTION_ELEMENT__NAME;
				default: return -1;
			}
		}
		if (baseClass == SecureObject.class) {
			switch (derivedFeatureID) {
				case UimPackage.FORM_PANEL__VISIBILITY: return UimPackage.SECURE_OBJECT__VISIBILITY;
				default: return -1;
			}
		}
		...
		if (baseClass == EditableSecureObject.class) {
			switch (derivedFeatureID) {
				case UimPackage.FORM_PANEL__EDITABILITY: return UimPackage.EDITABLE_SECURE_OBJECT__EDITABILITY;
				default: return -1;
			}
		}
		...
		if (baseClass == LayoutContainer.class) {
			switch (derivedFeatureID) {
				case UimPackage.FORM_PANEL__LAYOUT: return UimPackage.LAYOUT_CONTAINER__LAYOUT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == UserInteractionElement.class) {
			switch (baseFeatureID) {
				case UimPackage.USER_INTERACTION_ELEMENT__NAME: return UimPackage.FORM_PANEL__NAME;
				default: return -1;
			}
		}
		if (baseClass == SecureObject.class) {
			switch (baseFeatureID) {
				case UimPackage.SECURE_OBJECT__VISIBILITY: return UimPackage.FORM_PANEL__VISIBILITY;
				default: return -1;
			}
		}
		if (baseClass == UimComponent.class) {
		...
		if (baseClass == EditableSecureObject.class) {
			switch (baseFeatureID) {
				case UimPackage.EDITABLE_SECURE_OBJECT__EDITABILITY: return UimPackage.FORM_PANEL__EDITABILITY;
				default: return -1;
			}
		}
		if (baseClass == UimContainer.class) {
		...
		if (baseClass == LayoutContainer.class) {
			switch (baseFeatureID) {
				case UimPackage.LAYOUT_CONTAINER__LAYOUT: return UimPackage.FORM_PANEL__LAYOUT;
				default: return -1;
			}
		}
