 ...
 * <ul>
 *   <li>{@link org.nakeduml.uim.impl.UimFormImpl#getPanel <em>Panel</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UimFormImpl extends UserInteractionElementImpl implements UimForm {
	...
	protected EClass eStaticClass() {
		return UimPackage.Literals.UIM_FORM;
	}
	...
	public NotificationChain basicSetPanel(FormPanel newPanel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UimPackage.UIM_FORM__PANEL, oldPanel, newPanel);
	...
	public void setPanel(FormPanel newPanel) {
		if (newPanel != panel) {
			...
			if (panel != null)
				msgs = ((InternalEObject)panel).eInverseRemove(this, UimPackage.FORM_PANEL__FORM, FormPanel.class, msgs);
			if (newPanel != null)
				msgs = ((InternalEObject)newPanel).eInverseAdd(this, UimPackage.FORM_PANEL__FORM, FormPanel.class, msgs);
			msgs = basicSetPanel(newPanel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UimPackage.UIM_FORM__PANEL, newPanel, newPanel));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UimPackage.UIM_FORM__PANEL:
				if (panel != null)
					msgs = ((InternalEObject)panel).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UimPackage.UIM_FORM__PANEL, null, msgs);
