 ...
 * <ul>
 *   <li>{@link org.nakeduml.uim.impl.OperationTaskFormImpl#getUmlElementUid <em>Uml Element Uid</em>}</li>
...
public class OperationTaskFormImpl extends UIMFormImpl implements OperationTaskForm {
	...
	public void setUmlElementUid(String newUmlElementUid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UIMPackage.OPERATION_TASK_FORM__UML_ELEMENT_UID, oldUmlElementUid, umlElementUid));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == UmlReference.class) {
			switch (derivedFeatureID) {
				case UIMPackage.OPERATION_TASK_FORM__UML_ELEMENT_UID: return UIMPackage.UML_REFERENCE__UML_ELEMENT_UID;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == UmlReference.class) {
			switch (baseFeatureID) {
				case UIMPackage.UML_REFERENCE__UML_ELEMENT_UID: return UIMPackage.OPERATION_TASK_FORM__UML_ELEMENT_UID;
				default: return -1;
			}
		}
