 ...
 * <ul>
 *   <li>{@link org.nakeduml.uim.impl.UimTextAreaImpl#getRows <em>Rows</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UimTextAreaImpl extends UimControlImpl implements UimTextArea {
	...
	protected EClass eStaticClass() {
		return UimPackage.Literals.UIM_TEXT_AREA;
	}
	...
	public void setRows(Integer newRows) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UimPackage.UIM_TEXT_AREA__ROWS, oldRows, rows));
	}
