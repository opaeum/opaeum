 ...
 * <ul>
 *   <li>{@link org.nakeduml.uim.impl.WorkspaceSecurityConstraintImpl#isRequiresGroupOwnership <em>Requires Group Ownership</em>}</li>
 *   <li>{@link org.nakeduml.uim.impl.WorkspaceSecurityConstraintImpl#isRequiresOwnership <em>Requires Ownership</em>}</li>
 *   <li>{@link org.nakeduml.uim.impl.WorkspaceSecurityConstraintImpl#getRequiredRoles <em>Required Roles</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WorkspaceSecurityConstraintImpl extends EObjectImpl implements WorkspaceSecurityConstraint {
	...
	protected EClass eStaticClass() {
		return UimPackage.Literals.WORKSPACE_SECURITY_CONSTRAINT;
	}
	...
	public void setRequiresGroupOwnership(boolean newRequiresGroupOwnership) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UimPackage.WORKSPACE_SECURITY_CONSTRAINT__REQUIRES_GROUP_OWNERSHIP, oldRequiresGroupOwnership, requiresGroupOwnership));
	}
	...
	public void setRequiresOwnership(boolean newRequiresOwnership) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UimPackage.WORKSPACE_SECURITY_CONSTRAINT__REQUIRES_OWNERSHIP, oldRequiresOwnership, requiresOwnership));
	}
	...
	public EList<RequiredRole> getRequiredRoles() {
		if (requiredRoles == null) {
			requiredRoles = new EObjectContainmentEList<RequiredRole>(RequiredRole.class, this, UimPackage.WORKSPACE_SECURITY_CONSTRAINT__REQUIRED_ROLES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UimPackage.WORKSPACE_SECURITY_CONSTRAINT__REQUIRED_ROLES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UimPackage.WORKSPACE_SECURITY_CONSTRAINT__REQUIRES_GROUP_OWNERSHIP:
				return isRequiresGroupOwnership();
			case UimPackage.WORKSPACE_SECURITY_CONSTRAINT__REQUIRES_OWNERSHIP:
