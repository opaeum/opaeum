 ...
 * <ul>
 *   <li>{@link org.nakeduml.uim.impl.SecurityConstraintImpl#isInheritFromParent <em>Inherit From Parent</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SecurityConstraintImpl extends WorkspaceSecurityConstraintImpl implements SecurityConstraint {
	/**
	...
	protected EClass eStaticClass() {
		return UimPackage.Literals.SECURITY_CONSTRAINT;
	}
	...
	public void setInheritFromParent(boolean newInheritFromParent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UimPackage.SECURITY_CONSTRAINT__INHERIT_FROM_PARENT, oldInheritFromParent, inheritFromParent));
	}
