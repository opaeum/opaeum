 ...
 * <ul>
 *   <li>{@link org.nakeduml.uim.impl.UserInteractionWorkspaceImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link org.nakeduml.uim.impl.UserInteractionWorkspaceImpl#getEditability <em>Editability</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UserInteractionWorkspaceImpl extends AbstractFolderImpl implements UserInteractionWorkspace {
	...
	protected EClass eStaticClass() {
		return UimPackage.Literals.USER_INTERACTION_WORKSPACE;
	}
	...
	public NotificationChain basicSetVisibility(WorkspaceSecurityConstraint newVisibility, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UimPackage.USER_INTERACTION_WORKSPACE__VISIBILITY, oldVisibility, newVisibility);
	...
	public void setVisibility(WorkspaceSecurityConstraint newVisibility) {
		if (newVisibility != visibility) {
			...
			if (visibility != null)
				msgs = ((InternalEObject)visibility).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UimPackage.USER_INTERACTION_WORKSPACE__VISIBILITY, null, msgs);
			if (newVisibility != null)
				msgs = ((InternalEObject)newVisibility).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UimPackage.USER_INTERACTION_WORKSPACE__VISIBILITY, null, msgs);
			msgs = basicSetVisibility(newVisibility, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UimPackage.USER_INTERACTION_WORKSPACE__VISIBILITY, newVisibility, newVisibility));
	}
	...
	public NotificationChain basicSetEditability(WorkspaceSecurityConstraint newEditability, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UimPackage.USER_INTERACTION_WORKSPACE__EDITABILITY, oldEditability, newEditability);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEditability(WorkspaceSecurityConstraint newEditability) {
		if (newEditability != editability) {
			NotificationChain msgs = null;
			if (editability != null)
				msgs = ((InternalEObject)editability).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UimPackage.USER_INTERACTION_WORKSPACE__EDITABILITY, null, msgs);
			if (newEditability != null)
				msgs = ((InternalEObject)newEditability).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UimPackage.USER_INTERACTION_WORKSPACE__EDITABILITY, null, msgs);
			msgs = basicSetEditability(newEditability, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UimPackage.USER_INTERACTION_WORKSPACE__EDITABILITY, newEditability, newEditability));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UimPackage.USER_INTERACTION_WORKSPACE__VISIBILITY:
				return basicSetVisibility(null, msgs);
			case UimPackage.USER_INTERACTION_WORKSPACE__EDITABILITY:
