 ...
 * <ul>
 *   <li>{@link org.nakeduml.uim.security.impl.SecurityConstraintImpl#isInheritFromParent <em>Inherit From Parent</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SecurityConstraintImpl extends WorkspaceSecurityConstraintImpl implements SecurityConstraint {
	...
	public void setInheritFromParent(boolean newInheritFromParent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SecurityPackage.SECURITY_CONSTRAINT__INHERIT_FROM_PARENT, oldInheritFromParent, inheritFromParent));
	}
