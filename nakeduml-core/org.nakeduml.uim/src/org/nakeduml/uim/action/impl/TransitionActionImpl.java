 ...
 * <ul>
 *   <li>{@link org.nakeduml.uim.action.impl.TransitionActionImpl#getUmlElementUid <em>Uml Element Uid</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TransitionActionImpl extends UimActionImpl implements TransitionAction {
	...
	protected EClass eStaticClass() {
		return ActionPackage.Literals.TRANSITION_ACTION;
	}
	...
	public void setUmlElementUid(String newUmlElementUid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionPackage.TRANSITION_ACTION__UML_ELEMENT_UID, oldUmlElementUid, umlElementUid));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActionPackage.TRANSITION_ACTION__UML_ELEMENT_UID:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == UmlReference.class) {
			switch (derivedFeatureID) {
				case ActionPackage.TRANSITION_ACTION__UML_ELEMENT_UID: return UimPackage.UML_REFERENCE__UML_ELEMENT_UID;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == UmlReference.class) {
			switch (baseFeatureID) {
				case UimPackage.UML_REFERENCE__UML_ELEMENT_UID: return ActionPackage.TRANSITION_ACTION__UML_ELEMENT_UID;
				default: return -1;
			}
		}
