 ...
 * <ul>
 *   <li>{@link org.nakeduml.uim.form.impl.OperationInvocationFormImpl#getFolder <em>Folder</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationInvocationFormImpl extends FormPanelImpl implements OperationInvocationForm {
	...
	protected EClass eStaticClass() {
		return FormPackage.Literals.OPERATION_INVOCATION_FORM;
	}
		...
		if (folder != null && folder.eIsProxy()) {
			...
			if (folder != oldFolder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormPackage.OPERATION_INVOCATION_FORM__FOLDER, oldFolder, folder));
			}
		}
		return folder;
	}
	...
	public void setFolder(OperationContainingFolder newFolder) {
		...
		folder = newFolder;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.OPERATION_INVOCATION_FORM__FOLDER, oldFolder, folder));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FormPackage.OPERATION_INVOCATION_FORM__FOLDER:
