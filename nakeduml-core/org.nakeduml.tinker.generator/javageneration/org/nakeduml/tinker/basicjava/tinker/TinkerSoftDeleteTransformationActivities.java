...
public class TinkerSoftDeleteTransformationActivities extends AbstractJavaProducingVisitor {
	...
	private void transformMarkDeletedToSoft(INakedActivity c, OJAnnotatedClass ojClass) {
	...
	private void removeVertex(INakedActivity sc, OJClass ojClass, OJOperation markDeleted) {
