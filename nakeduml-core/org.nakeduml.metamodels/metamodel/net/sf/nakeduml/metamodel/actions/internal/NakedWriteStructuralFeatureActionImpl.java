...
public abstract class NakedWriteStructuralFeatureActionImpl extends NakedStructuralFeatureActionImpl implements
		INakedWriteStructuralFeatureAction {
	...
	public void setValue(INakedInputPin value) {
		this.removeOwnedElement(this.value);
		this.value = value;
		linkFeature();
	}
