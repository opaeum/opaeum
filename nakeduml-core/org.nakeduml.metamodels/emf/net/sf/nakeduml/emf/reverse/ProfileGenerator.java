...
public class ProfileGenerator extends AbstractUmlGenerator {
	...
	static void createStereotypeForAnnotation(Class annotation, Profile ecoreProfile) {
		...
		try {
			stereotype = (Stereotype) ecoreProfile.getMember(annotation.getSimpleName());
	...
	public static void main(String[] args) throws Exception {
		...
		// EmfElementCreator.registerPathmaps(URI.createURI("jar:file:/" +
		// metamodelResourceJar + "!/"));
		...
		// resource =
		// EmfElementCreator.loadResource(URI.createFileURI(profileFile.getAbsolutePath()));
		// ecoreProfile = (org.eclipse.uml2.uml.Profile)
		...
		while (entries.hasMoreElements()) {
			...
			if (cn.endsWith(".class")) {
				...
				try {
					...
					System.out.println("Swallowed " + e.getMessage() + " for " + cn);
