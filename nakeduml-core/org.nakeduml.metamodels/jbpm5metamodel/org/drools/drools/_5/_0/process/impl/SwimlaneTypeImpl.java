 ...
 * <ul>
 *   <li>{@link org.drools.drools._5._0.process.impl.SwimlaneTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SwimlaneTypeImpl extends EObjectImpl implements SwimlaneType {
	...
	protected EClass eStaticClass() {
		return ProcessPackage.Literals.SWIMLANE_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.SWIMLANE_TYPE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ProcessPackage.SWIMLANE_TYPE__NAME:
				return getName();
		}
