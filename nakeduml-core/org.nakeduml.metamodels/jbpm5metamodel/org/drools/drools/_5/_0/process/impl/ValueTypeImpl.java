 ...
 * <ul>
 *   <li>{@link org.drools.drools._5._0.process.impl.ValueTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ValueTypeImpl extends EObjectImpl implements ValueType {
	...
	protected EClass eStaticClass() {
		return ProcessPackage.Literals.VALUE_TYPE;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.VALUE_TYPE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ProcessPackage.VALUE_TYPE__VALUE:
				return getValue();
		}
