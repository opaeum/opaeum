 ...
 * <ul>
 *   <li>{@link org.drools.drools._5._0.process.impl.ConstraintsTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.drools.drools._5._0.process.impl.ConstraintsTypeImpl#getConstraint <em>Constraint</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConstraintsTypeImpl extends EObjectImpl implements ConstraintsType {
	...
	protected EClass eStaticClass() {
		return ProcessPackage.Literals.CONSTRAINTS_TYPE;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, ProcessPackage.CONSTRAINTS_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<ConstraintType> getConstraint() {
		return getGroup().list(ProcessPackage.Literals.CONSTRAINTS_TYPE__CONSTRAINT);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ProcessPackage.CONSTRAINTS_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case ProcessPackage.CONSTRAINTS_TYPE__CONSTRAINT:
