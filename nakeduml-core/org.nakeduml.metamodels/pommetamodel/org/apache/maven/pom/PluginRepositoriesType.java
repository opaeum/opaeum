 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom.PluginRepositoriesType#getPluginRepository <em>Plugin Repository</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.apache.maven.pom.POMPackage#getPluginRepositoriesType()
...
public interface PluginRepositoriesType extends EObject {
	 ...
	 * @see org.apache.maven.pom.POMPackage#getPluginRepositoriesType_PluginRepository()
