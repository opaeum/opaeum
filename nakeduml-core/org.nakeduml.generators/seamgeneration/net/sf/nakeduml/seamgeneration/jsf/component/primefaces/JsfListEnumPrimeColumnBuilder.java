...
public class JsfListEnumPrimeColumnBuilder implements IJsfPropertyFieldPrimeColumnBuilder {

	private static final String ATTRIBUTES_THAT_ARE_SET_KEY = UIComponentBase.class.getName() + ".attributesThatAreSet";
	private PropertyField pf;
	private ClassifierUserInteraction ui;

	public JsfListEnumPrimeColumnBuilder(ClassifierUserInteraction ui, PropertyField pf) {
		super();
		this.ui = ui;
		this.pf = pf;
	}
