...
public class Jsf2ListEnumColumnBuilder implements IJsf2PropertyFieldColumnBuilder {

	private static final String ATTRIBUTES_THAT_ARE_SET_KEY = UIComponentBase.class.getName() + ".attributesThatAreSet";
	private PropertyField pf;
	private ClassifierUserInteraction ui;

	public Jsf2ListEnumColumnBuilder(ClassifierUserInteraction ui, PropertyField pf) {
		super();
		this.ui = ui;
		this.pf = pf;
	}
