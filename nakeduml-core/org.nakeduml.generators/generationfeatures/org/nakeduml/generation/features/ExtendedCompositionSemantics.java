...
@StepDependency(phase = JavaTransformationPhase.class,requires = {BasicJavaAdaptorPomStep.class,ExtendedCompositionSemanticsJavaStep.class},after = {BasicJavaModelStep.class,
