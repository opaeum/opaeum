...
@StepDependency(phase = JavaTransformationPhase.class, requires = {IntegratedBasicJavaStep.class, IntegratedTestJavaGenerationStep.class, IntegratedArquillianBootstrapStep.class,IntegratedArquillianPomStep.class })
