...
/**
 * EndEvent restore connection command
 *
 * @generated
 */
public class EndEventRestoreConnectionCommand extends AbstractRestoreConnectionCommand{
	/**
	 * @param part the EditPart that is restored
	 * @generated
	 */
	public EndEventRestoreConnectionCommand(EditPart part){
		super(part);
	}
	/**
	...
	protected void initializeCommands(){
		...
		if(eObjectSrc instanceof EndEvent){
			for(GraphElement graphElementTgt:getAllGraphElements()){
				...
				if(eObjectTgt instanceof FlowNode){
					if(autoRef){
						...
						createSequenceFlowFromFlowNodeToEndEvent_Incoming(graphElementTgt, graphElementSrc);
					}
				}
			}
		}
