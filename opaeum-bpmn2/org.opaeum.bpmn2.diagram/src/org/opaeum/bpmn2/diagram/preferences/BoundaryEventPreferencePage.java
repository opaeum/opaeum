 ...
 * @generated
 */
public class BoundaryEventPreferencePage extends AbstractNodePreferencePage{
	/**
	...
	protected String getNodeBackgroundColor(){
		return BPMN2DiagramPreferenceConstants.BOUNDARYEVENT_DEFAULT_BACKGROUND_COLOR;
	}
	/**
	...
	protected String getNodeFont(){
		return BPMN2DiagramPreferenceConstants.BOUNDARYEVENT_DEFAULT_FONT;
	}
	/**
	...
	protected String getNodeForegroundColor(){
		return BPMN2DiagramPreferenceConstants.BOUNDARYEVENT_DEFAULT_FOREGROUND_COLOR;
	}
	/**
