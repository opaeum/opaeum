 ...
 * @generated
 */
public class IntermediateCatchEventPreferencePage extends AbstractNodePreferencePage{
	/**
	...
	protected String getNodeBackgroundColor(){
		return BPMN2DiagramPreferenceConstants.INTERMEDIATECATCHEVENT_DEFAULT_BACKGROUND_COLOR;
	}
	/**
	...
	protected String getNodeFont(){
		return BPMN2DiagramPreferenceConstants.INTERMEDIATECATCHEVENT_DEFAULT_FONT;
	}
	/**
	...
	protected String getNodeForegroundColor(){
		return BPMN2DiagramPreferenceConstants.INTERMEDIATECATCHEVENT_DEFAULT_FOREGROUND_COLOR;
	}
	/**
