 ...
 * @generated
 */
public class ExclusiveGatewayPreferencePage extends AbstractNodePreferencePage{
	/**
	...
	protected String getNodeBackgroundColor(){
		return BPMN2DiagramPreferenceConstants.EXCLUSIVEGATEWAY_DEFAULT_BACKGROUND_COLOR;
	}
	/**
	...
	protected String getNodeFont(){
		return BPMN2DiagramPreferenceConstants.EXCLUSIVEGATEWAY_DEFAULT_FONT;
	}
	/**
	...
	protected String getNodeForegroundColor(){
		return BPMN2DiagramPreferenceConstants.EXCLUSIVEGATEWAY_DEFAULT_FOREGROUND_COLOR;
	}
	/**
