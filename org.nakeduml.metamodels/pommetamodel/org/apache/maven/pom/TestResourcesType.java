 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom.TestResourcesType#getTestResource <em>Test Resource</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.apache.maven.pom.POMPackage#getTestResourcesType()
...
public interface TestResourcesType extends EObject {
	 ...
	 * @see org.apache.maven.pom.POMPackage#getTestResourcesType_TestResource()
