	...
	public static void main(String[] args) throws Exception{
		...
		if(file.exists()){
			...
			if(profileFile.exists()){
				library = EmfWorkspaceLoader.loadModel(resourceSet, URI.createFileURI(profileFile.getAbsolutePath()));
			...
			mappedTypes.store(new FileOutputStream(targetDir + "/" + jarFileName + ".library." + NameSpaceExtractor.MAPPINGS_EXTENSION), "Generated by Opaeum");
		}
	}
