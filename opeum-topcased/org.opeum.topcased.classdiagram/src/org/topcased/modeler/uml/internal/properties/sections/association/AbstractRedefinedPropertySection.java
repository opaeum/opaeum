...
import org.topcased.modeler.uml.internal.properties.sections.property.PropertyRedefinedPropertySection;
 ...
 */
public abstract class AbstractRedefinedPropertySection extends PropertyRedefinedPropertySection
{
    /**
    ...
    {
        return getProperty((Association) getEObject()).getRedefinedProperties();
    }
