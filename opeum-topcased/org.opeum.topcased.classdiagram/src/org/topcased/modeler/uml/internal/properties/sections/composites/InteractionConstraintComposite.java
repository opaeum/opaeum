 ...
 */
public class InteractionConstraintComposite extends Composite
{
    private InteractionConstraint modelObject;
     ...
     * @param editingDomain
     */
    public InteractionConstraintComposite(TabbedPropertySheetWidgetFactory widgetFactory, Composite parent, final InteractionConstraint modelObj, int style, final EditingDomain editingDomain)
    {
        super(parent, style);
