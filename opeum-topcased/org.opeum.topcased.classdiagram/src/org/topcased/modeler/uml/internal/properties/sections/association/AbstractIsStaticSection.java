...
import org.topcased.modeler.uml.internal.properties.sections.feature.FeatureIsStaticSection;

/**
 * The section for the isStatic property of a Property associated with an Association Object.
 * 
 * Creation 10 avr. 2006
 * 
 * @author jlescot
 */
public abstract class AbstractIsStaticSection extends FeatureIsStaticSection
{
    /**
    ...
    {
        return getProperty((Association) getEObject()).isStatic();
    }
