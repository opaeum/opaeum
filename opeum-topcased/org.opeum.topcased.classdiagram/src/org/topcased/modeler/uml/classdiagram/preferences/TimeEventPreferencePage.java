 ...
 * @generated
 */
public class TimeEventPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return ClassDiagramPreferenceConstants.TIMEEVENT_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ClassDiagramPreferenceConstants.TIMEEVENT_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ClassDiagramPreferenceConstants.TIMEEVENT_DEFAULT_FOREGROUND_COLOR;
	}
