...
/**
 * BehavioredClassifier restore connection command<br>
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class BehavioredClassifierRestoreConnectionCommand extends ClassifierRestoreConnectionCommand
{
    /**
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     ...
     * @generated
     */
    public BehavioredClassifierRestoreConnectionCommand(EditPart part)
    {
        super(part);
    }
    ...
    protected void initializeCommands()
    {
        ...
        if (eObjectSrc instanceof BehavioredClassifier)
        {
        	for(GraphElement graphElementTgt : getAllGraphElements())
        	{
        		EObject eObjectTgt = Utils.getElement(graphElementTgt);

        		if (eObjectTgt instanceof Interface)
        		{
        			// if the elt is the source of the edge or if it is
        			// the target and that the SourceTargetCouple is
        			// reversible
        			createInterfaceRealizationFromBehavioredClassifierToInterface(graphElementSrc, graphElementTgt);
        		}
        	}
        }
    }
