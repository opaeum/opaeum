...
public class GeneralizationPreferencePage extends AbstractEdgePreferencePage
{
    ...
    {
        return ClassDiagramPreferenceConstants.GENERALIZATION_EDGE_DEFAULT_FONT;
    }
    ...
    {
        return ClassDiagramPreferenceConstants.GENERALIZATION_EDGE_DEFAULT_FOREGROUND_COLOR;
    }
    ...
    {
        return ClassDiagramPreferenceConstants.GENERALIZATION_EDGE_DEFAULT_ROUTER;
    }
    ...
    protected List<String> getHiddenElements()
    {
        ...
        if (!getPreferenceStore().getBoolean(ClassDiagramPreferenceConstants.GENERALIZATION_STEREOTYPE_EDGE_OBJECT_DEFAULT_VISIBILITY))
        {
    ...
    {
        List<String> choiceOfValues = new ArrayList<String>();
        if (!getPreferenceStore().getDefaultBoolean(ClassDiagramPreferenceConstants.GENERALIZATION_STEREOTYPE_EDGE_OBJECT_DEFAULT_VISIBILITY))
        {
            choiceOfValues.add(ClassEdgeObjectConstants.STEREOTYPE_EDGE_OBJECT_ID);
        }
        return choiceOfValues;
    ...
    protected void storeEdgeObjectVisibility(List<String> visibleElement)
    {
        ...
        {
            getPreferenceStore().setValue(ClassDiagramPreferenceConstants.GENERALIZATION_STEREOTYPE_EDGE_OBJECT_DEFAULT_VISIBILITY, true);
        }
        else
        {
            getPreferenceStore().setValue(ClassDiagramPreferenceConstants.GENERALIZATION_STEREOTYPE_EDGE_OBJECT_DEFAULT_VISIBILITY, false);
        }
    }
