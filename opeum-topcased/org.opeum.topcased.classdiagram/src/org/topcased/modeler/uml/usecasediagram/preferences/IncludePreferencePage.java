...
public class IncludePreferencePage extends AbstractEdgePreferencePage
{
    ...
    {
        return UseCaseDiagramPreferenceConstants.INCLUDE_EDGE_DEFAULT_FONT;
    }
    ...
    {
        return UseCaseDiagramPreferenceConstants.INCLUDE_EDGE_DEFAULT_FOREGROUND_COLOR;
    }
    ...
    {
        return UseCaseDiagramPreferenceConstants.INCLUDE_EDGE_DEFAULT_ROUTER;
    }
    ...
    protected List<String> getHiddenElements()
    {
        ...
        if (!ps.getBoolean(UseCaseDiagramPreferenceConstants.INCLUDE_NAME_EDGE_OBJECT_DEFAULT_VISIBILITY))
        {
    ...
    protected List<String> getDefaultHiddenElements()
    {
        List<String> choiceOfValues = new ArrayList<String>();
        IPreferenceStore ps = getPreferenceStore();
        if (!ps.getDefaultBoolean(UseCaseDiagramPreferenceConstants.INCLUDE_NAME_EDGE_OBJECT_DEFAULT_VISIBILITY))
        {
            choiceOfValues.add(UseCaseEdgeObjectConstants.NAME_EDGE_OBJECT_ID);
        }
        return choiceOfValues;
    ...
    protected void storeEdgeObjectVisibility(List<String> visibleElement)
    {
        ...
        {
            ps.setValue(UseCaseDiagramPreferenceConstants.INCLUDE_NAME_EDGE_OBJECT_DEFAULT_VISIBILITY, true);
        }
        else
        {
            ps.setValue(UseCaseDiagramPreferenceConstants.INCLUDE_NAME_EDGE_OBJECT_DEFAULT_VISIBILITY, false);
        }
    }
