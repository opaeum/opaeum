 ...
 * @generated
 */
public class PackageMergeFigure extends PolylineConnectionEx implements IGraphEdgeFigure, HandleBounds
{
    /**
     * @generated
     */
     ...
     * @generated
     */
    private IEdgeObjectFigure mergeEdgeObject;

    /**
     * @generated
     */
    private Locator mergeLocator;
     ...
     * @generated
     */
    public PackageMergeFigure()
    {
        super();

        mergeEdgeObject = new EdgeObjectOffsetEditableLabel(this);
        mergeLocator = new EdgeObjectOffsetLocator((IEdgeObjectOffsetFigure) mergeEdgeObject);
        add(mergeEdgeObject, mergeLocator);
     ...
     * @generated
     */
    public IEdgeObjectFigure getMergeEdgeObjectFigure()
    {
        return mergeEdgeObject;
    }
    ...
    {
        if (edgeObjectfigure == mergeEdgeObject)
        {
            return mergeLocator;
        }
