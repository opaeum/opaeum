 ...
 * @generated
 */
public class PackageImportPreferencePage extends AbstractEdgePreferencePage
{
    ...
    {
        return AllDiagramPreferenceConstants.PACKAGEIMPORT_EDGE_DEFAULT_FONT;
    }
    ...
    {
        return AllDiagramPreferenceConstants.PACKAGEIMPORT_EDGE_DEFAULT_FOREGROUND_COLOR;
    }
    ...
    {
        return AllDiagramPreferenceConstants.PACKAGEIMPORT_EDGE_DEFAULT_ROUTER;
    }
    ...
    protected List<String> getHiddenElements()
    {
        ...
        if (!getPreferenceStore().getBoolean(AllDiagramPreferenceConstants.PACKAGEIMPORT_VISIBILITY_EDGE_OBJECT_DEFAULT_VISIBILITY))
        {
            choiceOfValues.add(AllEdgeObjectConstants.VISIBILITY_EDGE_OBJECT_ID);
        }
    ...
    {
        List<String> choiceOfValues = new ArrayList<String>();
        if (!getPreferenceStore().getDefaultBoolean(AllDiagramPreferenceConstants.PACKAGEIMPORT_VISIBILITY_EDGE_OBJECT_DEFAULT_VISIBILITY))
        {
            choiceOfValues.add(AllEdgeObjectConstants.VISIBILITY_EDGE_OBJECT_ID);
        }
        return choiceOfValues;
    ...
    {
        if (visibleElement.contains(AllEdgeObjectConstants.VISIBILITY_EDGE_OBJECT_ID))
        {
            getPreferenceStore().setValue(AllDiagramPreferenceConstants.PACKAGEIMPORT_VISIBILITY_EDGE_OBJECT_DEFAULT_VISIBILITY, true);
        }
        else
        {
            getPreferenceStore().setValue(AllDiagramPreferenceConstants.PACKAGEIMPORT_VISIBILITY_EDGE_OBJECT_DEFAULT_VISIBILITY, false);
        }
    }
