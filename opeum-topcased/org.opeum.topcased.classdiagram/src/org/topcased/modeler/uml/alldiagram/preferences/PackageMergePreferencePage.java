 ...
 * @generated
 */
public class PackageMergePreferencePage extends AbstractEdgePreferencePage
{
    ...
    {
        return AllDiagramPreferenceConstants.PACKAGEMERGE_EDGE_DEFAULT_FONT;
    }
    ...
    {
        return AllDiagramPreferenceConstants.PACKAGEMERGE_EDGE_DEFAULT_FOREGROUND_COLOR;
    }
    ...
    {
        return AllDiagramPreferenceConstants.PACKAGEMERGE_EDGE_DEFAULT_ROUTER;
    }
    ...
    protected List<String> getHiddenElements()
    {
        ...
        if (!getPreferenceStore().getBoolean(AllDiagramPreferenceConstants.PACKAGEMERGE_MERGE_EDGE_OBJECT_DEFAULT_VISIBILITY))
        {
            choiceOfValues.add(AllEdgeObjectConstants.MERGE_EDGE_OBJECT_ID);
        }
    ...
    {
        List<String> choiceOfValues = new ArrayList<String>();
        if (!getPreferenceStore().getDefaultBoolean(AllDiagramPreferenceConstants.PACKAGEMERGE_MERGE_EDGE_OBJECT_DEFAULT_VISIBILITY))
        {
            choiceOfValues.add(AllEdgeObjectConstants.MERGE_EDGE_OBJECT_ID);
        }
        return choiceOfValues;
    ...
    {
        if (visibleElement.contains(AllEdgeObjectConstants.MERGE_EDGE_OBJECT_ID))
        {
            getPreferenceStore().setValue(AllDiagramPreferenceConstants.PACKAGEMERGE_MERGE_EDGE_OBJECT_DEFAULT_VISIBILITY, true);
        }
        else
        {
            getPreferenceStore().setValue(AllDiagramPreferenceConstants.PACKAGEMERGE_MERGE_EDGE_OBJECT_DEFAULT_VISIBILITY, false);
        }
    }
