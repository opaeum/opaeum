...
/**
 * StartEvent restore connection command
 *
 * @generated
 */
public class StartEventRestoreConnectionCommand extends AbstractRestoreConnectionCommand{
	/**
	 * @param part the EditPart that is restored
	 * @generated
	 */
	public StartEventRestoreConnectionCommand(EditPart part){
		super(part);
	}
	/**
	...
	protected void initializeCommands(){
		...
		if(eObjectSrc instanceof StartEvent){
			for(GraphElement graphElementTgt:getAllGraphElements()){
				...
				if(eObjectTgt instanceof FlowNode){
					if(autoRef){
						...
						createSequenceFlowFromStartEventToFlowNode_Incoming(graphElementSrc, graphElementTgt);
					}
				}
			}
		}
