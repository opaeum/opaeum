 ...
 * @generated
 */
public class IntermediateThrowEventPreferencePage extends AbstractNodePreferencePage{
	/**
	...
	protected String getNodeBackgroundColor(){
		return BPMN2DiagramPreferenceConstants.INTERMEDIATETHROWEVENT_DEFAULT_BACKGROUND_COLOR;
	}
	/**
	...
	protected String getNodeFont(){
		return BPMN2DiagramPreferenceConstants.INTERMEDIATETHROWEVENT_DEFAULT_FONT;
	}
	/**
	...
	protected String getNodeForegroundColor(){
		return BPMN2DiagramPreferenceConstants.INTERMEDIATETHROWEVENT_DEFAULT_FOREGROUND_COLOR;
	}
	/**
