...
/**
 * A preference page to configure all preferences of the Bpmn2 editor.
 *
 * @generated
 */
public class Bpmn2PreferencePage extends AbstractTopcasedPreferencePage{
	/**
	 * @generated
	 */
	...
	private void createHeader(Composite parent){
		new Label(parent, SWT.WRAP).setText("Bpmn2 editor preference page");
	}
	/**
