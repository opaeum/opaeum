 ...
 ******************************************************************************/
package org.opaeum.bpmn2.modeleditor.editor;
...
public class Bpmn2Editor extends Modeler{
	...
	protected List getAdapterFactories(){
		...
		factories.add(new org.opaeum.bpmn2.modeleditor.providers.Bpmn2ModelerProviderAdapterFactory());
		factories.add(new org.eclipse.bpmn2.di.provider.BpmnDiItemProviderAdapterFactory());
		factories.add(new org.opaeum.bpmn2.modeleditor.providers.BpmnDiModelerProviderAdapterFactory());
		factories.add(new org.eclipse.dd.di.provider.DiItemProviderAdapterFactory());
		factories.add(new org.opaeum.bpmn2.modeleditor.providers.DiModelerProviderAdapterFactory());
		factories.add(new org.eclipse.dd.dc.provider.DcItemProviderAdapterFactory());
		factories.add(new org.opaeum.bpmn2.modeleditor.providers.DcModelerProviderAdapterFactory());
