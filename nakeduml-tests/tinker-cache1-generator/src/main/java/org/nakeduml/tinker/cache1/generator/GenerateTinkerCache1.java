...
public class GenerateTinkerCache1 {
	...
	public static void main(String[] args) throws Exception {
		...
		File outputRoot = new File("../tinker-cache1/");
		System.out.println(outputRoot.getAbsolutePath());
		GenerateTinkerCache1 g = new GenerateTinkerCache1(outputRoot, model);
		g.generate();
	}

	public GenerateTinkerCache1(File outputRoot, File modelFile) {
		super();
