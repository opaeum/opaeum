package org.nakeduml.tinker.testsuite;
...
public class TinkerTestSuiteGenerator {

	public static void main(String[] args) throws Exception  {
		TinkerTestSuiteGenerator generateTest = new TinkerTestSuiteGenerator();
		generateTest.generate("tinker");
	...
	public TinkerTestSuiteGenerator(){
