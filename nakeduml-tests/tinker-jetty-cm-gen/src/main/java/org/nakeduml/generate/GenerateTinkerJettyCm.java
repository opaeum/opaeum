...
public class GenerateTinkerJettyCm {
	...
	public static void main(String[] args) throws Exception {
		File model = new File("./src/main/model/cm-core.uml");
		// File model = new File("../TestModels/Models/tinker/tinker.uml");

		File outputRoot = new File("../tinker-jetty-cm/");
		System.out.println(outputRoot.getAbsolutePath());
		GenerateTinkerJettyCm g = new GenerateTinkerJettyCm(outputRoot, model);
		g.generate();
	}

	public GenerateTinkerJettyCm(File outputRoot, File modelFile) {
		super();
	...
	private void mapDomainProjects(NakedUmlConfig cfg) {
		...
		cfg.mapOutputRoot(JavaTextSource.OutputRootId.ADAPTOR_GEN_SRC, true, "", "../src/main/generated-adaptor");
