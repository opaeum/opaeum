package org.nakeduml.tinker.softdelete.test.generator;
...
public class GenerateSoftDelete {
	...
	public static void main(String[] args) throws Exception {
		...
		File outputRoot = new File("../tinker-softdelete-test/");
		System.out.println(outputRoot.getAbsolutePath());
		GenerateSoftDelete g = new GenerateSoftDelete(outputRoot, model);
		g.generate();
	}

	public GenerateSoftDelete(File outputRoot, File modelFile) {
		super();
