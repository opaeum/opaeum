...
public class GenerateTinkerSoftdeleteCache {
	...
	public static void main(String[] args) throws Exception {
		...
		File outputRoot = new File("../tinker-softdelete-cache/");
		System.out.println(outputRoot.getAbsolutePath());
		GenerateTinkerSoftdeleteCache g = new GenerateTinkerSoftdeleteCache(outputRoot, model);
		g.generate();
	}

	public GenerateTinkerSoftdeleteCache(File outputRoot, File modelFile) {
		super();
