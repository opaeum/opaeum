...
import com.rorotika.cm.core.dto.CmApplicationWsImpl;
import com.rorotika.cm.core.network.dto.GroupWsImpl;
import com.rorotika.cm.core.util.WebservicePublisher;
...
public class StartJetty {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			server = new Server(new InetSocketAddress("10.217.104.121", 8080));
