/**
 */
package org.opaeum.metamodels.simulation.simulation.presentation;
...
import org.opaeum.simulation.simulation.presentation.SimulationEditorAdvisor;
...
public class SimulationModelWizard extends Wizard implements INewWizard {
		...
		try {
			...
			if (new File(fileURI.toFileString()).exists()) {
				if (!MessageDialog.openQuestion
						(getShell(),
						 SimulationEditorPlugin.INSTANCE.getString("_UI_Question_title"),
						 SimulationEditorPlugin.INSTANCE.getString("_WARN_FileConflict", new String []{ fileURI.toFileString() }))) {
			...
			return SimulationEditorAdvisor.openEditor(workbench, fileURI);			
		}
		catch (Exception exception) {
			SimulationEditorPlugin.INSTANCE.log(exception);
			return false;
	...
	public class SimulationModelWizardInitialObjectCreationPage extends WizardPage {
		...
		public void createControl(Composite parent) {
			...
			{
				resourceURILabel.setText(SimulationEditorPlugin.INSTANCE.getString("_UI_File_label"));
