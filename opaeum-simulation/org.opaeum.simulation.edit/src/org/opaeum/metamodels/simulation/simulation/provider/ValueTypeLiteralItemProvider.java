 ...
 * @generated
 */
public class ValueTypeLiteralItemProvider
	 ...
	 * @generated
	 */
	public ValueTypeLiteralItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ValueTypeLiteral_stringValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ValueTypeLiteral_stringValue_feature", "_UI_ValueTypeLiteral_type"),
				 SimulationPackage.Literals.VALUE_TYPE_LITERAL__STRING_VALUE,
				 true,
				 false,
				 false,
	...
	protected void addRuntimeStrategyFactoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ValueTypeLiteral_runtimeStrategyFactory_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ValueTypeLiteral_runtimeStrategyFactory_feature", "_UI_ValueTypeLiteral_type"),
				 SimulationPackage.Literals.VALUE_TYPE_LITERAL__RUNTIME_STRATEGY_FACTORY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns ValueTypeLiteral.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ValueTypeLiteral"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ValueTypeLiteral_type") :
			getString("_UI_ValueTypeLiteral_type") + " " + label;
	}
