...
@AccessType(	"field")
@Table(name="person_i_business_role_1",schema="opaeum_bpm")
...
public class Person_iBusinessRole_1 implements IPersistentObject, HibernateEntity, CompositionNode, Serializable {
	 ...
	 * @param end2 
	 */
	public Person_iBusinessRole_1(IBusinessRole end1, Person end2) {
	 ...
	 * @param end1 
	 */
	public Person_iBusinessRole_1(Person end2, IBusinessRole end1) {
		this.z_internalAddToBusinessRole(end1);
		this.z_internalAddToRepresentedPerson(end2);
	}
