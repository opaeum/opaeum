...
public class TaskRequest extends AbstractRequest implements IStateMachineExecution, IPersistentObject, IEventGenerator, HibernateEntity, CompositionNode, Serializable {
	...
	/** Implements self.participationInTask->any(p : ParticipationInTask | p.kind.=(OpaeumLibraryForBPM::request::TaskParticipationKind::owner))
	 */
	...
	/** Implements self.participationInTask->select(p : ParticipationInTask | p.participant.=(participant).and(p.kind.=(kind)))
	 * 
	 * @param participant 
	 * @param kind 
	 */
