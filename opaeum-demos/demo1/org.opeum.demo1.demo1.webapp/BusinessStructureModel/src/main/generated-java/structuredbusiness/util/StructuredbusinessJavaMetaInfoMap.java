...
public class StructuredbusinessJavaMetaInfoMap extends JavaMetaInfoMap {
	...
	public StructuredbusinessJavaMetaInfoMap() {
		...
		putClass(structuredbusiness.BusinessComponent1.class,"914890@_ZXPEIKmhEeGU9ckjWaJA9g");
		putClass(structuredbusiness.BusinessService1.class,"914890@_Jn_8cKZyEeGmp8-JHElaag");
		putMethod(structuredbusiness.BusinessService1.class,"914890@_L48EUKZyEeGmp8-JHElaag",3618232455403743561l);
		...
		putClass(structuredbusiness.Notification1.class,"914890@_PRxvsKmkEeGQV_zuGf3bVA");
