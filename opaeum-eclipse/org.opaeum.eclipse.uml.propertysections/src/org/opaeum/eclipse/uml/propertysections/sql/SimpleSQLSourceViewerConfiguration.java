...
import org.eclipse.datatools.sqltools.sqleditor.internal.sql.SQLCompletionProposalComparator;
...
public class SimpleSQLSourceViewerConfiguration extends SourceViewerConfiguration{
	...
	private SQLDBProposalsService fDBProposalsService;
	/**
	 ...
	 */
	public SimpleSQLSourceViewerConfiguration(){
		fCompletionProcessor = new SQLCompletionProcessor();
	}
	/**
	 * Returns the annotation hover which will provide the information to be shown in a hover popup window when requested for the given source
	 * viewer.
	 * 
	...
	public IContentFormatter getContentFormatter(ISourceViewer sourceViewer){
		...
		SQLDevToolsConfiguration factory = SQLToolsFacade.getConfigurationByVendorIdentifier(fDBProposalsService.getConnectionInfo()
	...
	/**
	 * Returns the double-click strategy ready to be used in this viewer when double clicking onto text of the given content type. (Note: the
	 * same double-click strategy object is used for all content types.)
	 * 
	...
	public IPresentationReconciler getPresentationReconciler(ISourceViewer sourceViewer){
		...
		SQLDevToolsConfiguration factory = SQLToolsFacade.getConfigurationByVendorIdentifier(this.fDBProposalsService.getConnectionInfo()
				.getDatabaseVendorDefinitionId());
		if(factory != null){
	...
	/**
	 * Sets the <code>ISQLDBProposalsService</code> object that provides content assist services for this viewer to the given object.
	 * 
	 * @param the
	 *          <code>ISQLDBProposalsService</code> object to set
	 */
	public void setDBProposalsService(SQLDBProposalsService dbProposalsService){
