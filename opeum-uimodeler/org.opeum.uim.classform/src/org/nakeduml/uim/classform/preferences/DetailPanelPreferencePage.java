 ...
 * @generated
 */
public class DetailPanelPreferencePage extends AbstractNodePreferencePage{
	/**
	...
	protected String getNodeBackgroundColor(){
		return ClassFormDiagramPreferenceConstants.DETAILPANEL_DEFAULT_BACKGROUND_COLOR;
	}
	/**
	...
	protected String getNodeFont(){
		return ClassFormDiagramPreferenceConstants.DETAILPANEL_DEFAULT_FONT;
	}
	/**
	...
	protected String getNodeForegroundColor(){
		return ClassFormDiagramPreferenceConstants.DETAILPANEL_DEFAULT_FOREGROUND_COLOR;
	}
	/**
