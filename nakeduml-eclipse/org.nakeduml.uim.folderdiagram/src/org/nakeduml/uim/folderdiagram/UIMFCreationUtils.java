...
public class UIMFCreationUtils extends AbstractCreationUtils {
	...
	private class GraphicUIMSwitch extends UIMSwitch {
		...
		public Object caseStateMachineFolder(
			...
			if ("default".equals(presentation)) {
				return createGraphElementStateMachineFolder(object,
						presentation);
			}
			return null;
		}
		...
		public Object caseOperationInvocationForm(
			...
			if ("default".equals(presentation)) {
				return createGraphElementOperationInvocationForm(object,
						presentation);
			}
			return null;
		}
	 ...
	 * @generated
	 */
	protected GraphElement createGraphElementPackageFolder(
			org.nakeduml.uim.PackageFolder element, String presentation) {
	 ...
	 * @generated
	 */
	protected GraphElement createGraphElementEntityFolder(
			org.nakeduml.uim.EntityFolder element, String presentation) {
		return createGraphNode(element, presentation);
	}
	 ...
	 * @generated
	 */
	protected GraphElement createGraphElementStateMachineFolder(
			org.nakeduml.uim.StateMachineFolder element, String presentation) {
		return createGraphNode(element, presentation);
	}
	 ...
	 * @generated
	 */
	protected GraphElement createGraphElementActivityFolder(
			org.nakeduml.uim.ActivityFolder element, String presentation) {
		return createGraphNode(element, presentation);
	}
	 ...
	 * @generated
	 */
	protected GraphElement createGraphElementClassForm(
			org.nakeduml.uim.ClassForm element, String presentation) {
		return createGraphNode(element, presentation);
	}
	 ...
	 * @generated
	 */
	protected GraphElement createGraphElementStateForm(
			org.nakeduml.uim.StateForm element, String presentation) {
		return createGraphNode(element, presentation);
	}
	 ...
	 * @generated
	 */
	protected GraphElement createGraphElementOperationInvocationForm(
			org.nakeduml.uim.OperationInvocationForm element,
			String presentation) {
		return createGraphNode(element, presentation);
	}
	 ...
	 * @generated
	 */
	protected GraphElement createGraphElementActionTaskForm(
			org.nakeduml.uim.ActionTaskForm element, String presentation) {
		return createGraphNode(element, presentation);
	}
	 ...
	 * @generated
	 */
	protected GraphElement createGraphElementOperationTaskForm(
			org.nakeduml.uim.OperationTaskForm element, String presentation) {
		return createGraphNode(element, presentation);
	}
	...
	private IPreferenceStore getPreferenceStore() {
		IEditorInput editorInput = UIMFPlugin.getActivePage().getActiveEditor()
				.getEditorInput();
