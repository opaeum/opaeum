 ...
 * @generated
 */
public class PackageFolderPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return UIMFDiagramPreferenceConstants.PACKAGEFOLDER_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return UIMFDiagramPreferenceConstants.PACKAGEFOLDER_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return UIMFDiagramPreferenceConstants.PACKAGEFOLDER_DEFAULT_FOREGROUND_COLOR;
	}
