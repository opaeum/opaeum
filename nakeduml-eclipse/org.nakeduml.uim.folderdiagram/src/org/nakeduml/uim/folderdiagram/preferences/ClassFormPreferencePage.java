 ...
 * @generated
 */
public class ClassFormPreferencePage extends AbstractNodePreferencePage{
	/**
	...
	protected String getNodeBackgroundColor(){
		return UIMFDiagramPreferenceConstants.CLASSFORM_DEFAULT_BACKGROUND_COLOR;
	}
	/**
	...
	protected String getNodeFont(){
		return UIMFDiagramPreferenceConstants.CLASSFORM_DEFAULT_FONT;
	}
	/**
	...
	protected String getNodeForegroundColor(){
		return UIMFDiagramPreferenceConstants.CLASSFORM_DEFAULT_FOREGROUND_COLOR;
	}
	/**
