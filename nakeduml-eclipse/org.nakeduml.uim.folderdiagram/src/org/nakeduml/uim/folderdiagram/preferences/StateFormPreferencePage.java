 ...
 * @generated
 */
public class StateFormPreferencePage extends AbstractNodePreferencePage{
	/**
	...
	protected String getNodeBackgroundColor(){
		return UIMFDiagramPreferenceConstants.STATEFORM_DEFAULT_BACKGROUND_COLOR;
	}
	/**
	...
	protected String getNodeFont(){
		return UIMFDiagramPreferenceConstants.STATEFORM_DEFAULT_FONT;
	}
	/**
	...
	protected String getNodeForegroundColor(){
		return UIMFDiagramPreferenceConstants.STATEFORM_DEFAULT_FOREGROUND_COLOR;
	}
	/**
