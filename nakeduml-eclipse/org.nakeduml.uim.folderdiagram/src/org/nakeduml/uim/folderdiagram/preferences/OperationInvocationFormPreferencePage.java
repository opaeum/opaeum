 ...
 * @generated
 */
public class OperationInvocationFormPreferencePage extends AbstractNodePreferencePage{
	/**
	...
	protected String getNodeBackgroundColor(){
		return UIMFDiagramPreferenceConstants.OPERATIONINVOCATIONFORM_DEFAULT_BACKGROUND_COLOR;
	}
	/**
	...
	protected String getNodeFont(){
		return UIMFDiagramPreferenceConstants.OPERATIONINVOCATIONFORM_DEFAULT_FONT;
	}
	/**
	...
	protected String getNodeForegroundColor(){
		return UIMFDiagramPreferenceConstants.OPERATIONINVOCATIONFORM_DEFAULT_FOREGROUND_COLOR;
	}
	/**
