 ...
 * @generated
 */
public class ActionTaskFormPreferencePage extends AbstractNodePreferencePage{
	/**
	...
	protected String getNodeBackgroundColor(){
		return UIMFDiagramPreferenceConstants.ACTIONTASKFORM_DEFAULT_BACKGROUND_COLOR;
	}
	/**
	...
	protected String getNodeFont(){
		return UIMFDiagramPreferenceConstants.ACTIONTASKFORM_DEFAULT_FONT;
	}
	/**
	...
	protected String getNodeForegroundColor(){
		return UIMFDiagramPreferenceConstants.ACTIONTASKFORM_DEFAULT_FOREGROUND_COLOR;
	}
	/**
