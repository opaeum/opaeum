 ...
 * @generated
 */
public class ActivityFolderPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return UIMFDiagramPreferenceConstants.ACTIVITYFOLDER_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return UIMFDiagramPreferenceConstants.ACTIVITYFOLDER_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return UIMFDiagramPreferenceConstants.ACTIVITYFOLDER_DEFAULT_FOREGROUND_COLOR;
	}
