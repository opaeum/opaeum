 ...
 * @generated
 */
public class StateMachineFolderPreferencePage extends AbstractNodePreferencePage{
	/**
	...
	protected String getNodeBackgroundColor(){
		return UIMFDiagramPreferenceConstants.STATEMACHINEFOLDER_DEFAULT_BACKGROUND_COLOR;
	}
	/**
	...
	protected String getNodeFont(){
		return UIMFDiagramPreferenceConstants.STATEMACHINEFOLDER_DEFAULT_FONT;
	}
	/**
	...
	protected String getNodeForegroundColor(){
		return UIMFDiagramPreferenceConstants.STATEMACHINEFOLDER_DEFAULT_FOREGROUND_COLOR;
	}
	/**
