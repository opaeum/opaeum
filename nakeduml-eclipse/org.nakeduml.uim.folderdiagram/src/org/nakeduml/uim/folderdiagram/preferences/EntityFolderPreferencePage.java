 ...
 * @generated
 */
public class EntityFolderPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return UIMFDiagramPreferenceConstants.ENTITYFOLDER_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return UIMFDiagramPreferenceConstants.ENTITYFOLDER_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return UIMFDiagramPreferenceConstants.ENTITYFOLDER_DEFAULT_FOREGROUND_COLOR;
	}
