...
public class UIMFConfiguration implements IConfiguration {
	...
	private void registerAdapters() {
		Platform.getAdapterManager().registerAdapters(
				new EditPart2ModelAdapterFactory(PackageFolderEditPart.class,
						org.nakeduml.uim.PackageFolder.class),
				PackageFolderEditPart.class);
		Platform.getAdapterManager().registerAdapters(
				new EditPart2ModelAdapterFactory(EntityFolderEditPart.class,
						org.nakeduml.uim.EntityFolder.class),
				EntityFolderEditPart.class);
		Platform.getAdapterManager().registerAdapters(
				new EditPart2ModelAdapterFactory(
						StateMachineFolderEditPart.class,
						org.nakeduml.uim.StateMachineFolder.class),
				StateMachineFolderEditPart.class);
		Platform.getAdapterManager().registerAdapters(
				new EditPart2ModelAdapterFactory(ActivityFolderEditPart.class,
						org.nakeduml.uim.ActivityFolder.class),
				ActivityFolderEditPart.class);
		Platform.getAdapterManager().registerAdapters(
				new EditPart2ModelAdapterFactory(ClassFormEditPart.class,
						org.nakeduml.uim.ClassForm.class),
				ClassFormEditPart.class);
		Platform.getAdapterManager().registerAdapters(
				new EditPart2ModelAdapterFactory(StateFormEditPart.class,
						org.nakeduml.uim.StateForm.class),
				StateFormEditPart.class);
		Platform.getAdapterManager().registerAdapters(
				new EditPart2ModelAdapterFactory(
						OperationTaskFormEditPart.class,
						org.nakeduml.uim.OperationTaskForm.class),
				OperationTaskFormEditPart.class);
		Platform.getAdapterManager().registerAdapters(
				new EditPart2ModelAdapterFactory(ActionTaskFormEditPart.class,
						org.nakeduml.uim.ActionTaskForm.class),
				ActionTaskFormEditPart.class);
		Platform.getAdapterManager().registerAdapters(
				new EditPart2ModelAdapterFactory(
						OperationInvocationFormEditPart.class,
						org.nakeduml.uim.OperationInvocationForm.class),
				OperationInvocationFormEditPart.class);
	}
	...
	public DiagramGraphConf getDiagramGraphConf() {
		if (diagramGraphConf == null) {
			URL url = UIMFPlugin.getDefault().getBundle().getResource(
					"net/sf/nakeduml/uim/folderdiagram/diagram.graphconf");
			if (url != null) {
