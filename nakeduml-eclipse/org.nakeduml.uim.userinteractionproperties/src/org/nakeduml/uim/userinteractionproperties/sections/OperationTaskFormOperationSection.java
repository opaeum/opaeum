 ...
 * @generated
 */
public class OperationTaskFormOperationSection extends
	...
	protected EStructuralFeature getFeature() {
		return UIMPackage.eINSTANCE.getOperationTaskForm_Operation();
	}
	...
	protected Object getFeatureValue() {
		return ((OperationTaskForm) getEObject()).getOperation();
	}
	...
	protected Object[] getComboFeatureValues() {
		return getChoices(getEObject(), UIMPackage.eINSTANCE
				.getOperationTaskForm_Operation().getEType());
	}
