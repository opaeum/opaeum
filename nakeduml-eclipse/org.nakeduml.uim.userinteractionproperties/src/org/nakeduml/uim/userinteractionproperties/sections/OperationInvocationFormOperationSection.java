 ...
 * @generated
 */
public class OperationInvocationFormOperationSection extends
	...
	protected EStructuralFeature getFeature() {
		return UIMPackage.eINSTANCE.getOperationInvocationForm_Operation();
	}
	...
	protected Object getFeatureValue() {
		return ((OperationInvocationForm) getEObject()).getOperation();
	}
	...
	protected Object[] getComboFeatureValues() {
		OperationInvocationForm oif = (OperationInvocationForm) getEObject();
		if (oif.getFolder().getRepresentedClass() != null) {
			EList<Operation> opers = UimUtil.getRepresentedClass(oif)
					.getAllOperations();
