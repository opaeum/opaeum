...
/**
 * This is the item provider adapter for a {@link org.nakeduml.uim.UserInteractionElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UserInteractionElementItemProvider
	 ...
	 * @generated
	 */
	public UserInteractionElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((UserInteractionElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UserInteractionElement_type") :
			getString("_UI_UserInteractionElement_type") + " " + label;
	}
