...
/**
 * This is the item provider adapter for a {@link org.nakeduml.uim.WorkspaceSecurityConstraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WorkspaceSecurityConstraintItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UimPackage.Literals.WORKSPACE_SECURITY_CONSTRAINT__REQUIRES_GROUP_OWNERSHIP,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UimPackage.Literals.WORKSPACE_SECURITY_CONSTRAINT__REQUIRES_OWNERSHIP,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UimPackage.Literals.WORKSPACE_SECURITY_CONSTRAINT__REQUIRED_ROLES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UimPackage.Literals.WORKSPACE_SECURITY_CONSTRAINT__REQUIRED_ROLES,
				 UimFactory.eINSTANCE.createRequiredRole()));
	}
