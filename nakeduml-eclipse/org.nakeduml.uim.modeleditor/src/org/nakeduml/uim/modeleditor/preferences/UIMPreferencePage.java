...
public class UIMPreferencePage extends AbstractTopcasedPreferencePage {
	...
	private void createMoveActionGroup(Composite parent) {
		...
		moveModelElements = new BooleanFieldEditor(ModelerPreferenceConstants.MOVE_MODEL_ACTION_CONFIRM,
				"Do not ask for confirmation before moving model elements.", fieldsContainerMove);
