...
public class UimDataColumnFigure extends Figure implements IContainerFigure,ILabelFigure{
	...
	public UimDataColumnFigure(){
		...
		addLayoutListener(new LayoutListener(){
			...
			public boolean layout(IFigure arg0){
				...
				GridData constraint2 = (GridData) getLayoutManager().getConstraint(getContentPane());
