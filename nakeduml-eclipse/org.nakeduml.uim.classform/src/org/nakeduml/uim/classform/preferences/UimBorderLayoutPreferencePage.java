 ...
 * @generated
 */
public class UimBorderLayoutPreferencePage extends AbstractNodePreferencePage{
	/**
	...
	protected String getNodeBackgroundColor(){
		return ClassFormDiagramPreferenceConstants.UIMBORDERLAYOUT_DEFAULT_BACKGROUND_COLOR;
	}
	/**
	...
	protected String getNodeFont(){
		return ClassFormDiagramPreferenceConstants.UIMBORDERLAYOUT_DEFAULT_FONT;
	}
	/**
	...
	protected String getNodeForegroundColor(){
		return ClassFormDiagramPreferenceConstants.UIMBORDERLAYOUT_DEFAULT_FOREGROUND_COLOR;
	}
	/**
