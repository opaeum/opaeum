 ...
 * @generated
 */
public class UimDataColumnPreferencePage extends AbstractNodePreferencePage{
	/**
	...
	protected String getNodeBackgroundColor(){
		return ClassFormDiagramPreferenceConstants.UIMDATACOLUMN_DEFAULT_BACKGROUND_COLOR;
	}
	/**
	...
	protected String getNodeFont(){
		return ClassFormDiagramPreferenceConstants.UIMDATACOLUMN_DEFAULT_FONT;
	}
	/**
	...
	protected String getNodeForegroundColor(){
		return ClassFormDiagramPreferenceConstants.UIMDATACOLUMN_DEFAULT_FOREGROUND_COLOR;
	}
	/**
