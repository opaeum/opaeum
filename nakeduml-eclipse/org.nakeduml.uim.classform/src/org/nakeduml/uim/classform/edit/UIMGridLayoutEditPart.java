...
import org.nakeduml.uim.classform.commands.UIMGridLayoutRestoreConnectionCommand;
...
public class UIMGridLayoutEditPart extends AbstractUIMGridLayoutEditPart {
	...
	protected void createEditPolicies() {
		...
		installEditPolicy(ModelerEditPolicyConstants.RESTORE_EDITPOLICY,
				new RestoreEditPolicy() {
					protected Command getRestoreConnectionsCommand(
						...
						return new UIMGridLayoutRestoreConnectionCommand(
								getHost());
					}
				});
		...
		installEditPolicy(EditPolicy.LAYOUT_ROLE,
				new UIMGridLayoutLayoutEditPolicy());
	...
	protected Color getPreferenceDefaultBackgroundColor() {
		String backgroundColor = getPreferenceStore()
				.getString(
						ClassFormDiagramPreferenceConstants.UIMGRIDLAYOUT_DEFAULT_BACKGROUND_COLOR);
	...
	protected Color getPreferenceDefaultForegroundColor() {
		String foregroundColor = getPreferenceStore()
				.getString(
						ClassFormDiagramPreferenceConstants.UIMGRIDLAYOUT_DEFAULT_FOREGROUND_COLOR);
	...
	protected Font getPreferenceDefaultFont() {
		String preferenceFont = getPreferenceStore().getString(
				ClassFormDiagramPreferenceConstants.UIMGRIDLAYOUT_DEFAULT_FONT);
