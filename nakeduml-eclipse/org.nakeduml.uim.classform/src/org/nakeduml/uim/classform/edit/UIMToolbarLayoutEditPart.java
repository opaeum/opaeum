...
public class UIMToolbarLayoutEditPart extends EMFGraphNodeEditPart {
	...
	protected void createEditPolicies() {
		...
		installEditPolicy(ModelerEditPolicyConstants.RESTORE_EDITPOLICY,
				new RestoreEditPolicy() {
					protected Command getRestoreConnectionsCommand(
						...
						return new UIMToolbarLayoutRestoreConnectionCommand(
								getHost());
					}
				});
		...
		installEditPolicy(EditPolicy.LAYOUT_ROLE,
				new UIMToolbarLayoutLayoutEditPolicy());
	...
	protected Color getPreferenceDefaultBackgroundColor() {
		String backgroundColor = getPreferenceStore()
				.getString(
						ClassFormDiagramPreferenceConstants.UIMTOOLBARLAYOUT_DEFAULT_BACKGROUND_COLOR);
	...
	protected Color getPreferenceDefaultForegroundColor() {
		String foregroundColor = getPreferenceStore()
				.getString(
						ClassFormDiagramPreferenceConstants.UIMTOOLBARLAYOUT_DEFAULT_FOREGROUND_COLOR);
	...
	protected Font getPreferenceDefaultFont() {
		String preferenceFont = getPreferenceStore()
				.getString(
						ClassFormDiagramPreferenceConstants.UIMTOOLBARLAYOUT_DEFAULT_FONT);
