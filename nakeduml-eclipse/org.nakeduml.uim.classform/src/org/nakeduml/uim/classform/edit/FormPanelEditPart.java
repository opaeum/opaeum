...
import org.nakeduml.uim.classform.commands.FormPanelRestoreConnectionCommand;
import org.nakeduml.uim.classform.policies.FormPanelLayoutEditPolicy;
...
public class FormPanelEditPart extends EMFGraphNodeEditPart {
	...
	protected Color getPreferenceDefaultBackgroundColor() {
		String backgroundColor = getPreferenceStore()
				.getString(
						ClassFormDiagramPreferenceConstants.FORMPANEL_DEFAULT_BACKGROUND_COLOR);
	...
	protected Color getPreferenceDefaultForegroundColor() {
		String foregroundColor = getPreferenceStore()
				.getString(
						ClassFormDiagramPreferenceConstants.FORMPANEL_DEFAULT_FOREGROUND_COLOR);
	...
	protected Font getPreferenceDefaultFont() {
		String preferenceFont = getPreferenceStore().getString(
				ClassFormDiagramPreferenceConstants.FORMPANEL_DEFAULT_FONT);
