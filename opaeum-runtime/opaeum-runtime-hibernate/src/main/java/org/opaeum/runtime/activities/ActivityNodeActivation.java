...
public abstract class ActivityNodeActivation<AE extends IActivityNodeContainerExecution, T extends ActivityToken<AE>> implements IActivityNodeActivation<AE,T>{
	protected AE group;
	private String id;
	...
	public void addToken(T token){
		...
		T transferredToken = token.transfer(this);
		this.getHeldTokens().add(transferredToken);
	}
	public  <T2 extends ActivityToken<AE>> int removeToken(T2 activityToken){
