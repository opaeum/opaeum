...
public class BusinessCalendarGenerated implements IEventGenerator, CompositionNode, HibernateEntity, Serializable, IPersistentObject {
	...
	public void createComponents() {
		if ( getWorkDay().isEmpty() ) {
			...
			newworkDay.setKind(org.opeum.runtime.bpm.businesscalendar.WorkDayKind.WEEKDAY);
			newworkDay= new WorkDay();
			addToWorkDay(newworkDay);
			newworkDay.setKind(org.opeum.runtime.bpm.businesscalendar.WorkDayKind.SATURDAY);
			newworkDay= new WorkDay();
			addToWorkDay(newworkDay);
			newworkDay.setKind(org.opeum.runtime.bpm.businesscalendar.WorkDayKind.SUNDAY);
		}
	}
