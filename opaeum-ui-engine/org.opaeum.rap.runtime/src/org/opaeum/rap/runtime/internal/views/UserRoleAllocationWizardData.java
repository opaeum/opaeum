...
public class UserRoleAllocationWizardData{
	...
	protected void populateBusinessRoleClasses(){
		for(Class<?> bc:application.getEnvironment().getMetaInfoMap().getClassesByAnnotation(BusinessComponent.class)){
	...
	public void flush(){
		...
		application.getEnvironment().getPersistence().flush();
	}
