...
public class DataModel extends Adaptable implements IDataModel {
	...
	public final class Employee extends Adaptable implements IEmployee {
		...
		private Employee(final String firstName, final String lastName,
				final Long id) {
	...
	public class Principal extends Adaptable implements IPrincipal {
		...
		private Principal(final String name, final Long id) {
			assert (name != null);
			this.name = name;
			if (id != null) {
				this.id = id;
		...
		IProject newProject(final String name, final Long id) {
		...
		public void setFaxNumber(final String faxNumber) {
			this.faxNumber = (String) notifyOnChange(faxNumber, this.faxNumber,
					this);
		}

		public void setFirstName(final String firstName) {
			this.firstName = (String) notifyOnChange(firstName, this.firstName,
					this);
		}

		public void setLastName(final String lastName) {
			this.lastName = (String) notifyOnChange(lastName, this.lastName,
					this);
		}

		public void setMobileNumber(final String mobileNumber) {
			this.mobileNumber = (String) notifyOnChange(mobileNumber,
					this.mobileNumber, this);
		}

		public void setPhoneNumber(final String phoneNumber) {
			this.phoneNumber = (String) notifyOnChange(phoneNumber,
					this.phoneNumber, this);
		}

		public void setPostCode(final String postCode) {
			this.postCode = (String) notifyOnChange(postCode, this.postCode,
					this);
		}

		public void setStreet(final String street) {
			this.street = (String) notifyOnChange(street, this.street, this);
		}
	}

	public class Project extends Adaptable implements IProject {
		private final String name;
		private final Long id;
		...
		private Project(final String name, final IPrincipal principal,
				final Long id) {
			this.name = name;
		...
		IAssignment newAssignment(final IEmployee employee, final Long id) {
		...
		ITask newTask(final String name, final Long id) {
		...
		public void setDescription(final String description) {
			this.description = (String) notifyOnChange(description,
		...
		public void setStartDate(final Date startDate) {
			this.startDate = (Date) notifyOnChange(startDate, this.startDate,
					this);
		}
	}

	public class Assignment extends Adaptable implements IAssignment {
		private final Long id;
		private final IEmployee employee;
		private final IProject project;

		private Assignment(final IProject project, final IEmployee employee,
				final Long id) {
		...
		public String getName() {
			return getEmployee().getName() + "->" +getProject().getName();
		}
	}

	public class Task extends Adaptable implements ITask {
		private final Long id;
		private final String name;
		private final IProject project;
		private String description;
		...
		public Task(final String name, final IProject project, final Long id) {
			this.name = name;
			this.project = project;
			if (id != null) {
				this.id = id;
	...
	IPrincipal newPrincipal(final String name, final Long id) {
	...
	IEmployee newEmployee(final String lastName, final String firstName,
			final Long id) {
	...
	private Object notifyOnChange(final Object newValue, final Object oldValue,
			final IPersistentObject entity) {
	...
	void notifyOnCreated(final IPersistentObject entity) {
		ModelListener[] modelListeners = new ModelListener[listeners.size()];
		listeners.toArray(modelListeners);
		ModelEvent evt = new ModelEvent(entity);
		for (int i = 0; i < modelListeners.length; i++) {
