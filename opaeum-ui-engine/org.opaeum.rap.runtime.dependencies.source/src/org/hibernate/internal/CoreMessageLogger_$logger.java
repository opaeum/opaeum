 ...
 * 
 */
@Generated(value = "org.jboss.logging.generator.model.MessageLoggerImplementor", date = "2012-01-11T12:44:58-0600")
    ...
    implements Serializable, CoreMessageLogger, BasicLogger
{
    ...
    @Override
    public final void filterAnnotationOnSubclass(final String className) {
        log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000103: ")+ filterAnnotationOnSubclass$str()), className);
    }
