...
public class OnRevokedHandler69 implements IEventHandler {
	private BusinessRole revokedBy;
	private boolean isEvent;
	private Date firstOccurrenceScheduledFor;

	/** Default constructor for OnRevokedHandler69
	 */
	public OnRevokedHandler69() {
	}
	
	/** Constructor for OnRevokedHandler69
	 * 
	 * @param revokedBy 
	 * @param isEvent 
	 */
	public OnRevokedHandler69(BusinessRole revokedBy, boolean isEvent) {
	...
	public String getHandlerUuid() {
		return "6b36d586_5db5_4b08_8957_a7d21bb1634c";
	}
	...
	public Collection<PropertyValue> marshall() {
		...
		result.add(new PropertyValue(70, Value.valueOf(this.getRevokedBy())));
