...
public class OnDelegatedHandler71 implements IEventHandler {
	private BusinessRole delegatedBy;
	private BusinessRole delegatedTo;
	private boolean isEvent;
	private Date firstOccurrenceScheduledFor;

	/** Default constructor for OnDelegatedHandler71
	 */
	public OnDelegatedHandler71() {
	}
	
	/** Constructor for OnDelegatedHandler71
	 * 
	 * @param delegatedBy 
	 * @param delegatedTo 
	 * @param isEvent 
	 */
	public OnDelegatedHandler71(BusinessRole delegatedBy, BusinessRole delegatedTo, boolean isEvent) {
	...
	public String getHandlerUuid() {
		return "e33e12bc_fff7_4b70_a535_47e2a0e4490f";
	}
	...
	public Collection<PropertyValue> marshall() {
		...
		result.add(new PropertyValue(72, Value.valueOf(this.getDelegatedBy())));
		result.add(new PropertyValue(73, Value.valueOf(this.getDelegatedTo())));
