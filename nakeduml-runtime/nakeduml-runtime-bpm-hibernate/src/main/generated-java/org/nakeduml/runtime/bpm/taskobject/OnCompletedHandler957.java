...
public class OnCompletedHandler957 implements ICallEventHandler {
	private boolean isEvent;
	private BusinessRole completedBy;
	private Date firstOccurrenceScheduledFor;

	/** Default constructor for OnCompletedHandler957
	 */
	public OnCompletedHandler957() {
	}
	
	/** Constructor for OnCompletedHandler957
	 * 
	 * @param completedBy 
	 * @param isEvent 
	 */
	public OnCompletedHandler957(BusinessRole completedBy, boolean isEvent) {
	...
	public Collection<PropertyValue> marshall() {
		...
		result.add(new PropertyValue(958, Value.valueOf(this.getCompletedBy())));
