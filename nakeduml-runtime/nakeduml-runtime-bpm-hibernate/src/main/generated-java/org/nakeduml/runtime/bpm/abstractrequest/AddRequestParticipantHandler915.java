...
public class AddRequestParticipantHandler915 implements ICallEventHandler {
	private boolean isEvent;
	private Date firstOccurrenceScheduledFor;
	private Participant newParticipant;
	private RequestParticipationKind kind;

	/** Default constructor for AddRequestParticipantHandler915
	 */
	public AddRequestParticipantHandler915() {
	}
	
	/** Constructor for AddRequestParticipantHandler915
	 * 
	 * @param newParticipant 
	 * @param kind 
	 * @param isEvent 
	 */
	public AddRequestParticipantHandler915(Participant newParticipant, RequestParticipationKind kind, boolean isEvent) {
	...
	public Collection<PropertyValue> marshall() {
		...
		result.add(new PropertyValue(916, Value.valueOf(this.getNewParticipant())));
		result.add(new PropertyValue(917, Value.valueOf(this.getKind())));
