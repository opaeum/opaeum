...
public enum TaskRequestState implements IProcessStep {
	...
	ACTIVE(null,"9e92c9fb_bb1e_4bb9_a522_d9dc02c90ac1",201l,"Active",new TriggerMethod[]{new TriggerMethod(false,"Skip","skip"),new TriggerMethod(false,"Delegate","delegate"),new TriggerMethod(false,"Start","start"),new TriggerMethod(false,"Forward","forward")}),
	...
	INPROGRESS(ACTIVE,"3f7193d9_cc4e_4ead_b8d6_882b3d5aba90",203l,"In progress",new TriggerMethod[]{new TriggerMethod(false,"Complete","complete"),new TriggerMethod(false,"Stop","stop"),new TriggerMethod(false,"Suspend","suspend")}),
	NUMBEROFPOTENTIALOWNERS_(ACTIVE,"ff4d1190_32d0_4f72_bfea_c0fd84285293",206l,"NumberOfPotentialOwners ",new TriggerMethod[]{}),
	READY(ACTIVE,"7f5b4c74_f141_4cb6_b69d_cd8db569db87",204l,"Ready",new TriggerMethod[]{new TriggerMethod(false,"Claim","claim"),new TriggerMethod(false,"Suspend","suspend")}),
	RESERVED(ACTIVE,"02da48d2_5afb_45f5_826f_4df8e54de0e9",205l,"Reserved",new TriggerMethod[]{new TriggerMethod(false,"Revoke","revoke"),new TriggerMethod(false,"Start","start"),new TriggerMethod(false,"Suspend","suspend")}),
	SUSPENDED(null,"6386fe81_a224_4e33_b553_d1b447ac6da2",209l,"Suspended",new TriggerMethod[]{new TriggerMethod(false,"Resume","resume")}),
	...
	CREATED(null,"69363e0d_de8a_4640_b088_f4a354c5523a",214l,"Created",new TriggerMethod[]{new TriggerMethod(false,"Activate","activate")});
