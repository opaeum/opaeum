...
public class CalculateTimeBetweenHandler689 implements IEventHandler {
	...
	/** Default constructor for CalculateTimeBetweenHandler689
	 */
	public CalculateTimeBetweenHandler689() {
	}
	
	/** Constructor for CalculateTimeBetweenHandler689
	 * 
	 * @param fromDateTIme 
	 * @param toDateTime 
	 ...
	 * @param isEvent 
	 */
	public CalculateTimeBetweenHandler689(Date fromDateTIme, Date toDateTime, BusinessTimeUnit businessTimeUnit, Double result, boolean isEvent) {
	...
	public String getHandlerUuid() {
		return "OpiumBPM.library.uml@_mOhZgNcEEeCJ0dmaHEVVnw";
	}
	...
	public Collection<PropertyValue> marshall() {
		...
		result.add(new PropertyValue(692, Value.valueOf(this.getFromDateTIme())));
		result.add(new PropertyValue(691, Value.valueOf(this.getToDateTime())));
		result.add(new PropertyValue(690, Value.valueOf(this.getBusinessTimeUnit())));
		result.add(new PropertyValue(693, Value.valueOf(this.getResult())));
