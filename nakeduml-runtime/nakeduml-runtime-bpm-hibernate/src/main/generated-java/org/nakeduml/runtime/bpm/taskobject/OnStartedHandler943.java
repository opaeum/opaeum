...
public class OnStartedHandler943 implements ICallEventHandler {
	private boolean isEvent;
	private BusinessRole startedBy;
	private Date firstOccurrenceScheduledFor;

	/** Default constructor for OnStartedHandler943
	 */
	public OnStartedHandler943() {
	}
	
	/** Constructor for OnStartedHandler943
	 * 
	 * @param startedBy 
	 * @param isEvent 
	 */
	public OnStartedHandler943(BusinessRole startedBy, boolean isEvent) {
	...
	public Collection<PropertyValue> marshall() {
		...
		result.add(new PropertyValue(944, Value.valueOf(this.getStartedBy())));
