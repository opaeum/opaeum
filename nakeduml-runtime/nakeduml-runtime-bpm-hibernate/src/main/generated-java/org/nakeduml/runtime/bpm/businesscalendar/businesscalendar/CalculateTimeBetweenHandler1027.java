...
public class CalculateTimeBetweenHandler1027 implements ICallEventHandler {
	...
	/** Default constructor for CalculateTimeBetweenHandler1027
	 */
	public CalculateTimeBetweenHandler1027() {
	}
	
	/** Constructor for CalculateTimeBetweenHandler1027
	 * 
	 * @param fromDateTIme 
	 * @param toDateTime 
	 ...
	 * @param isEvent 
	 */
	public CalculateTimeBetweenHandler1027(Date fromDateTIme, Date toDateTime, BusinessTimeUnit businessTimeUnit, Double result, boolean isEvent) {
	...
	public Collection<PropertyValue> marshall() {
		...
		result.add(new PropertyValue(1028, Value.valueOf(this.getFromDateTIme())));
		result.add(new PropertyValue(1029, Value.valueOf(this.getToDateTime())));
		result.add(new PropertyValue(1031, Value.valueOf(this.getBusinessTimeUnit())));
		result.add(new PropertyValue(1030, Value.valueOf(this.getResult())));
