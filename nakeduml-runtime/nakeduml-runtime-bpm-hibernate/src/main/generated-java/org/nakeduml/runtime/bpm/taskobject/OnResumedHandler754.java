...
public class OnResumedHandler754 implements IEventHandler {
	private BusinessRole resumedBy;
	private boolean isEvent;
	private Date firstOccurrenceScheduledFor;

	/** Default constructor for OnResumedHandler754
	 */
	public OnResumedHandler754() {
	}
	
	/** Constructor for OnResumedHandler754
	 * 
	 * @param resumedBy 
	 * @param isEvent 
	 */
	public OnResumedHandler754(BusinessRole resumedBy, boolean isEvent) {
	...
	public String getHandlerUuid() {
		return "OpiumBPM.library.uml@_8ba9IK0NEeCK48ywUpk_rg";
	}
	...
	public Collection<PropertyValue> marshall() {
		...
		result.add(new PropertyValue(755, Value.valueOf(this.getResumedBy())));
