...
public class DelegateHandler732 implements IEventHandler {
	private BusinessRole delegate;
	private boolean isEvent;
	private Date firstOccurrenceScheduledFor;

	/** Default constructor for DelegateHandler732
	 */
	public DelegateHandler732() {
	}
	
	/** Constructor for DelegateHandler732
	 * 
	 * @param delegate 
	 * @param isEvent 
	 */
	public DelegateHandler732(BusinessRole delegate, boolean isEvent) {
	...
	public String getHandlerUuid() {
		return "OpiumBPM.library.uml@_0lAQAIoaEeCPduia_-NbFw";
	}
	...
	public Collection<PropertyValue> marshall() {
		...
		result.add(new PropertyValue(733, Value.valueOf(this.getDelegate())));
