...
public class OnRevokedHandler936 implements ICallEventHandler {
	private boolean isEvent;
	private Date firstOccurrenceScheduledFor;
	private BusinessRole revokedBy;

	/** Default constructor for OnRevokedHandler936
	 */
	public OnRevokedHandler936() {
	}
	
	/** Constructor for OnRevokedHandler936
	 * 
	 * @param revokedBy 
	 * @param isEvent 
	 */
	public OnRevokedHandler936(BusinessRole revokedBy, boolean isEvent) {
	...
	public Collection<PropertyValue> marshall() {
		...
		result.add(new PropertyValue(937, Value.valueOf(this.getRevokedBy())));
