...
public class ForwardHandler171 implements ICallEventHandler {
	private boolean isEvent;
	private BusinessRole toPerson;
	private Date firstOccurrenceScheduledFor;

	/** Default constructor for ForwardHandler171
	 */
	public ForwardHandler171() {
	}
	
	/** Constructor for ForwardHandler171
	 * 
	 * @param toPerson 
	 * @param isEvent 
	 */
	public ForwardHandler171(BusinessRole toPerson, boolean isEvent) {
	...
	public Collection<PropertyValue> marshall() {
		...
		result.add(new PropertyValue(172, Value.valueOf(this.getToPerson())));
