...
public class OnActivatedHandler959 implements ICallEventHandler {
	private boolean isEvent;
	private BusinessRole activatedBy;
	private Date firstOccurrenceScheduledFor;

	/** Default constructor for OnActivatedHandler959
	 */
	public OnActivatedHandler959() {
	}
	
	/** Constructor for OnActivatedHandler959
	 * 
	 * @param activatedBy 
	 * @param isEvent 
	 */
	public OnActivatedHandler959(BusinessRole activatedBy, boolean isEvent) {
	...
	public Collection<PropertyValue> marshall() {
		...
		result.add(new PropertyValue(960, Value.valueOf(this.getActivatedBy())));
