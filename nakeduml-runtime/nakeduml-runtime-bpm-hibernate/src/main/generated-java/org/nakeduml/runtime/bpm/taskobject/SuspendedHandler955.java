...
public class SuspendedHandler955 implements ICallEventHandler {
	private boolean isEvent;
	private Date firstOccurrenceScheduledFor;
	private BusinessRole suspendedBy;

	/** Default constructor for SuspendedHandler955
	 */
	public SuspendedHandler955() {
	}
	
	/** Constructor for SuspendedHandler955
	 * 
	 * @param suspendedBy 
	 * @param isEvent 
	 */
	public SuspendedHandler955(BusinessRole suspendedBy, boolean isEvent) {
	...
	public Collection<PropertyValue> marshall() {
		...
		result.add(new PropertyValue(956, Value.valueOf(this.getSuspendedBy())));
