...
public class OnActivatedHandler54 implements IEventHandler {
	private BusinessRole activatedBy;
	private boolean isEvent;
	private Date firstOccurrenceScheduledFor;

	/** Default constructor for OnActivatedHandler54
	 */
	public OnActivatedHandler54() {
	}
	
	/** Constructor for OnActivatedHandler54
	 * 
	 * @param activatedBy 
	 * @param isEvent 
	 */
	public OnActivatedHandler54(BusinessRole activatedBy, boolean isEvent) {
	...
	public String getHandlerUuid() {
		return "5ca783d9_68c7_4b5a_9da9_38bc6f5e37f2";
	}
	...
	public Collection<PropertyValue> marshall() {
		...
		result.add(new PropertyValue(55, Value.valueOf(this.getActivatedBy())));
