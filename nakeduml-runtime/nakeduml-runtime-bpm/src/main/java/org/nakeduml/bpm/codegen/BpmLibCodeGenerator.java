...
import net.sf.nakeduml.javageneration.jbpm5.SignalListenerImplementor;
...
public class BpmLibCodeGenerator{
	...
	protected void generateCodeForSingleModel() throws Exception,IOException,FileNotFoundException{
		modelFile = new File("/home/ampie/workspace_sandbox/nakeduml/nakeduml-core/org.nakeduml.metamodels/libraries/NakedUMLLibraryForBPM.uml");
		EmfWorkspace workspace = EmfWorkspaceLoader.loadSingleModelWorkspace(resourceSet, modelFile, "nakeduml");
	...
	protected Set<Class<? extends TransformationStep>> getSteps(){
		...
		steps.add(SignalListenerImplementor.class);
	...
	private void mapDomainProjects(NakedUmlConfig cfg){
		OutputRoot generatedJava = cfg.mapOutputRoot(JavaTextSource.OutputRootId.DOMAIN_GEN_SRC, true, "-runtime-bpm", "src/main/generated-java");
		cfg.mapOutputRoot(JavaTextSource.OutputRootId.DOMAIN_GEN_TEST_SRC, true, "-runtime-bpm", "src/test/generated-java");
		OutputRoot domainSrc = cfg.mapOutputRoot(JavaTextSource.OutputRootId.DOMAIN_SRC, true, "-runtime-bpm", "src/main/java");
		domainSrc.dontCleanDirectoriesOrOverwriteFiles();
		OutputRoot domainTestSrc = cfg.mapOutputRoot(JavaTextSource.OutputRootId.DOMAIN_TEST_SRC, true, "-runtime-bpm", "src/test/java");
		domainTestSrc.dontCleanDirectoriesOrOverwriteFiles();
		cfg.mapOutputRoot(CharArrayTextSource.OutputRootId.DOMAIN_GEN_TEST_RESOURCE, true, "-runtime-bpm", "src/test/generated-resources");
		cfg.mapOutputRoot(CharArrayTextSource.OutputRootId.DOMAIN_GEN_RESOURCE, true, "-runtime-bpm", "src/main/generated-resources");
	}
	private void mapAdaptorProjects(NakedUmlConfig cfg){
		cfg.mapOutputRoot(JavaTextSource.OutputRootId.ADAPTOR_GEN_SRC, true, "-runtime-bpm", "src/main/generated-java");
		cfg.mapOutputRoot(CharArrayTextSource.OutputRootId.ADAPTOR_GEN_RESOURCE, true, "-runtime-bpm", "src/main/generated-resources");
		cfg.mapOutputRoot(JavaTextSource.OutputRootId.ADAPTOR_GEN_TEST_SRC, true, "-runtime-bpm", "src/test/generated-java");
		OutputRoot testSource = cfg.mapOutputRoot(JavaTextSource.OutputRootId.ADAPTOR_TEST_SRC, true, "-runtime-bpm", "src/test/java");
		testSource.dontCleanDirectories();
		OutputRoot jbossResources = cfg.mapOutputRoot(CharArrayTextSource.OutputRootId.ADAPTOR_TEST_RESOURCE_JBOSSAS, true, "-runtime-bpm",
				"src/test/jboss-resources");
		jbossResources.dontCleanDirectoriesOrOverwriteFiles();
		OutputRoot testResources = cfg.mapOutputRoot(CharArrayTextSource.OutputRootId.ADAPTOR_TEST_RESOURCE, true, "-runtime-bpm", "src/test/resources");
		testResources.dontCleanDirectoriesOrOverwriteFiles();
		cfg.mapOutputRoot(CharArrayTextSource.OutputRootId.ADAPTOR_GEN_TEST_RESOURCE, true, "-runtime-bpm", "src/test/generated-resources");
		OutputRoot mainResources = cfg.mapOutputRoot(CharArrayTextSource.OutputRootId.ADAPTOR_RESOURCE, true, "-runtime-bpm", "src/main/resources");
