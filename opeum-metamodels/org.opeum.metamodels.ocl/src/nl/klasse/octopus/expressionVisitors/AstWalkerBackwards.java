...
/** An AstWalkerVackwards navigates the full OCL Abstract Syntax Tree. It implements 
 ...
 * or aap - noot - mies. This class navigates the expression from last applied property to source, that is 
 * in the order mies - noot - aap. The class AstWalker implements the other navigation route.
 * <p>
 * Users must implement IAstVisitorBackwards and call <code>walk(expression, visitor)</code>.
 * <p>
 * Example usage:
 * <p>
...
public class AstWalkerBackwards {
	 ...
	 * @return
	 */
	public Object walk(IOclExpression exp, IAstVisitorBackwards visitor) {
		IPropertyCallExp last = exp.getLastAppliedProperty();
		if( last == null ) {
			return visitNode(exp, visitor);
		} else {
			return visitPropertyCallExp(last, visitor);
		}
	}
	
	private Object visitNode(IOclExpression exp, IAstVisitorBackwards visitor) {
		Object result = null;
		if( exp instanceof IIfExp ) {
			...
			result = visitUnspecifiedValueExp((IUnspecifiedValueExp )exp, visitor);
		} else {
			System.err.println("AstWalker.visitNode incorrect expression node");
			System.err.println("OclExpression: " + exp);
		}
		return result;
	}
	 ...
	 * @return
	 */
	private Object visitPropertyCallExp(IPropertyCallExp exp, IAstVisitorBackwards visitor) {
	 ...
	 * @return
	 */
	private Object visitLoopExp(ILoopExp exp, IAstVisitorBackwards visitor) {
	 ...
	 * @return
	 */
	private Object visitIteratorExp(IIteratorExp exp, IAstVisitorBackwards visitor) {
		...
		if( exp.getSource() != null ) {
		  source = visitNode( exp.getSource(), visitor);
		}
		return visitor.iteratorExp(exp, source, its, bodyResult);
	}
	 ...
	 * @return
	 */
	private Object visitIterateExp(IIterateExp exp, IAstVisitorBackwards visitor) {
		List<Object> its = new ArrayList<Object>();
		Iterator it = exp.getIterators().iterator();
		while( it.hasNext() ){
			IVariableDeclaration var = (IVariableDeclaration ) it.next();
		...
		return visitor.iterateExp(exp, source, resultVar, its, bodyResult);
	}
	 ...
	 * @return
	 */
	private Object visitUnspecifiedValueExp(IUnspecifiedValueExp exp, IAstVisitorBackwards visitor) {
		return visitor.unspecifiedValueExp(exp);
	}
	 ...
	 * @return
	 */
	private Object visitLetExp(ILetExp exp, IAstVisitorBackwards visitor) {
	 ...
	 * @return
	 */
	private Object visitVariableDeclaration(IVariableDeclaration declaration, IAstVisitorBackwards visitor) {
		Object init ;
	 ...
	 * @return
	 */
	private Object visitVariableExp(IVariableExp exp, IAstVisitorBackwards visitor) {
		return visitor.variableExp(exp);
	}

	private Object visitModelPropertyCallExp(IModelPropertyCallExp exp, IAstVisitorBackwards visitor){
	 ...
	 * @return
	 */
	private Object visitNavigationCallExp(INavigationCallExp exp, IAstVisitorBackwards visitor) {
	 ...
	 * @return
	 */
	private Object visitAssociationClassCallExp(IAssociationClassCallExp exp, IAstVisitorBackwards visitor) {
		Object source = "";
		if( exp.getSource() != null ) {
		  source = visitNode( exp.getSource(), visitor);
		}
		return visitor.associationClassCallExp(exp, source);
	}
	 ...
	 * @return
	 */
	private Object visitOperationCallExp(IOperationCallExp exp, IAstVisitorBackwards visitor) {
		...
		return visitor.operationCallExp(exp, source, args);
	}    

	private Object visitLiteralExp(ILiteralExp exp, IAstVisitorBackwards visitor){
	 ...
	 * @return
	 */
	private Object visitTupleLiteralExp(ITupleLiteralExp exp, IAstVisitorBackwards visitor) {
	 ...
	 * @return
	 */
	private Object visitOclTypeLiteralExp(IOclTypeLiteralExp exp, IAstVisitorBackwards visitor) {
	 ...
	 * @return
	 */
	private Object visitOclStateLiteralExp(IOclStateLiteralExp exp, IAstVisitorBackwards visitor) {
	 ...
	 * @return
	 */
	private Object visitEnumLiteralExp(IEnumLiteralExp exp, IAstVisitorBackwards visitor) {
	 ...
	 * @return
	 */
	private Object visitCollectionLiteralExp(ICollectionLiteralExp exp, IAstVisitorBackwards visitor) {
	 ...
	 * @return
	 */
	private Object visitAttributeCallExp(IAttributeCallExp exp, IAstVisitorBackwards visitor) {
		Object source = "";
		if( exp.getSource() != null ) {
		  source = visitNode( exp.getSource(), visitor);
		}
		return visitor.attributeCallExp(exp, source);
	}
	 ...
	 * @return
	 */
	private Object visitAssociationEndCallExp(IAssociationEndCallExp exp, IAstVisitorBackwards visitor) {
		Object source = "";
		if( exp.getSource() != null ) {
		  source = visitNode( exp.getSource(), visitor);
		}
		return visitor.associationEndCallExp(exp, source);
	}
	 ...
	 * @return
	 */
	private Object visitBooleanLiteralExp(IBooleanLiteralExp exp, IAstVisitorBackwards visitor) {
	 ...
	 * @return
	 */
	private Object visitOclUndefinedLiteralExp(IOclUndefinedLiteralExp exp, IAstVisitorBackwards visitor) {
	 ...
	 * @return
	 */
	private Object visitRealLiteralExp(IRealLiteralExp exp, IAstVisitorBackwards visitor) {
	 ...
	 * @return
	 */
	private Object visitStringLiteralExp(IStringLiteralExp exp, IAstVisitorBackwards visitor) {
	 ...
	 * @return
	 */
	private Object visitIntegerLiteralExp(IIntegerLiteralExp exp, IAstVisitorBackwards visitor) {
	 ...
	 * @return
	 */
	private Object visitIfExp(IIfExp exp, IAstVisitorBackwards visitor) {
