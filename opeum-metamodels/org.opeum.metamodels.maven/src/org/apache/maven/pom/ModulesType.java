 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom.ModulesType#getModule <em>Module</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.apache.maven.pom.POMPackage#getModulesType()
...
public interface ModulesType extends EObject {
	 ...
	 * @see org.apache.maven.pom.POMPackage#getModulesType_Module()
