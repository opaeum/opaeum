 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom.ExcludesType#getExclude <em>Exclude</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.apache.maven.pom.POMPackage#getExcludesType()
...
public interface ExcludesType extends EObject {
	 ...
	 * @see org.apache.maven.pom.POMPackage#getExcludesType_Exclude()
