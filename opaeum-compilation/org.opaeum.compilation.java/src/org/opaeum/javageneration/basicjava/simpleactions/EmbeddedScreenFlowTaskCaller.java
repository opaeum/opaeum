...
public class EmbeddedScreenFlowTaskCaller extends AbstractBehaviorCaller<CallBehaviorAction>{
	...
	protected void maybeStartBehavior(OJAnnotatedOperation operation,OJBlock block,PropertyMap resultMap){
		...
		taskUtil.implementAssignmentsAndEventGeneration(operation, block, getLibrary().getResponsibilityDefinition( node, StereotypeNames.EMBEDDED_SCREEN_FLOW_TASK), taskName );
