...
public class TupleTypeCreator extends DataTypeCreator {
		...
		while (it.hasNext()) {
			...
			constr.getBody().addToStatements(
					"this." + getFieldName(decl) + " = "
							+ ExpGeneratorHelper.javaFieldName(decl));
			constr.addParam(ExpGeneratorHelper.javaFieldName(decl),
					mapper.javaTypePath());
	 ...
	 * @return
	 */
	private OJOperation createGetter(IVariableDeclaration decl,
	...
	private OJField make_attribute(IVariableDeclaration decl,
			ClassifierMap mapper) {
