...
public class BasicTypeOperCallCreator{
	...
	public String makeOperCall(OperationCallExp exp,String source,List args,Operation referedOp,List params){
		...
		if(EmfClassifierUtil.comformsToLibraryType(sourceType, IOclLibrary.BooleanTypeName)){
			result = booleanOperCall(exp, source, args, referedOp, params);
		}else if(EmfClassifierUtil.comformsToLibraryType(sourceType, IOclLibrary.StringTypeName)){
			result = stringOperCall(exp, source, args, referedOp, params);
		}else if(EmfClassifierUtil.comformsToLibraryType(sourceType, IOclLibrary.IntegerTypeName)){
			result = integerOperCall(exp, source, args, referedOp, params);
		}else if(EmfClassifierUtil.comformsToLibraryType(sourceType, IOclLibrary.RealTypeName)){
	...
	private String integerOperCall(OperationCallExp exp,String source,List args,Operation referedOp,List params){
		String result = "";
		if(referedOp != null){
	 ...
	 * @return
	 */
	private String realOperCall(OperationCallExp exp,String source,List args,Operation referedOp,List params){
		String result = "";
		if(referedOp != null){
			if(referedOp.getName().equals("asBag")){
				myClass.addToImports(OclUtilityCreator.getStdlibPath());
	...
	private String booleanOperCall(OperationCallExp exp,String source,List args,Operation referedOp,List params){
		String result = "";
		String argStr = "";
		if(referedOp != null){
			if(!args.isEmpty()){
	...
	private String numericOperCall(OperationCallExp exp,String source,List args,Operation referedOp,List params){
		String result = "";
		String argStr = "";
		if(referedOp != null){
			if(!args.isEmpty()){
	...
	private String stringOperCall(OperationCallExp exp,String source,List args,Operation referedOp,List params){
		String result = "";
		String argStr = "";
		if(referedOp != null){
			if(!args.isEmpty()){
