...
/* <octel/> */ 
	...
	public void structuralfeature(StructuralFeature feat) {
	...
	private void generateNonOptional(StructuralFeature att){
...
/* <octel/> */ 
	...
	private void generateUpper(StructuralFeature att, int upper) {
		FEATURE = new StructuralFeatureMap(att);
		owner.addToImports(ERROR_PATH);
...
/* <octel/> */ 
	...
	private void generateLower(StructuralFeature att, int lower) {
		FEATURE = new StructuralFeatureMap(att);
		owner.addToImports(ERROR_PATH);
