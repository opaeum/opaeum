...
/**<octel>
 <java>
 %import org.opaeum.javametamodel.OJWhileStatement%;
 %inet.sfsf.opaeum.javametamodelametamodel.model.OJForStatementnet.sf.sf.opaeum.javametamodell.javametamodel.model.OJSimpleStanet.sft.sf.opaeum.javametamodelkeduml.javametamodel.model.Onet.sfet.sf.opaeum.javametamodelsf.opaeum.javametamodel.model.OJBlock%;
 </java>
 </octel>*/
...
public class LoopExpCreator {
	 ...
	 * @return
	 */
	public String iteratorExp(IteratorExp exp, StringBuffer source,
	 ...
	 * @return
	 */
	public String iterateExp(IterateExp exp, StringBuffer source,
			boolean isStatic, List<OJParameter> params) {
		// get the result variable of the expression
		ExpressionCreator maker = new ExpressionCreator(myClass);
		String varDeclStr = maker.makeVarDecl((Variable) exp.getResult(),
				isStatic, params);
		List<OJParameter> bodyParams = ExpGeneratorHelper.addVarToParams(
				(Variable) exp.getResult(), params);
		String resultName = ExpGeneratorHelper.javaFieldName((Variable) exp
				.getResult());
		// get info
		...
		if (exp.getIterator().size() == 2) {
			...
			/* <exp> */
			OJSimpleStatement exp2 = new OJSimpleStatement("Iterator it = "
					+ source + ".iterator()");
			...
			/* <exp> */
			OJSimpleStatement exp3 = new OJSimpleStatement(myListType + " "
					+ iterVarNames[0] + " = (" + myListType + ") it.next()");
			...
			/* <exp> */
			OJSimpleStatement exp4 = new OJSimpleStatement(myListType + " "
					+ iterVarNames[1] + " = (" + myListType + ") it.next()");
			body3.addToStatements(exp4);

			/* <exp/> */

			/* <exp> */
			OJSimpleStatement exp5 = new OJSimpleStatement(resultName + " = "
					+ expStr);
			...
			/* <exp> */
			OJSimpleStatement exp6 = new OJSimpleStatement("return "
					+ resultName);
			...
			/**
			 * <octel var="myClass"> <method type="%resultTypePath%"
			 * name="%operName%" visibility="%priv%" static="%isStatic%"
			 * var="oper"> <comment> implements %exp.toString()% </comment>
			 * <paramlist> %params% </paramlist> <body> %varDeclStr%; <for
			 * name="%iterVarNames[0]%" type="%myListTypePath%">
			 * <collection>%source.toString()%</collection> <body> %resultName%
			 * = %expStr%; </body></for> return %resultName%; </body> </method>
			 * </octel>
			 */
			...
			/* <exp> */
			OJSimpleStatement exp8 = new OJSimpleStatement(resultName + " = "
					+ expStr);
			...
			/* <exp> */
			OJSimpleStatement exp9 = new OJSimpleStatement("return "
					+ resultName);
	...
	private String createCollect(IteratorExp exp, StringBuffer source,
			boolean isStatic, List<OJParameter> params) {
		// make sure expressions of primitive type can be added to a collection
		OCLExpression body = (OCLExpression) exp.getBody();
		expStr = ExpGeneratorHelper.makeListElem(myClass, body.getType(),
				expStr);
		//
		...
		/* <exp> */
		OJSimpleStatement exp10 = new OJSimpleStatement(resultType
		...
		/* <exp> */
		OJSimpleStatement exp11 = new OJSimpleStatement(expType
				+ " bodyExpResult = " + expStr);
	...
	private String createCollectNested(IteratorExp exp, StringBuffer source,
			boolean isStatic, List<OJParameter> params) {
		// make sure expressions of primitive type can be added to a collection
		expStr = ExpGeneratorHelper.makeListElem(myClass, exp.getBody()
				.getType(), expStr);
		// generate operation
		OJOperation oper = null;
		/**
		 * <octel var="myClass"> <method type="%resultTypePath%"
		 * name="%operName%" visibility="%priv%" static="%isStatic%" var="oper">
		 * <comment> implements %exp.toString()% </comment> <paramlist> %params%
		 * </paramlist> <body> %resultType% result = %resultDefault%; <for
		 * name="%iterVarNames[0]%" type="%myListTypePath%">
		 * <collection>%source.toString()%</collection> <body> %expType%
		 * bodyExpResult = %expStr%; if ( bodyExpResult != null ) result.add(
		 * bodyExpResult ); </body></for> return result; </body> </method>
		 * </octel>
		 */
		...
		/* <exp> */
		OJSimpleStatement exp14 = new OJSimpleStatement(resultType
				+ " result = " + resultDefault);
		...
		/* <exp> */
		OJSimpleStatement exp15 = new OJSimpleStatement(expType
				+ " bodyExpResult = " + expStr);
		...
		/* <exp> */
		OJSimpleStatement exp16 = new OJSimpleStatement(
	...
	private String createSortedBy(IteratorExp exp, StringBuffer source,
			boolean isStatic, List<OJParameter> params) {
		...
		OJPathName comparatorClassName = ComparatorCreator.makeComparator(
				elementType, exp.getBody().getType(), expStr, iterVarName);
		 ...
		 * name="%operName%" visibility="%priv%" static="%isStatic%" var="oper">
		 * <comment> implements %exp.toString()% </comment> <paramlist> %params%
		 * </paramlist> <body> %resultType% result = %resultDefault%;
		 * result.addAll(%source%); //
		 * System.out.println("BEFORE SORTING ON %expStr%"); //
		 * System.out.println(Util.collectionToString(result, "\\n")); // create
		 * a new Comparator instance; Comparator comp = new
		 * %comparatorClassName.getLast()%(); // sort the result collection;
		 * Collections.sort(result, comp); //
		 * System.out.println("AFTER SORTING ON %expStr%"); //
		 * System.out.println(Util.collectionToString(result, "\\n")); return
		 * result; </body> </method> </octel>
		 */
		...
		/* <exp> */
		OJSimpleStatement exp18 = new OJSimpleStatement(resultType
				+ " result = " + resultDefault);
		...
		/* <exp> */
		OJSimpleStatement exp19 = new OJSimpleStatement("result.addAll("
				+ source + ")");
		...
		/* <exp> */
		OJSimpleStatement exp20 = new OJSimpleStatement(
				"// System.out.println(\"BEFORE SORTING ON " + expStr + "\")");
		...
		/* <exp> */
		OJSimpleStatement exp21 = new OJSimpleStatement(
				"// System.out.println(Util.collectionToString(result, \"\\n\"))");
		...
		/* <exp> */
		OJSimpleStatement exp22 = new OJSimpleStatement(
		...
		/* <exp> */
		OJSimpleStatement exp23 = new OJSimpleStatement(
		...
		/* <exp> */
		OJSimpleStatement exp24 = new OJSimpleStatement(
		...
		/* <exp> */
		OJSimpleStatement exp25 = new OJSimpleStatement(
				"Collections.sort(result, comp)");
		...
		/* <exp> */
		OJSimpleStatement exp26 = new OJSimpleStatement(
				"// System.out.println(\"AFTER SORTING ON " + expStr + "\")");
		...
		/* <exp> */
		OJSimpleStatement exp27 = new OJSimpleStatement(
				"// System.out.println(Util.collectionToString(result, \"\\n\"))");
	...
	private String createSelect(IteratorExp exp, StringBuffer source,
			boolean isStatic, List<OJParameter> params) {
		// generate operation
		OJOperation oper = null;
		/**
		 ...
		 * </paramlist> <body> %resultType% result = %resultDefault%; <for
		 * name="%iterVarNames[0]%" type="%myListTypePath%">
		 * <collection>%source.toString()%</collection> <body> <if> %expStr%
		 * <then> result.add( %iterVarNames[0]% ); </then></if> </body></for>
		 * return result; </body> </method> </octel>
		 */
		...
		/* <exp> */
		OJSimpleStatement exp29 = new OJSimpleStatement(resultType
				+ " result = " + resultDefault);
		...
		/* <exp> */
		OJSimpleStatement exp30 = new OJSimpleStatement("result.add( "
				+ iterVarNames[0] + " )");
	...
	private String createReject(IteratorExp exp, StringBuffer source,
			boolean isStatic, List<OJParameter> params) {
		...
		/* <exp> */
		OJSimpleStatement exp32 = new OJSimpleStatement(resultType
				+ " result = " + resultDefault);
		...
		/* <exp> */
		OJSimpleStatement exp33 = new OJSimpleStatement("result.add( "
				+ iterVarNames[0] + " )");
	...
	private String createAny(IteratorExp exp, StringBuffer source,
			boolean isStatic, List<OJParameter> params) {
		// generate operation
		OJOperation oper = null;
		/**
		 * <octel var="myClass"> <method type="%myListTypePath%"
		 * name="%operName%" visibility="%priv%" static="%isStatic%" var="oper">
		 * <comment> implements %exp.toString()% </comment> <paramlist> %params%
		 * </paramlist> <body> %myListType% result = %myListDefault%; <for
		 * name="%iterVarNames[0]%" type="%myListTypePath%">
		 * <collection>%source.toString()%</collection> <body> <if> %expStr%
		 * <then> return %iterVarNames[0]%; </then></if> </body></for> return
		 * result; </body> </method> </octel>
		 */
		...
		/* <exp> */
		OJSimpleStatement exp35 = new OJSimpleStatement(myListType
				+ " result = " + myListDefault);
		...
		/* <exp> */
		OJSimpleStatement exp36 = new OJSimpleStatement("return "
				+ iterVarNames[0]);
	...
	private String createOne(IteratorExp exp, StringBuffer source,
			boolean isStatic, List<OJParameter> params) {
		// generate operation
		OJOperation oper = null;
		/**
		 ...
		 * name="%operName%" visibility="%priv%" static="%isStatic%" var="oper">
		 * <comment> implements %exp.toString()% </comment> <paramlist> %params%
		 * </paramlist> <body> int _genNr = 0; <for name="%iterVarNames[0]%"
		 * type="%myListTypePath%"> <collection>%source.toString()%</collection>
		 * <body> <if> %expStr% <then> _genNr++; </then></if> </body></for> <if>
		 * _genNr != 1 <then> return false; </then></if> return true; </body>
		 * </method> </octel>
		 */
	...
	private String createIsUnique(IteratorExp exp, StringBuffer source,
			boolean isStatic, List<OJParameter> params) {
		expStr = ExpGeneratorHelper.makeListElem(myClass, exp.getBody()
				.getType(), expStr);
		ClassifierMap map = new ClassifierMap(exp.getBody().getType());
		 ...
		 * name="%operName%" visibility="%priv%" static="%isStatic%" var="oper">
		 * <comment> implements %exp.toString()% </comment> <paramlist> %params%
		 * </paramlist> <body> %valueType.getCollectionTypeName()%
		 * _valuesInSource = new %valueImplType.getCollectionTypeName()%(); <for
		 * name="%iterVarNames[0]%" type="%myListTypePath%">
		 * <collection>%source.toString()%</collection> <body> <if>
		 * _valuesInSource.contains(%expStr%) <then> return false; </then></if>
		 * _valuesInSource.add(%expStr%); </body></for> return true; </body>
		 * </method> </octel>
		 */
		...
		/* <exp> */
		OJSimpleStatement exp42 = new OJSimpleStatement(
				valueType.getCollectionTypeName() + " _valuesInSource = new "
						+ valueImplType.getCollectionTypeName() + "()");
		...
		/* <exp> */
		OJSimpleStatement exp44 = new OJSimpleStatement("_valuesInSource.add("
				+ expStr + ")");
	...
	private String createExists(IteratorExp exp, StringBuffer source,
			boolean isStatic, List<OJParameter> params) {
		// generate operation
		OJOperation oper = null;
		/**
		 ...
		 * name="%operName%" visibility="%priv%" static="%isStatic%" var="oper">
		 * <comment> implements %exp.toString()% </comment> <paramlist> %params%
		 * </paramlist> <body> <for name="%iterVarNames[0]%"
		 * type="%myListTypePath%"> <collection>%source.toString()%</collection>
		 * <body> <if> %expStr% <then> return true; </then></if> </body></for>
		 * return false; </body> </method> </octel>
		 */
	...
	private String createForAll(IteratorExp exp, StringBuffer source,
			boolean isStatic, List<OJParameter> params) {
		expStr = StringHelpers.addBrackets(expStr);
		OJOperation oper = null;
		if (iterVarNames.length == 1) {
			// generate operation
			/**
			 * <octel var="myClass"> <method type="%JavaPathNames.Bool%"
			 * name="%operName%" visibility="%priv%" static="%isStatic%"
			 * var="oper"> <comment> implements %exp.toString()% </comment>
			 * <paramlist> %params% </paramlist> <body> <for
			 * name="%iterVarNames[0]%" type="%myListTypePath%">
			 * <collection>%source.toString()%</collection> <body> <if>
			 * !%expStr% <then> return false; </then></if> </body></for> return
			 * true; </body> </method> </octel>
			 */
			 ...
			 * <paramlist> %params% </paramlist> <body> <for
			 * name="%iterVarNames[0]%" type="%myListTypePath%">
			 * <collection>%source.toString()%</collection> <body> <for
			 * name="%iterVarNames[1]%" type="%myListTypePath%">
			 * <collection>%source.toString()%</collection> <body> <if>
			 * !%expStr% <then> return false; </then></if> </body></for>
			 * </body></for> return true; </body> </method> </octel>
			 */
	 ...
	 * @param params
	 */
	private void setVariables(LoopExp exp, boolean isStatic,
			List<OJParameter> params) {
		ClassifierMap nodeMap = new ClassifierMap(exp.getType());
		...
		List<OJParameter> loopParams = addItersToParams(exp.getIterator(),
				params);
		expStr = myExpMaker.makeExpression((OCLExpression) exp.getBody(),
				isStatic, loopParams);
		ClassifierMap map = new ClassifierMap(exp.getBody().getType());
	 ...
	 * implementing the body expression. This method add the iterator
	...
	// used
	private List<OJParameter> addItersToParams(
			EList<org.eclipse.ocl.expressions.Variable<Classifier, Parameter>> eList,
			List<OJParameter> params) {
		...
		while (outerIt.hasNext()) {
			...
			while (innerIt.hasNext()) {
				...
				if (ExpGeneratorHelper.javaFieldName(elem)
						.equals(par.getName())) {
					result.remove(par);
				}
			}
