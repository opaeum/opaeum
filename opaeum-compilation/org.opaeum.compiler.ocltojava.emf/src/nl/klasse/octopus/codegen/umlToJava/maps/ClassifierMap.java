...
public class ClassifierMap extends PackageableElementMap {
	...
	public ClassifierMap(Classifier modelClass) {
		...
		Check.pre("ClassifierMap constructor: modelClass is null",
				modelClass != null);
	...
	public boolean isJavaPrimitive() {
		...
		return javatype.equals("int") || javatype.equals("float")
	...
	/**
	 * The java type of the default value for this class. Note that this type
	 * may be different form the java type for this class. E.g. the java type
	 * for the default value of an OCL sequence is <code>ArrayList</code>,
	...
	public OJPathName javaElementTypePath() {
		Check.pre(
				"ClassMap.javaElementType called for non-collection attribute",
				isCollection());
		if (elementMap != null) {
	 ...
	 * this method returns the path of the java type of the facade of the
	 * elements in the collection. E.g. the java element facade type of a
	 * Sequence of <code>pack1.SomeClass</code> objects is
	...
	public OJPathName javaElementFacadeTypePath() {
		Check.pre(
				"ClassMap.elementFacadeTypePath called for non-collection attribute",
				isCollection());
		if (elementMap != null) {
			return elementMap.javaTypePath();
		}
	...
	/**
	 * If this classifier represents a collection, this method returns the path
	 * of the java type of the default initial value of the elements in the
	 * collection. E.g. the java element type of Sequence{Set{1,2,3}} is
	 * <code>HashSet</code>.
	 * 
	 * @return
	 */
	public OJPathName javaElementDefaultTypePath() {
		Check.pre(
				"ClassMap.javaElementDefaultValue called for non-collection attribute",
				isCollection());
		if (elementMap != null) {
	...
	/**
	 * If this classifier represents a collection, this method returns the java
	 * default initial value of the elements in the collection. E.g. the java
	 * default initial value of Sequence{1,2,3} is <code>0</code>.
	 * 
	 * @return
	 */
	...
	public OJPathName javaElementObjectTypePath() {
		Check.pre(
				"ClassMap.javaElementObjectTypePath called for non-collection attribute",
				isCollection());
		Check.pre(
				"ClassMap.javaElementObjectTypePath called for non-primitive element type",
				elementMap.isJavaPrimitive());
		if (elementMap != null) {
	...
	public OJPathName javaObjectTypePath() {
		Check.pre("javaObjectType called for non primitive type",
				isUmlPrimitive());
	...
	/*
	 * A SET OF CONVIENCE OPERATIONS THAT RETURN A STRING REPRESENTATION OF THE
	 * CORRESPONDING OJPATHNAME
	 */
	/**
	 * The Java class name without any prefix, but with element types if the UML
	 * classifier is a collection. E.g. Set<Book>, Chapter.
	 * 
	 * @return String
	 */
	...
	/**
	 * If this classifier has a facade interface, this method returns the name
	 * of the java type of that facade interface. If the classifier does not
	 * have a facade interface, the name of the java type for the classifier is
	 * returned.
	 * 
	 * @return
	 */
	...
	/**
	 * If this classifier represents a collection, this method returns the java
	 * type of the elements in the collection. E.g. the java element type of
	 * Sequence{1,2,3} is <code>int</code>.
	 * 
	 * @return
	 */
	...
	/**
	 * If this classifier represents a collection, this method returns the name
	 * of the java type of the default initial value of the elements in the
	 * collection. E.g. the java element type of Sequence{Set{1,2,3}} is
	 * <code>HashSet</code>.
	 * 
