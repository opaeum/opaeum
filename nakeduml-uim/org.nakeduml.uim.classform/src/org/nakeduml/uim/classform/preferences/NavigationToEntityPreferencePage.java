 ...
 * @generated
 */
public class NavigationToEntityPreferencePage extends AbstractNodePreferencePage{
	/**
	...
	protected String getNodeBackgroundColor(){
		return ClassFormDiagramPreferenceConstants.NAVIGATIONTOENTITY_DEFAULT_BACKGROUND_COLOR;
	}
	/**
	...
	protected String getNodeFont(){
		return ClassFormDiagramPreferenceConstants.NAVIGATIONTOENTITY_DEFAULT_FONT;
	}
	/**
	...
	protected String getNodeForegroundColor(){
		return ClassFormDiagramPreferenceConstants.NAVIGATIONTOENTITY_DEFAULT_FOREGROUND_COLOR;
	}
	/**
