...
public class ClassFormPaletteManager extends ModelerPaletteManager{
	...
	private void createControlsDrawer(){
		...
		factory = new GraphElementCreationFactory(creationUtils, ActionPackage.eINSTANCE.getNavigationToEntity(), "default");
		...
		factory = new GraphElementCreationFactory(creationUtils, ActionPackage.eINSTANCE.getNavigationToOperation(), "default");
		...
		factory = new GraphElementCreationFactory(creationUtils, ActionPackage.eINSTANCE.getOperationAction(), "default");
		...
		factory = new GraphElementCreationFactory(creationUtils, ActionPackage.eINSTANCE.getBuiltInAction(), "default");
		...
		factory = new GraphElementCreationFactory(creationUtils, ActionPackage.eINSTANCE.getTransitionAction(), "default");
	...
	private void createContainersDrawer(){
		...
		List<PaletteEntry> entries = new ArrayList<PaletteEntry>();
		CreationFactory factory;
		factory = new GraphElementCreationFactory(creationUtils, FormPackage.eINSTANCE.getFormPanel(), "default");
		...
		factory = new GraphElementCreationFactory(creationUtils, FormPackage.eINSTANCE.getDetailPanel(), "default");
	...
	private void createLayoutsDrawer(){
		...
		List<PaletteEntry> entries = new ArrayList<PaletteEntry>();
		CreationFactory factory;
		factory = new GraphElementCreationFactory(creationUtils, LayoutPackage.eINSTANCE.getUimXYLayout(), "default");
		...
		factory = new GraphElementCreationFactory(creationUtils, LayoutPackage.eINSTANCE.getUimGridLayout(), "default");
		...
		factory = new GraphElementCreationFactory(creationUtils, LayoutPackage.eINSTANCE.getUimToolbarLayout(), "default");
		...
		factory = new GraphElementCreationFactory(creationUtils, LayoutPackage.eINSTANCE.getUimBorderLayout(), "default");
