...
/**
 * This is the item provider adapter for a {@link org.nakeduml.uim.form.DetailPanel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DetailPanelItemProvider
	 ...
	 * @generated
	 */
	public DetailPanelItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FormPackage.Literals.DETAIL_PANEL__MASTER_COMPONENT,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DetailPanel"));
	}
	...
	public String getText(Object object) {
		String label = ((DetailPanel)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DetailPanel_type") :
			getString("_UI_DetailPanel_type") + " " + label;
	}
