...
/**
 * This is the item provider adapter for a {@link org.nakeduml.uim.layout.UimGridLayout} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UimGridLayoutItemProvider
	 ...
	 * @generated
	 */
	public UimGridLayoutItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LayoutPackage.Literals.UIM_GRID_LAYOUT__NUMBER_OF_COLUMNS,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns UimGridLayout.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UimGridLayout"));
	}
	...
	public String getText(Object object) {
		String label = ((UimGridLayout)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UimGridLayout_type") :
			getString("_UI_UimGridLayout_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UimGridLayout.class)) {
