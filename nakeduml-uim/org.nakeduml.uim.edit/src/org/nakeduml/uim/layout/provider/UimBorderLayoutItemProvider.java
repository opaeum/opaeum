...
/**
 * This is the item provider adapter for a {@link org.nakeduml.uim.layout.UimBorderLayout} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UimBorderLayoutItemProvider
	extends UimLayoutItemProvider
	implements
	 ...
	 * @generated
	 */
	public UimBorderLayoutItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LayoutPackage.Literals.UIM_BORDER_LAYOUT__HORIZONTAL,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns UimBorderLayout.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UimBorderLayout"));
	}
	...
	public String getText(Object object) {
		String label = ((UimBorderLayout)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UimBorderLayout_type") :
			getString("_UI_UimBorderLayout_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UimBorderLayout.class)) {
			case LayoutPackage.UIM_BORDER_LAYOUT__HORIZONTAL:
