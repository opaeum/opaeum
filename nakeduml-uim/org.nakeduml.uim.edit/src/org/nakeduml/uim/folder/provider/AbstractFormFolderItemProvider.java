...
/**
 * This is the item provider adapter for a {@link org.nakeduml.uim.folder.AbstractFormFolder} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractFormFolderItemProvider
	 ...
	 * @generated
	 */
	public AbstractFormFolderItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractFormFolder)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractFormFolder_type") :
			getString("_UI_AbstractFormFolder_type") + " " + label;
	}
