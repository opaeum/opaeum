...
/** The StdlibBasic class is responsible for creating the basic types of
 *  the OCL Standard Library. It contains static operations only.
 * 
 * @author  Jos Warmer
...
// String
        ...
        OCL_String.addOperation( new StdlibOperation("substring", "from", OCL_Integer,
                                                                  "to"  , OCL_Integer, OCL_String) );
