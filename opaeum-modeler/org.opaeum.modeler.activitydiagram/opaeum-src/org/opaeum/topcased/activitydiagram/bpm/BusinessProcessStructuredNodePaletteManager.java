...
public class BusinessProcessStructuredNodePaletteManager extends OpaeumStructuredNodePalletteManager{
	BusinessProcessPaletteManager delegate;
	private PaletteDrawer bpmDrawer;
	public BusinessProcessStructuredNodePaletteManager(ICreationUtils utils){
		super(utils);
		delegate=new BusinessProcessPaletteManager(utils);
	}
	...
	private void createBpmDrawer(){
		delegate.createBpmDrawer();
		this.bpmDrawer=delegate.bpmDrawer;
	}
