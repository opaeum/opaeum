...
import net.sf.nakeduml.library.workinghours.Holiday;
import net.sf.nakeduml.library.workinghours.WorkDay;
import net.sf.nakeduml.library.workinghours.WorkingHoursConfiguration;
