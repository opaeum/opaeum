...
public class NameConverter {
	...
	public static String toUnderscoreStyle(String name) {
		...
		for (int i = 0; i < name.length(); i++) {
			boolean upperLower = name.length() > i + 1 && Character.isLowerCase(name.charAt(i + 1))
					&& Character.isUpperCase(name.charAt(i)) && i > 0;
			boolean lowerUpper = i > 0 && Character.isLowerCase(name.charAt(i - 1))
