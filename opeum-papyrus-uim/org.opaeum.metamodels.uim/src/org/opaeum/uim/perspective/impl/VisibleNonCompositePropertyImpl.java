...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Visible Non Composite Property</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.opaeum.uim.perspective.impl.VisibleNonCompositePropertyImpl#getExplorerConfiguration <em>Explorer Configuration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class VisibleNonCompositePropertyImpl extends UmlReferenceImpl implements VisibleNonCompositeProperty {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected VisibleNonCompositePropertyImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PerspectivePackage.Literals.VISIBLE_NON_COMPOSITE_PROPERTY;
	}
	...
	public ExplorerConfiguration getExplorerConfiguration() {
		if (eContainerFeatureID() != PerspectivePackage.VISIBLE_NON_COMPOSITE_PROPERTY__EXPLORER_CONFIGURATION) return null;
	...
	public NotificationChain basicSetExplorerConfiguration(ExplorerConfiguration newExplorerConfiguration, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newExplorerConfiguration, PerspectivePackage.VISIBLE_NON_COMPOSITE_PROPERTY__EXPLORER_CONFIGURATION, msgs);
		return msgs;
	}
	...
	public void setExplorerConfiguration(ExplorerConfiguration newExplorerConfiguration) {
		if (newExplorerConfiguration != eInternalContainer() || (eContainerFeatureID() != PerspectivePackage.VISIBLE_NON_COMPOSITE_PROPERTY__EXPLORER_CONFIGURATION && newExplorerConfiguration != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PerspectivePackage.VISIBLE_NON_COMPOSITE_PROPERTY__EXPLORER_CONFIGURATION, newExplorerConfiguration, newExplorerConfiguration));
	}
...
} //VisibleNonCompositePropertyImpl
