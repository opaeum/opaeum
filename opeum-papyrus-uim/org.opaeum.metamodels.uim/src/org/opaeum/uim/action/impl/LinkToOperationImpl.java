...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Link To Operation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.opaeum.uim.action.impl.LinkToOperationImpl#getUmlElementUid <em>Uml Element Uid</em>}</li>
 *   <li>{@link org.opaeum.uim.action.impl.LinkToOperationImpl#getToForm <em>To Form</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LinkToOperationImpl extends UimLinkImpl implements LinkToOperation {
	/**
	...
	protected EClass eStaticClass() {
		return ActionPackage.Literals.LINK_TO_OPERATION;
	}
	...
	public void setUmlElementUid(String newUmlElementUid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionPackage.LINK_TO_OPERATION__UML_ELEMENT_UID, oldUmlElementUid, umlElementUid));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActionPackage.LINK_TO_OPERATION__UML_ELEMENT_UID:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == UmlReference.class) {
			switch (derivedFeatureID) {
				case ActionPackage.LINK_TO_OPERATION__UML_ELEMENT_UID: return UimPackage.UML_REFERENCE__UML_ELEMENT_UID;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == UmlReference.class) {
			switch (baseFeatureID) {
				case UimPackage.UML_REFERENCE__UML_ELEMENT_UID: return ActionPackage.LINK_TO_OPERATION__UML_ELEMENT_UID;
				default: return -1;
			}
		}
