 ...
 * @generated
 */
public class LinkToEntity2EditPart extends ShapeNodeEditPart{
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public LinkToEntity2EditPart(View view){
		super(view);
	}
	/**
	 * @generated
	...
	protected void createDefaultEditPolicies(){
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new LinkToEntity2ItemSemanticEditPolicy());
	 ...
	 * @generated
	 */
	public class LinkToEntityColumnFigure extends RectangleFigure{
		/**
		 * @generated
		 */
		private WrappingLabel fLinkToEntityColumnNameFigure;
		/**
		 * @generated
		 */
		public LinkToEntityColumnFigure(){
			createContents();
		}
		/**
		 * @generated
		...
		private void createContents(){
			fLinkToEntityColumnNameFigure = new WrappingLabel();
			fLinkToEntityColumnNameFigure.setText("....");
			this.add(fLinkToEntityColumnNameFigure);
		}
		/**
		 * @generated
		 */
		public WrappingLabel getLinkToEntityColumnNameFigure(){
			return fLinkToEntityColumnNameFigure;
		}
	}
	/**
	 * @generated
