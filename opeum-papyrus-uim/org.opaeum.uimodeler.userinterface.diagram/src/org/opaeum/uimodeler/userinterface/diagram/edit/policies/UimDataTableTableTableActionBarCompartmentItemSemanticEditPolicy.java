...
import org.opaeum.uimodeler.userinterface.diagram.edit.commands.OperationButton3CreateCommand;
...
public class UimDataTableTableTableActionBarCompartmentItemSemanticEditPolicy extends UimBaseItemSemanticEditPolicy{
	...
	protected Command getCreateCommand(CreateElementRequest req){
		...
		if(UimElementTypes.OperationButton_3026 == req.getElementType()){
			return getGEFWrapper(new OperationButton3CreateCommand(req));
		}
