 ...
 * @generated
 */
public class LinkToEntityPreferencePage extends AbstractPapyrusNodePreferencePage{
	/**
	 * @generated
	 */
	public LinkToEntityPreferencePage(){
		super();
		setPreferenceKey(UserInterfaceEditPart.MODEL_ID + "_LinkToEntity");
	}
	/**
	 * @generated
	 */
	...
	public static void initDefaults(IPreferenceStore store){
		String key = UserInterfaceEditPart.MODEL_ID + "_LinkToEntity";
