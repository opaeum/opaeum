 ...
 * @generated
 */
public class LinkToOperationPreferencePage extends AbstractPapyrusNodePreferencePage{
	/**
	 * @generated
	 */
	public LinkToOperationPreferencePage(){
		super();
		setPreferenceKey(UserInterfaceEditPart.MODEL_ID + "_LinkToOperation");
	}
	/**
	 * @generated
	 */
	...
	public static void initDefaults(IPreferenceStore store){
		String key = UserInterfaceEditPart.MODEL_ID + "_LinkToOperation";
