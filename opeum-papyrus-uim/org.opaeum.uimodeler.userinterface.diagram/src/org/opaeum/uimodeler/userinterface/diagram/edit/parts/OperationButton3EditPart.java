...
import org.opaeum.uimodeler.userinterface.diagram.edit.policies.OperationButton3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OperationButton3EditPart extends ShapeNodeEditPart{
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public OperationButton3EditPart(View view){
		super(view);
	}
	/**
	 * @generated
	...
	protected void createDefaultEditPolicies(){
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new OperationButton3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart){
		if(childEditPart instanceof OperationButtonName2EditPart){
			((OperationButtonName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureOperationButtonNameFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart(){
		return getChildBySemanticHint(UimVisualIDRegistry.getType(OperationButtonName2EditPart.VISUAL_ID));
	}
	/**
	 * @generated
	 */
