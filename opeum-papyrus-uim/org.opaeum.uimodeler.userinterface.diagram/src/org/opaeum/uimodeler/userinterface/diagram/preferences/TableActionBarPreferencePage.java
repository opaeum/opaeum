 ...
 * @generated
 */
public class TableActionBarPreferencePage extends AbstractPapyrusNodePreferencePage{
	/**
	 * @generated
	 */
	public static final String compartments[] = {"TableActionBarActionCompartment"};
	/**
	 * @generated
	 */
	public TableActionBarPreferencePage(){
		super();
		setPreferenceKey(UserInterfaceEditPart.MODEL_ID + "_TableActionBar");
	}
	/**
	 * @generated
	 */
	...
	public static void initDefaults(IPreferenceStore store){
		String key = UserInterfaceEditPart.MODEL_ID + "_TableActionBar";
	...
	private static TreeMap<String,Boolean> getStaticCompartmentVisibilityPreferences(){
		...
		map.put("TableActionBarActionCompartment", Boolean.TRUE);
		return map;
	}
	/**
	 * @generated
