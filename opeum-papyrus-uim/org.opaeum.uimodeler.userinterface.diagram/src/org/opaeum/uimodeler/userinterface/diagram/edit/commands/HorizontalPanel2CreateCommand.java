 ...
 * @generated
 */
public class HorizontalPanel2CreateCommand extends EditElementCommand{
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public HorizontalPanel2CreateCommand(CreateElementRequest req,EObject eObject){
	 ...
	 * @generated
	 */
	public static HorizontalPanel2CreateCommand create(CreateElementRequest req,EObject eObject){
		return new HorizontalPanel2CreateCommand(req, eObject);
	}
	/**
	 * @generated
	 */
	public HorizontalPanel2CreateCommand(CreateElementRequest req){
		super(req.getLabel(), null, req);
	}
	/**
