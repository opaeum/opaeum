...
public class ActionActionBarContributor
	...
	/**
	 * Action to create objects from the Action model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static class NewAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			ActionModelWizard wizard = new ActionModelWizard();
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(UimEditorPlugin.INSTANCE.getString("_UI_ActionEditor_menu"), "org.opaeum.uim.actionMenuID");
