...
public class UimModelWizard extends Wizard implements INewWizard {
	...
	public void addPages() {
		initialObjectCreationPage = new UimModelWizardInitialObjectCreationPage("Whatever2");
		initialObjectCreationPage.setTitle(UimEditorPlugin.INSTANCE.getString("_UI_UimModelWizard_label"));
