...
public class WizardActionBarContributor
	...
	/**
	 * Action to create objects from the Wizard model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static class NewAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			WizardModelWizard wizard = new WizardModelWizard();
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(UimEditorPlugin.INSTANCE.getString("_UI_WizardEditor_menu"), "org.opaeum.uim.wizardMenuID");
