...
public class EditorActionBarContributor
	...
	/**
	 * Action to create objects from the Editor model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static class NewAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			EditorModelWizard wizard = new EditorModelWizard();
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(UimEditorPlugin.INSTANCE.getString("_UI_EditorEditor_menu"), "org.opaeum.uim.editorMenuID");
