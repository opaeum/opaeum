...
/**
 * This is the action bar contributor for the Panel model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PanelActionBarContributor
	extends EditingDomainActionBarContributor
	implements ISelectionChangedListener {
	/**
	 * Action to create objects from the Panel model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static class NewAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			PanelModelWizard wizard = new PanelModelWizard();
	 ...
	 * @generated
	 */
	public PanelActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("panel-settings"));
		toolBarManager.add(new Separator("panel-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(UimEditorPlugin.INSTANCE.getString("_UI_PanelEditor_menu"), "org.opaeum.uim.panelMenuID");
