...
public class ConstraintActionBarContributor
	...
	/**
	 * Action to create objects from the Constraint model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static class NewAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			ConstraintModelWizard wizard = new ConstraintModelWizard();
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(UimEditorPlugin.INSTANCE.getString("_UI_ConstraintEditor_menu"), "org.opaeum.uim.constraintMenuID");
