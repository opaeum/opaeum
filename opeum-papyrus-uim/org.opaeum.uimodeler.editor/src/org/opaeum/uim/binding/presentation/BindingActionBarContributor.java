...
public class BindingActionBarContributor
	...
	/**
	 * Action to create objects from the Binding model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static class NewAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			BindingModelWizard wizard = new BindingModelWizard();
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(UimEditorPlugin.INSTANCE.getString("_UI_BindingEditor_menu"), "org.opaeum.uim.bindingMenuID");
