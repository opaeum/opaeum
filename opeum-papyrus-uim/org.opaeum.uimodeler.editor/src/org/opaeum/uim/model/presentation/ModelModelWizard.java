/**
 */
package org.opaeum.uim.model.presentation;
...
public class ModelModelWizard extends Wizard implements INewWizard {
	...
	public static final List<String> FILE_EXTENSIONS =
		Collections.unmodifiableList(Arrays.asList(UimEditorPlugin.INSTANCE.getString("_UI_ModelEditorFilenameExtensions").split("\\s*,\\s*")));
	...
	public static final String FORMATTED_FILE_EXTENSIONS =
		UimEditorPlugin.INSTANCE.getString("_UI_ModelEditorFilenameExtensions").replaceAll("\\s*,\\s*", ", ");
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		setDefaultPageImageDescriptor(ExtendedImageRegistry.INSTANCE.getImageDescriptor(UimEditorPlugin.INSTANCE.getImage("full/wizban/NewModel")));
	}
	...
	public void addPages() {
		...
		initialObjectCreationPage.setTitle(UimEditorPlugin.INSTANCE.getString("_UI_ModelModelWizard_label"));
