 ...
 */
@Deprecated
public class IsDiagramContainer extends AbstractEditorContainerQuery implements IJavaModelQuery<EditorPage, Boolean> {


	public Boolean evaluate(EditorPage context, ParameterValueList parameterValues) throws ModelQueryExecutionException {
