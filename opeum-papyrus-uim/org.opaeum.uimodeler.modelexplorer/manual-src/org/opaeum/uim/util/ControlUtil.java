...
public class ControlUtil{
	public static ControlKind[] getAllowedControlKinds(AbstractEditor form,TypedElement typedElement){
	...
	public static boolean requiresManySelection(AbstractEditor form,TypedElement typedElement){
	...
	public static boolean requiresUserInput(AbstractEditor form,TypedElement te){
		if(te instanceof Pin){
			return te instanceof OutputPin;
		}else if(te instanceof Parameter){
			Parameter p = (Parameter) te;
			if(form instanceof QueryInvocationEditor){
	...
	public static ControlKind getPreferredControlKind(AbstractEditor form,TypedElement typedElement){
