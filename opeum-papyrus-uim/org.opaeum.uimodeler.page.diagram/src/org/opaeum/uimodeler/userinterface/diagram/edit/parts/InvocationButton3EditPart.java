...
import org.opaeum.uimodeler.userinterface.diagram.edit.policies.InvocationButton3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InvocationButton3EditPart extends ShapeNodeEditPart{
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public InvocationButton3EditPart(View view){
		super(view);
	}
	/**
	 * @generated
	...
	protected void createDefaultEditPolicies(){
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InvocationButton3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart){
		if(childEditPart instanceof InvocationButtonName2EditPart){
			((InvocationButtonName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureInvocationButtonNameFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart(){
		return getChildBySemanticHint(UimVisualIDRegistry.getType(InvocationButtonName2EditPart.VISUAL_ID));
	}
	/**
	 * @generated
	 */
