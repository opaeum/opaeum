...
public class UimDiagramUpdater{
	...
	public static List<UimNodeDescriptor> getUimDataTableTableTableActionBarCompartment_7003SemanticChildren(View view){
		...
		for(Iterator<?> it = modelElement.getActionsOnMultipleSelection().iterator();it.hasNext();){
			AbstractActionButton childElement = (AbstractActionButton) it.next();
			int visualID = UimVisualIDRegistry.getNodeVisualID(view, childElement);
	...
	public static List<UimLinkDescriptor> getContainedLinks(View view){
		...
		case InvocationButtonEditPart.VISUAL_ID:
			return getInvocationButton_3020ContainedLinks(view);
		...
		case InvocationButton2EditPart.VISUAL_ID:
			return getInvocationButton_3024ContainedLinks(view);
		...
		case InvocationButton3EditPart.VISUAL_ID:
			return getInvocationButton_3026ContainedLinks(view);
	...
	public static List<UimLinkDescriptor> getIncomingLinks(View view){
		...
		case InvocationButtonEditPart.VISUAL_ID:
			return getInvocationButton_3020IncomingLinks(view);
		case LinkToQueryEditPart.VISUAL_ID:
		...
		case InvocationButton2EditPart.VISUAL_ID:
			return getInvocationButton_3024IncomingLinks(view);
		case BuiltInActionButton3EditPart.VISUAL_ID:
			return getBuiltInActionButton_3025IncomingLinks(view);
		case InvocationButton3EditPart.VISUAL_ID:
			return getInvocationButton_3026IncomingLinks(view);
		case BuiltInLink2EditPart.VISUAL_ID:
	...
	public static List<UimLinkDescriptor> getOutgoingLinks(View view){
		...
		case InvocationButtonEditPart.VISUAL_ID:
			return getInvocationButton_3020OutgoingLinks(view);
		case LinkToQueryEditPart.VISUAL_ID:
		...
		case InvocationButton2EditPart.VISUAL_ID:
			return getInvocationButton_3024OutgoingLinks(view);
		case BuiltInActionButton3EditPart.VISUAL_ID:
			return getBuiltInActionButton_3025OutgoingLinks(view);
		case InvocationButton3EditPart.VISUAL_ID:
			return getInvocationButton_3026OutgoingLinks(view);
		case BuiltInLink2EditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	public static List<UimLinkDescriptor> getInvocationButton_3020ContainedLinks(View view){
		return Collections.emptyList();
	}
	/**
	 * @generated
	 ...
	 * @generated
	 */
	public static List<UimLinkDescriptor> getInvocationButton_3024ContainedLinks(View view){
		return Collections.emptyList();
	}
	/**
	 * @generated
	 ...
	 * @generated
	 */
	public static List<UimLinkDescriptor> getInvocationButton_3026ContainedLinks(View view){
		return Collections.emptyList();
	}
	/**
	 * @generated
	 ...
	 * @generated
	 */
	public static List<UimLinkDescriptor> getInvocationButton_3020IncomingLinks(View view){
		return Collections.emptyList();
	}
	/**
	 * @generated
	 ...
	 * @generated
	 */
	public static List<UimLinkDescriptor> getInvocationButton_3024IncomingLinks(View view){
		return Collections.emptyList();
	}
	/**
	 * @generated
	 ...
	 * @generated
	 */
	public static List<UimLinkDescriptor> getInvocationButton_3026IncomingLinks(View view){
		return Collections.emptyList();
	}
	/**
	 * @generated
	 ...
	 * @generated
	 */
	public static List<UimLinkDescriptor> getInvocationButton_3020OutgoingLinks(View view){
		return Collections.emptyList();
	}
	/**
	 * @generated
	 ...
	 * @generated
	 */
	public static List<UimLinkDescriptor> getInvocationButton_3024OutgoingLinks(View view){
		return Collections.emptyList();
	}
	/**
	 * @generated
	 ...
	 * @generated
	 */
	public static List<UimLinkDescriptor> getInvocationButton_3026OutgoingLinks(View view){
		return Collections.emptyList();
	}
	/**
	 * @generated
