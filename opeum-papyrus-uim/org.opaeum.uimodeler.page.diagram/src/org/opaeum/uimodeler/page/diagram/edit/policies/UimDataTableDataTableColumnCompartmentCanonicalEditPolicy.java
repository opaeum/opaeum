 ...
 * @generated
 */
public class UimDataTableDataTableColumnCompartmentCanonicalEditPolicy extends CanonicalEditPolicy{
	/**
	 * @generated
	 */
	...
	protected List getSemanticChildrenList(){
		...
		List<UimNodeDescriptor> childDescriptors = UimDiagramUpdater.getUimDataTableDataTableColumnCompartment_7002SemanticChildren(viewObject);
	...
	protected void refreshSemantic(){
		...
		List<UimNodeDescriptor> childDescriptors = UimDiagramUpdater
				.getUimDataTableDataTableColumnCompartment_7002SemanticChildren((View) getHost().getModel());
