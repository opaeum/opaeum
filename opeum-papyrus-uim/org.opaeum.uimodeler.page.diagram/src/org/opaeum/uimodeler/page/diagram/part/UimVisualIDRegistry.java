...
public class UimVisualIDRegistry{
	...
	public static int getVisualID(View view){
		...
		return org.opaeum.uimodeler.page.diagram.part.UimVisualIDRegistry.getVisualID(view.getType());
	}
	/**
	 * @generated
	 */
	...
	public static int getNodeVisualID(View containerView,EObject domainElement){
		...
		String containerModelID = org.opaeum.uimodeler.page.diagram.part.UimVisualIDRegistry.getModelID(containerView);
		if(!UserInterfaceEditPart.MODEL_ID.equals(containerModelID)){
			return -1;
		}
		int containerVisualID;
		if(UserInterfaceEditPart.MODEL_ID.equals(containerModelID)){
			containerVisualID = org.opaeum.uimodeler.page.diagram.part.UimVisualIDRegistry.getVisualID(containerView);
		}else{
