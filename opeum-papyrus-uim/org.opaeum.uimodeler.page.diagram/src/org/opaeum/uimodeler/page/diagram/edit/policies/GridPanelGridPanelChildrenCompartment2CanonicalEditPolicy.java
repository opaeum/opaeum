 ...
 * @generated
 */
public class GridPanelGridPanelChildrenCompartment2CanonicalEditPolicy extends CanonicalEditPolicy{
	/**
	 * @generated
	 */
	...
	protected List getSemanticChildrenList(){
		...
		List<UimNodeDescriptor> childDescriptors = UimDiagramUpdater.getGridPanelGridPanelChildrenCompartment_7005SemanticChildren(viewObject);
	...
	protected void refreshSemantic(){
		...
		List<UimNodeDescriptor> childDescriptors = UimDiagramUpdater
				.getGridPanelGridPanelChildrenCompartment_7005SemanticChildren((View) getHost().getModel());
