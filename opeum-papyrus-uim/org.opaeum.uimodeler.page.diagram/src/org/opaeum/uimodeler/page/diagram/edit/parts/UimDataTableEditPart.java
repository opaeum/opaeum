...
import org.opaeum.uimodeler.page.diagram.edit.policies.UimDataTableItemSemanticEditPolicy;
...
public class UimDataTableEditPart extends ShapeNodeEditPart{
	...
	protected NodeFigure createNodeFigure(){
		...
		figure.add(shape);
		new UimDataTableEventAdapter(this, (CustomUimDataTableFigure) shape);
