 ...
 * @generated
 */
public class ColumnAxisEntryPreferencePage extends AbstractPapyrusNodePreferencePage{
	/**
	 * @generated
	 */
	public ColumnAxisEntryPreferencePage(){
		super();
		setPreferenceKey(CubeQueryEditPart.MODEL_ID + "_ColumnAxisEntry");
	}
	/**
	 * @generated
	 */
	...
	public static void initDefaults(IPreferenceStore store){
		String key = CubeQueryEditPart.MODEL_ID + "_ColumnAxisEntry";
