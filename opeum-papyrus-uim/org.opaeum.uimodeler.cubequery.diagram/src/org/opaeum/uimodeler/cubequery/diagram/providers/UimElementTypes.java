...
public class UimElementTypes{
	 ...
	 * @generated
	 */
	public static final IElementType CubeQuery_1000 = getElementType("org.opaeum.uimodeler.cubequery.diagram.CubeQuery_1000"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType ColumnAxisEntry_2001 = getElementType("org.opaeum.uimodeler.cubequery.diagram.ColumnAxisEntry_2001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	...
	private static ImageDescriptor getProvidedImageDescriptor(ENamedElement element){
		...
		if(element instanceof EClass){
			...
			if(!eClass.isAbstract()){
				return UimCubeQueryDiagramEditorPlugin.getInstance().getItemImageDescriptor(
