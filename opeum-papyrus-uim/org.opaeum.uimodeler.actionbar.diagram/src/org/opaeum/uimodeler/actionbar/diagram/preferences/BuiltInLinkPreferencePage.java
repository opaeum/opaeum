 ...
 * @generated
 */
public class BuiltInLinkPreferencePage extends AbstractPapyrusNodePreferencePage{
	/**
	 * @generated
	 */
	public BuiltInLinkPreferencePage(){
		super();
		setPreferenceKey(AbstractEditorEditPart.MODEL_ID + "_BuiltInLink");
	}
	/**
	 * @generated
	 */
	...
	public static void initDefaults(IPreferenceStore store){
		String key = AbstractEditorEditPart.MODEL_ID + "_BuiltInLink";
