 ...
 * @generated
 */
public class UimDomainNavigatorContentProvider implements ICommonContentProvider{
	/**
	 * @generated
	 */
	...
	public UimDomainNavigatorContentProvider(){
		myAdapterFctoryContentProvier = new AdapterFactoryContentProvider(UimDiagramEditorPlugin.getInstance().getItemProvidersAdapterFactory());
	...
	public Object[] getChildren(Object parentElement){
		...
		if(parentElement instanceof UimDomainNavigatorItem){
			return wrapEObjects(myAdapterFctoryContentProvier.getChildren(((UimDomainNavigatorItem) parentElement).getEObject()), parentElement);
		}
		return EMPTY_ARRAY;
	}
	/**
