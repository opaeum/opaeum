...
public class UimNavigatorContentProvider implements ICommonContentProvider{
	...
	private Object[] getViewChildrenForAbstractEditorEditPart(View view,Object parentElement){
		...
		Collection connectedViews = getChildrenByType(Collections.singleton(view),
				UimVisualIDRegistry.getType(ActionBarEditPart.VISUAL_ID));
	 ...
	 *@generated
	 **/
	private Object[] getViewChildrenForActionBarEditPart(View view,Object parentElement){
		Collection result = new ArrayList();
		Collection connectedViews = getChildrenByType(Collections.singleton(view),
				UimVisualIDRegistry.getType(ActionBarActionBarChildrenCompartmentEditPart.VISUAL_ID));
		...
		connectedViews = getChildrenByType(Collections.singleton(view),
				UimVisualIDRegistry.getType(ActionBarActionBarChildrenCompartmentEditPart.VISUAL_ID));
		connectedViews = getChildrenByType(connectedViews, UimVisualIDRegistry.getType(InvocationButtonEditPart.VISUAL_ID));
		result.addAll(createNavigatorItems(connectedViews, parentElement, false));
		connectedViews = getChildrenByType(Collections.singleton(view),
				UimVisualIDRegistry.getType(ActionBarActionBarChildrenCompartmentEditPart.VISUAL_ID));
	...
	private Object[] getViewChildren(View view,Object parentElement){
		...
		case ActionBarEditPart.VISUAL_ID:{
			//modification of the template to avoid mistake of 65kb.
			return getViewChildrenForActionBarEditPart(view, parentElement);
		}
		}
		return EMPTY_ARRAY;
	}
