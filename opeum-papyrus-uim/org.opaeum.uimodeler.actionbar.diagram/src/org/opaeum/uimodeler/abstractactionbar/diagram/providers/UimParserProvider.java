...
public class UimParserProvider extends AbstractProvider implements IParserProvider{
	 ...
	 * @generated
	 */
	private IParser getActionBarName_5016Parser(){
	 ...
	 * @generated
	 */
	private IParser getInvocationButtonName_5013Parser(){
	...
	protected IParser getParser(int visualID){
		switch(visualID){
		case ActionBarNameEditPart.VISUAL_ID:
			return getActionBarName_5016Parser();
		...
		case InvocationButtonNameEditPart.VISUAL_ID:
			return getInvocationButtonName_5013Parser();
