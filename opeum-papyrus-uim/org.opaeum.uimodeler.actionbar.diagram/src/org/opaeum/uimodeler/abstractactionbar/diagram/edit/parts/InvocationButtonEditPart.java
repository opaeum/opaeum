...
import org.opaeum.uimodeler.abstractactionbar.diagram.edit.policies.InvocationButtonItemSemanticEditPolicy;
...
public class InvocationButtonEditPart extends ShapeNodeEditPart{
	...
	protected void createDefaultEditPolicies(){
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InvocationButtonItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart){
		if(childEditPart instanceof InvocationButtonNameEditPart){
			((InvocationButtonNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureInvocationButtonNameFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart(){
		return getChildBySemanticHint(UimVisualIDRegistry.getType(InvocationButtonNameEditPart.VISUAL_ID));
	}
	/**
	 * @generated
	 */
	...
	public Object getPreferredValue(EStructuralFeature feature){
		...
		if(feature == NotationPackage.eINSTANCE.getLineStyle_LineColor() || feature == NotationPackage.eINSTANCE.getFontStyle_FontColor()
			...
			if(feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()){
				prefColor = PreferenceConstantHelper.getElementConstant("InvocationButton", PreferenceConstantHelper.COLOR_LINE);
			}else if(feature == NotationPackage.eINSTANCE.getFontStyle_FontColor()){
				prefColor = PreferenceConstantHelper.getElementConstant("InvocationButton", PreferenceConstantHelper.COLOR_FONT);
			}else if(feature == NotationPackage.eINSTANCE.getFillStyle_FillColor()){
				prefColor = PreferenceConstantHelper.getElementConstant("InvocationButton", PreferenceConstantHelper.COLOR_FILL);
			}
			...
			String prefGradient = PreferenceConstantHelper.getElementConstant("InvocationButton", PreferenceConstantHelper.COLOR_GRADIENT);
