...
public class UserInterfaceItemSemanticEditPolicy extends UimBaseItemSemanticEditPolicy{
	...
	protected Command getCreateCommand(CreateElementRequest req){
		if(UimElementTypes.GridPanel_2004 == req.getElementType()){
			return getGEFWrapper(new GridPanelCreateCommand(req));
		}
		if(UimElementTypes.HorizontalPanel_2005 == req.getElementType()){
			return getGEFWrapper(new HorizontalPanelCreateCommand(req));
		}
		if(UimElementTypes.VerticalPanel_2006 == req.getElementType()){
