 ...
 * @generated
 */
public class VerticalPanel2CreateCommand extends EditElementCommand{
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public VerticalPanel2CreateCommand(CreateElementRequest req,EObject eObject){
	 ...
	 * @generated
	 */
	public static VerticalPanel2CreateCommand create(CreateElementRequest req,EObject eObject){
		return new VerticalPanel2CreateCommand(req, eObject);
	}
	/**
	 * @generated
	 */
	public VerticalPanel2CreateCommand(CreateElementRequest req){
		super(req.getLabel(), null, req);
	}
	/**
