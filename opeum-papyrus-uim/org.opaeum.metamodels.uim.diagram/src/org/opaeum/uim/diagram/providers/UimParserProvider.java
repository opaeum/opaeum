...
import org.opaeum.uim.diagram.parsers.MessageFormatParser;
...
public class UimParserProvider extends AbstractProvider implements IParserProvider{
	 ...
	 * @generated
	 */
	private IParser uimFieldName_5001Parser;
	/**
	 * @generated
	 */
	private IParser getUimFieldName_5001Parser(){
		if(uimFieldName_5001Parser == null){
			EAttribute[] features = new EAttribute[]{UimPackage.eINSTANCE.getUserInteractionElement_Name()};
			EAttribute[] editableFeatures = new EAttribute[]{UimPackage.eINSTANCE.getUserInteractionElement_Name()};
			MessageFormatParser parser = new MessageFormatParser(features, editableFeatures);
			uimFieldName_5001Parser = parser;
		}
		return uimFieldName_5001Parser;
	}
	/**
	 * @generated
	 */
	private IParser builtInActionNameKind_5003Parser;
	/**
	 * @generated
	 */
	private IParser getBuiltInActionNameKind_5003Parser(){
		if(builtInActionNameKind_5003Parser == null){
			EAttribute[] features = new EAttribute[]{UimPackage.eINSTANCE.getUserInteractionElement_Name(),
					ActionPackage.eINSTANCE.getBuiltInAction_Kind()};
			EAttribute[] editableFeatures = new EAttribute[]{UimPackage.eINSTANCE.getUserInteractionElement_Name()};
			MessageFormatParser parser = new MessageFormatParser(features, editableFeatures);
			parser.setViewPattern("{0}:{1}"); //$NON-NLS-1$
			parser.setEditorPattern("{0}:{1}"); //$NON-NLS-1$
			parser.setEditPattern("{0}:{1}"); //$NON-NLS-1$
			builtInActionNameKind_5003Parser = parser;
		}
		return builtInActionNameKind_5003Parser;
	}
	/**
	 * @generated
	 */
	protected IParser getParser(int visualID){
		...
		case BuiltInActionNameKindEditPart.VISUAL_ID:
			return getBuiltInActionNameKind_5003Parser();
		}
		return null;
	}
	/**
