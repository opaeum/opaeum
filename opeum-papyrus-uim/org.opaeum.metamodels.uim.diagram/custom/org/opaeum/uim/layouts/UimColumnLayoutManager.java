...
import org.opaeum.uim.diagram.edit.parts.UimField2EditPart.ColumnFigure;
...
public class UimColumnLayoutManager extends XYLayout implements IUimLayoutManager{
	...
	public void layout(IFigure parent){
		...
		for(ColumnFigure figure:children){
			...
			bounds.y = 0;
			Rectangle constraint = (Rectangle) figure.getLayoutManager().getConstraint((IFigure) figure.getChildren().get(0));
