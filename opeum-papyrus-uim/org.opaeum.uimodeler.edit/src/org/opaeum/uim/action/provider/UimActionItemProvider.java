...
/**
 * This is the item provider adapter for a {@link org.opaeum.uim.action.UimAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UimActionItemProvider
	 ...
	 * @generated
	 */
	public UimActionItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((UimAction)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UimAction_type") :
			getString("_UI_UimAction_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UimAction.class)) {
