...
/**
 * This is the item provider adapter for a {@link org.opaeum.uim.action.OperationPopup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationPopupItemProvider
	 ...
	 * @generated
	 */
	public OperationPopupItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ActionPackage.Literals.OPERATION_POPUP__PAGES);
		}
	...
	/**
	 * This returns OperationPopup.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OperationPopup"));
	}
	...
	public String getText(Object object) {
		String label = ((OperationPopup)object).getUmlElementUid();
		return label == null || label.length() == 0 ?
			getString("_UI_OperationPopup_type") :
			getString("_UI_OperationPopup_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OperationPopup.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ActionPackage.Literals.OPERATION_POPUP__PAGES,
