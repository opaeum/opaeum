...
/**
 * This is the item provider adapter for a {@link org.opaeum.uim.action.OperationAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addPopupPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OperationAction_popup_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OperationAction_popup_feature", "_UI_OperationAction_type"),
				 ActionPackage.Literals.OPERATION_ACTION__POPUP,
				 true,
				 false,
				 true,
				 null,
