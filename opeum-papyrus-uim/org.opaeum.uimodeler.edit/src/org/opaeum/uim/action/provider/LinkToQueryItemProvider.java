...
/**
 * This is the item provider adapter for a {@link org.opaeum.uim.action.LinkToQuery} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkToQueryItemProvider
	 ...
	 * @generated
	 */
	public LinkToQueryItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LinkToQuery"));
	}
	...
	public String getText(Object object) {
		String label = ((LinkToQuery)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_LinkToQuery_type") :
			getString("_UI_LinkToQuery_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LinkToQuery.class)) {
