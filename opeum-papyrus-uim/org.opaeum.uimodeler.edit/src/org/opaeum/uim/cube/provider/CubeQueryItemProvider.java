...
public class CubeQueryItemProvider
	 ...
	 * @generated
	 */
	public CubeQueryItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CubeQuery"));
	}
	...
	public String getText(Object object) {
		String label = ((CubeQuery)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CubeQuery_type") :
			getString("_UI_CubeQuery_type") + " " + label;
	}
