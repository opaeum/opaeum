...
public class MeasurePropertyItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addAggregationFormulaPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Aggregation Formula feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAggregationFormulaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MeasureProperty_aggregationFormula_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MeasureProperty_aggregationFormula_feature", "_UI_MeasureProperty_type"),
				 CubePackage.Literals.MEASURE_PROPERTY__AGGREGATION_FORMULA,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((MeasureProperty)object).getUmlElementUid();
		return label == null || label.length() == 0 ?
			getString("_UI_MeasureProperty_type") :
			getString("_UI_MeasureProperty_type") + " " + label;
	}
