...
/**
 * This is the item provider adapter for a {@link org.opaeum.uim.model.QueryInvoker} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QueryInvokerItemProvider
	extends AbstractEditorItemProvider
	implements
	 ...
	 * @generated
	 */
	public QueryInvokerItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.QUERY_INVOKER__RESULT_PAGE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/QueryInvoker"));
	}
	...
	public String getText(Object object) {
		String label = ((QueryInvoker)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_QueryInvoker_type") :
			getString("_UI_QueryInvoker_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(QueryInvoker.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.QUERY_INVOKER__RESULT_PAGE,
				 EditorFactory.eINSTANCE.createQueryResultPage()));
	}
