...
/**
 * This is the item provider adapter for a {@link org.opaeum.uim.model.ClassUserInteractionModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassUserInteractionModelItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.CLASS_USER_INTERACTION_MODEL__PRIMARY_EDITOR);
			childrenFeatures.add(ModelPackage.Literals.CLASS_USER_INTERACTION_MODEL__SECONDARY_EDITORS);
			childrenFeatures.add(ModelPackage.Literals.CLASS_USER_INTERACTION_MODEL__NEW_OBJECT_WIZARD);
			childrenFeatures.add(ModelPackage.Literals.CLASS_USER_INTERACTION_MODEL__CUBE_QUERY_EDITOR);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.CLASS_USER_INTERACTION_MODEL__PRIMARY_EDITOR,
				 EditorFactory.eINSTANCE.createObjectEditor()));

		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.CLASS_USER_INTERACTION_MODEL__SECONDARY_EDITORS,
				 EditorFactory.eINSTANCE.createObjectEditor()));

		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.CLASS_USER_INTERACTION_MODEL__NEW_OBJECT_WIZARD,
				 WizardFactory.eINSTANCE.createNewObjectWizard()));

		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.CLASS_USER_INTERACTION_MODEL__CUBE_QUERY_EDITOR,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == ModelPackage.Literals.CLASS_USER_INTERACTION_MODEL__PRIMARY_EDITOR ||
			childFeature == ModelPackage.Literals.CLASS_USER_INTERACTION_MODEL__SECONDARY_EDITORS;
