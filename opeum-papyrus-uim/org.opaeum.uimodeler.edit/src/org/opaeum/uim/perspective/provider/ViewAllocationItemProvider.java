...
public class ViewAllocationItemProvider
	 ...
	 * @generated
	 */
	public ViewAllocationItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ViewAllocation_width_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ViewAllocation_width_feature", "_UI_ViewAllocation_type"),
				 PerspectivePackage.Literals.VIEW_ALLOCATION__WIDTH,
				 true,
				 false,
				 false,
	...
	protected void addPositionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ViewAllocation_position_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ViewAllocation_position_feature", "_UI_ViewAllocation_type"),
				 PerspectivePackage.Literals.VIEW_ALLOCATION__POSITION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns ViewAllocation.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ViewAllocation"));
	}
