...
public class ExplorerClassConstraintItemProvider
	 ...
	 * @generated
	 */
	public ExplorerClassConstraintItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PerspectivePackage.Literals.EXPLORER_CLASS_CONSTRAINT__PROPERTIES);
			childrenFeatures.add(PerspectivePackage.Literals.EXPLORER_CLASS_CONSTRAINT__NEW_OBJECT_CONSTRAINT);
			childrenFeatures.add(PerspectivePackage.Literals.EXPLORER_CLASS_CONSTRAINT__BEHAVIORS);
			childrenFeatures.add(PerspectivePackage.Literals.EXPLORER_CLASS_CONSTRAINT__OPERATIONS);
		}
	...
	/**
	 * This returns ExplorerClassConstraint.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ExplorerClassConstraint"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ExplorerClassConstraint.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PerspectivePackage.Literals.EXPLORER_CLASS_CONSTRAINT__BEHAVIORS,
				 PerspectiveFactory.eINSTANCE.createExplorerBehaviorConstraint()));

		newChildDescriptors.add
			(createChildParameter
				(PerspectivePackage.Literals.EXPLORER_CLASS_CONSTRAINT__OPERATIONS,
				 PerspectiveFactory.eINSTANCE.createExplorerOperationConstraint()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == PerspectivePackage.Literals.EXPLORER_CLASS_CONSTRAINT__PROPERTIES ||
			childFeature == PerspectivePackage.Literals.EXPLORER_CLASS_CONSTRAINT__NEW_OBJECT_CONSTRAINT ||
			childFeature == PerspectivePackage.Literals.EXPLORER_CLASS_CONSTRAINT__OPERATIONS ||
			childFeature == PerspectivePackage.Literals.EXPLORER_CLASS_CONSTRAINT__BEHAVIORS;
