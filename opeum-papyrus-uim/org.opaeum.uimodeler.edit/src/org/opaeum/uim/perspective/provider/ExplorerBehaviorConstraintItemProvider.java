...
/**
 * This is the item provider adapter for a {@link org.opaeum.uim.perspective.ExplorerBehaviorConstraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExplorerBehaviorConstraintItemProvider
	 ...
	 * @generated
	 */
	public ExplorerBehaviorConstraintItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PerspectivePackage.Literals.EXPLORER_BEHAVIOR_CONSTRAINT__INVOCATION_CONSTRAINT);
		}
	...
	/**
	 * This returns ExplorerBehaviorConstraint.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ExplorerBehaviorConstraint"));
	}
	...
	public String getText(Object object) {
		String label = ((ExplorerBehaviorConstraint)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ExplorerBehaviorConstraint_type") :
			getString("_UI_ExplorerBehaviorConstraint_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ExplorerBehaviorConstraint.class)) {
