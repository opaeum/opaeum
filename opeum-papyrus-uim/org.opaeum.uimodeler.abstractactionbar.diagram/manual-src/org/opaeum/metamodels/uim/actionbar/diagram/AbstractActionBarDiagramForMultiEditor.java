...
public class AbstractActionBarDiagramForMultiEditor extends UimDiagramEditor {
	 ...
	 * 
	 */
	public AbstractActionBarDiagramForMultiEditor(ServicesRegistry servicesRegistry, Diagram diagram) throws BackboneException, ServiceException {
