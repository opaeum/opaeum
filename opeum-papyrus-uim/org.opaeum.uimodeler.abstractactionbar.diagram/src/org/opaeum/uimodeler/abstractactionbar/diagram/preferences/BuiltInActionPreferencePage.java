 ...
 * @generated
 */
public class BuiltInActionPreferencePage extends AbstractPapyrusNodePreferencePage{
	/**
	 * @generated
	 */
	public BuiltInActionPreferencePage(){
		super();
		setPreferenceKey(AbstractActionBarEditPart.MODEL_ID + "_BuiltInAction");
	}
	/**
	 * @generated
	 */
	...
	public static void initDefaults(IPreferenceStore store){
		String key = AbstractActionBarEditPart.MODEL_ID + "_BuiltInAction";
