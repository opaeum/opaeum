 ...
 * @generated
 */
public class OperationButtonPreferencePage extends AbstractPapyrusNodePreferencePage{
	/**
	 * @generated
	 */
	public OperationButtonPreferencePage(){
		super();
		setPreferenceKey(AbstractEditorEditPart.MODEL_ID + "_OperationButton");
	}
	/**
	 * @generated
	 */
	...
	public static void initDefaults(IPreferenceStore store){
		String key = AbstractEditorEditPart.MODEL_ID + "_OperationButton";
