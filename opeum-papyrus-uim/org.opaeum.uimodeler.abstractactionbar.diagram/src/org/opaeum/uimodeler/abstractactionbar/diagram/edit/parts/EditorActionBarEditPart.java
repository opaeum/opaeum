...
import org.opaeum.uimodeler.abstractactionbar.diagram.edit.policies.EditorActionBarItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EditorActionBarEditPart extends ShapeNodeEditPart{
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EditorActionBarEditPart(View view){
		super(view);
	}
	/**
	 * @generated
	...
	protected void createDefaultEditPolicies(){
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new EditorActionBarItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart){
		if(childEditPart instanceof EditorActionBarNameEditPart){
			((EditorActionBarNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureGridPanelNameFigure());
			return true;
		}
		return false;
	}
	...
	protected NodeFigure createNodePlate(){
		String prefElementId = "EditorActionBar";
	...
	public EditPart getPrimaryChildEditPart(){
		return getChildBySemanticHint(UimVisualIDRegistry.getType(EditorActionBarNameEditPart.VISUAL_ID));
	}
	/**
	 * @generated
	 */
	...
	public Object getPreferredValue(EStructuralFeature feature){
		...
		if(feature == NotationPackage.eINSTANCE.getLineStyle_LineColor() || feature == NotationPackage.eINSTANCE.getFontStyle_FontColor()
			...
			if(feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()){
				prefColor = PreferenceConstantHelper.getElementConstant("EditorActionBar", PreferenceConstantHelper.COLOR_LINE);
			}else if(feature == NotationPackage.eINSTANCE.getFontStyle_FontColor()){
				prefColor = PreferenceConstantHelper.getElementConstant("EditorActionBar", PreferenceConstantHelper.COLOR_FONT);
			}else if(feature == NotationPackage.eINSTANCE.getFillStyle_FillColor()){
				prefColor = PreferenceConstantHelper.getElementConstant("EditorActionBar", PreferenceConstantHelper.COLOR_FILL);
			}
			...
			String prefGradient = PreferenceConstantHelper.getElementConstant("EditorActionBar", PreferenceConstantHelper.COLOR_GRADIENT);
