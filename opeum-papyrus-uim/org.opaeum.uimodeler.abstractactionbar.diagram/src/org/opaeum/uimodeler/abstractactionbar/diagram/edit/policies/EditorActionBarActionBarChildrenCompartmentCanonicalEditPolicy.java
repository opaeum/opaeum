 ...
 * @generated
 */
public class EditorActionBarActionBarChildrenCompartmentCanonicalEditPolicy extends CanonicalEditPolicy{
	/**
	 * @generated
	 */
	...
	protected List getSemanticChildrenList(){
		...
		List<UimNodeDescriptor> childDescriptors = UimDiagramUpdater
				.getEditorActionBarActionBarChildrenCompartment_7001SemanticChildren(viewObject);
	...
	protected void refreshSemantic(){
		...
		List<UimNodeDescriptor> childDescriptors = UimDiagramUpdater
				.getEditorActionBarActionBarChildrenCompartment_7001SemanticChildren((View) getHost().getModel());
