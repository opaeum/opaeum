...
import org.opaeum.uimodeler.abstractactionbar.diagram.edit.commands.EditorActionBarCreateCommand;
...
public class AbstractEditorItemSemanticEditPolicy extends UimBaseItemSemanticEditPolicy{
	...
	protected Command getCreateCommand(CreateElementRequest req){
		if(UimElementTypes.EditorActionBar_2011 == req.getElementType()){
			return getGEFWrapper(new EditorActionBarCreateCommand(req));
		}
