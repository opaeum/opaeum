...
import org.opaeum.uimodeler.abstractactionbar.diagram.edit.policies.BuiltInLinkItemSemanticEditPolicy;
...
public class BuiltInLinkEditPart extends ShapeNodeEditPart{
	...
	protected void createDefaultEditPolicies(){
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new BuiltInLinkItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart){
		if(childEditPart instanceof BuiltInLinkNameEditPart){
			((BuiltInLinkNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureBuiltInLinkNameFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart(){
		return getChildBySemanticHint(UimVisualIDRegistry.getType(BuiltInLinkNameEditPart.VISUAL_ID));
	}
	/**
	 * @generated
	 */
