...
import org.opaeum.uimodeler.abstractactionbar.diagram.edit.policies.BuiltInActionItemSemanticEditPolicy;
...
public class BuiltInActionEditPart extends ShapeNodeEditPart{
	...
	protected boolean addFixedChild(EditPart childEditPart){
		if(childEditPart instanceof BuiltInActionNameEditPart){
			((BuiltInActionNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureBuiltInActionNameFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart(){
		return getChildBySemanticHint(UimVisualIDRegistry.getType(BuiltInActionNameEditPart.VISUAL_ID));
	}
	/**
	 * @generated
	 */
