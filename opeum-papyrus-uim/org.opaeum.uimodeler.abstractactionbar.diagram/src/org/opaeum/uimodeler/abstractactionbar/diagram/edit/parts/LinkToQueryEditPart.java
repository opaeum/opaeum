...
import org.opaeum.uimodeler.abstractactionbar.diagram.edit.policies.LinkToQueryItemSemanticEditPolicy;
 ...
 * @generated
 */
public class LinkToQueryEditPart extends ShapeNodeEditPart{
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public LinkToQueryEditPart(View view){
		super(view);
	}
	/**
	 * @generated
	...
	protected void createDefaultEditPolicies(){
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new LinkToQueryItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart){
		if(childEditPart instanceof LinkToQueryNameEditPart){
			((LinkToQueryNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLinkToQueryNameFigure());
			return true;
		}
		return false;
	}
	...
	protected NodeFigure createNodePlate(){
		String prefElementId = "LinkToQuery";
	...
	public EditPart getPrimaryChildEditPart(){
		return getChildBySemanticHint(UimVisualIDRegistry.getType(LinkToQueryNameEditPart.VISUAL_ID));
	}
	/**
	 * @generated
	 */
	public class LinkToQueryFigure extends RectangleFigure{
		/**
		 * @generated
		 */
		private WrappingLabel fFigureLinkToQueryName;
		/**
		 * @generated
		 */
		public LinkToQueryFigure(){
		...
		private void createContents(){
			fFigureLinkToQueryName = new WrappingLabel();
			fFigureLinkToQueryName.setText("<...>");
			this.add(fFigureLinkToQueryName);
		}
		/**
		 * @generated
		 */
		public WrappingLabel getFigureLinkToQueryName(){
			return fFigureLinkToQueryName;
		}
	}
	/**
	 * @generated
	...
	public Object getPreferredValue(EStructuralFeature feature){
		...
		if(feature == NotationPackage.eINSTANCE.getLineStyle_LineColor() || feature == NotationPackage.eINSTANCE.getFontStyle_FontColor()
			...
			if(feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()){
				prefColor = PreferenceConstantHelper.getElementConstant("LinkToQuery", PreferenceConstantHelper.COLOR_LINE);
			}else if(feature == NotationPackage.eINSTANCE.getFontStyle_FontColor()){
				prefColor = PreferenceConstantHelper.getElementConstant("LinkToQuery", PreferenceConstantHelper.COLOR_FONT);
			}else if(feature == NotationPackage.eINSTANCE.getFillStyle_FillColor()){
				prefColor = PreferenceConstantHelper.getElementConstant("LinkToQuery", PreferenceConstantHelper.COLOR_FILL);
			}
			...
			String prefGradient = PreferenceConstantHelper.getElementConstant("LinkToQuery", PreferenceConstantHelper.COLOR_GRADIENT);
