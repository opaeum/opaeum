...
public class UimInitDiagramFileAction implements IObjectActionDelegate{
	...
	public void run(IAction action){
		...
		try{
			...
			UimDiagramEditorPlugin.getInstance().logError("Unable to load resource: " + domainModelURI, ex); //$NON-NLS-1$
		}
		if(diagramRoot == null){
		...
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle, AbstractActionBarEditPart.MODEL_ID));
