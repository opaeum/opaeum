 ...
 * @generated
 */
public class TransitionActionPreferencePage extends AbstractPapyrusNodePreferencePage{
	/**
	 * @generated
	 */
	public TransitionActionPreferencePage(){
		super();
		setPreferenceKey(AbstractActionBarEditPart.MODEL_ID + "_TransitionAction");
	}
	/**
	 * @generated
	 */
	...
	public static void initDefaults(IPreferenceStore store){
		String key = AbstractActionBarEditPart.MODEL_ID + "_TransitionAction";
