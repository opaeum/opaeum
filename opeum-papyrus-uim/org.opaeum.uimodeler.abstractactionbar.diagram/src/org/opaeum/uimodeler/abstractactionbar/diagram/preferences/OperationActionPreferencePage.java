 ...
 * @generated
 */
public class OperationActionPreferencePage extends AbstractPapyrusNodePreferencePage{
	/**
	 * @generated
	 */
	public OperationActionPreferencePage(){
		super();
		setPreferenceKey(AbstractActionBarEditPart.MODEL_ID + "_OperationAction");
	}
	/**
	 * @generated
	 */
	...
	public static void initDefaults(IPreferenceStore store){
		String key = AbstractActionBarEditPart.MODEL_ID + "_OperationAction";
