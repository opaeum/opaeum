 ...
 * @generated
 */
public class EditorActionBarPreferencePage extends AbstractPapyrusNodePreferencePage{
	/**
	 * @generated
	 */
	public static final String compartments[] = {"ActionBarChildrenCompartment"};
	/**
	 * @generated
	 */
	public EditorActionBarPreferencePage(){
		super();
		setPreferenceKey(AbstractEditorEditPart.MODEL_ID + "_EditorActionBar");
	}
	/**
	 * @generated
	 */
	...
	public static void initDefaults(IPreferenceStore store){
		String key = AbstractEditorEditPart.MODEL_ID + "_EditorActionBar";
	...
	private static TreeMap<String,Boolean> getStaticCompartmentVisibilityPreferences(){
		...
		map.put("ActionBarChildrenCompartment", Boolean.TRUE);
		return map;
	}
	/**
	 * @generated
