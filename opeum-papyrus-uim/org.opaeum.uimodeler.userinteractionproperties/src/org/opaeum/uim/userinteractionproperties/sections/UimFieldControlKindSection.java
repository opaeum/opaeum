...
public class UimFieldControlKindSection extends AbstractEnumerationPropertySection{
	...
	protected String[] getEnumerationFeatureValues(){
		...
		if(binding != null){
			TypedElement typedElement = UmlUimLinks.getCurrentUmlLinks().getResultingType(binding);
			if(typedElement != null && typedElement.getType() != null){
				cks = ControlUtil.getAllowedControlKinds(UmlUimLinks.getCurrentUmlLinks().getNearestForm(binding.getField()), typedElement);
			}
		}
