...
import org.opaeum.uimodeler.perspective.diagram.edit.policies.PropertiesConfigurationItemSemanticEditPolicy;
import org.opaeum.uimodeler.perspective.diagram.part.UimPerspectiveDiagramEditorPlugin;

/**
 * @generated
 */
public class PropertiesConfigurationEditPart extends ShapeNodeEditPart{
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public PropertiesConfigurationEditPart(View view){
		super(view);
	}
	/**
	 * @generated
	...
	protected void createDefaultEditPolicies(){
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PropertiesConfigurationItemSemanticEditPolicy());
	...
	protected NodeFigure createNodePlate(){
		String prefElementId = "PropertiesConfiguration";
	...
	public Object getPreferredValue(EStructuralFeature feature){
		...
		if(feature == NotationPackage.eINSTANCE.getLineStyle_LineColor() || feature == NotationPackage.eINSTANCE.getFontStyle_FontColor()
			...
			if(feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()){
				prefColor = PreferenceConstantHelper.getElementConstant("PropertiesConfiguration", PreferenceConstantHelper.COLOR_LINE);
			}else if(feature == NotationPackage.eINSTANCE.getFontStyle_FontColor()){
				prefColor = PreferenceConstantHelper.getElementConstant("PropertiesConfiguration", PreferenceConstantHelper.COLOR_FONT);
			}else if(feature == NotationPackage.eINSTANCE.getFillStyle_FillColor()){
				prefColor = PreferenceConstantHelper.getElementConstant("PropertiesConfiguration", PreferenceConstantHelper.COLOR_FILL);
			}
			...
			String prefGradient = PreferenceConstantHelper.getElementConstant("PropertiesConfiguration", PreferenceConstantHelper.COLOR_GRADIENT);
