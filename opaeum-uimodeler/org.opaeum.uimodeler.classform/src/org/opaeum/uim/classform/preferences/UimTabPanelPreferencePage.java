 ...
 * @generated
 */
public class UimTabPanelPreferencePage extends AbstractNodePreferencePage{
	/**
	...
	protected String getNodeBackgroundColor(){
		return ClassFormDiagramPreferenceConstants.UIMTABPANEL_DEFAULT_BACKGROUND_COLOR;
	}
	/**
	...
	protected String getNodeFont(){
		return ClassFormDiagramPreferenceConstants.UIMTABPANEL_DEFAULT_FONT;
	}
	/**
	...
	protected String getNodeForegroundColor(){
		return ClassFormDiagramPreferenceConstants.UIMTABPANEL_DEFAULT_FOREGROUND_COLOR;
	}
	/**
