...
public class AuditStuff {
	private EntityManagerFactory emf;
	public void dontTestSimpleTypes() throws Exception {
		System.out.println("AuditTest.dontTestSimpleTypes()");
		dontTestPropertyHistory("asdf", "stringProperty");
		dontTestPropertyHistory(Boolean.TRUE, "booleanProperty");
		dontTestPropertyHistory(300, "integerProperty");
		dontTestPropertyHistory(1.23456789, "doubleProperty");
		dontTestPropertyHistory(new Date(), "dateTimeProperty");
	}

	private void dontTestPropertyHistory(Object expectedValue, String propertyName) throws Exception {
		System.out.println("AuditTest.dontTestPropertyHistory()");
	...
	public void dontTestAuditedEntityRelationship() {		
		System.out.println("AuditTest.dontTestAuditedEntityRelationship()");
		EntityManager em = emf.createEntityManager();
	...
	public void dontTestPrevious() {		
		System.out.println("AuditTest.dontTestPrevious()");
		EntityManager em = emf.createEntityManager();
		ParentAuditedObject pao1 = new ParentAuditedObject();
		em.getTransaction().begin();
		em.persist(pao1);
	...
	public void dontTestUnauditedEntityRelationship(){
		System.out.println("AuditTest.dontTestUnauditedEntityRelationship()");
		EntityManager em = emf.createEntityManager();
		ParentAuditedObject pao1 = new ParentAuditedObject();
		em.getTransaction().begin();
		ChildAuditedObject cao = new ChildAuditedObject();
	...
	public void dontTestCustomAuditEntry(){
		System.out.println("AuditTest.dontTestCustomAuditEntry()");
		EntityManager em = emf.createEntityManager();
		ParentAuditedObject pao1 = new ParentAuditedObject();
		em.getTransaction().begin();
		ChildAuditedObject cao = new ChildAuditedObject();
	...
	public void dontTestNoPreviousEntry(){
		System.out.println("AuditTest.dontTestNoPreviousEntry()");
		EntityManager em = emf.createEntityManager();
		ParentAuditedObject pao1 = new ParentAuditedObject();
		em.getTransaction().begin();
		em.persist(pao1);
