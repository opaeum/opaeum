...
@NumlMetaInfo(applicationIdentifier="opaeum-runtime-bpm",uuid="OpaeumBPMCommon.library.uml@_7zLcgNb-EeCJ0dmaHEVVnw")
public enum BusinessTimeUnit implements IEnum, Serializable {
