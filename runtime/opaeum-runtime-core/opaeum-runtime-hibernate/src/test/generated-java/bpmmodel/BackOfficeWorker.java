...
@NumlMetaInfo(applicationIdentifier="opaeum_hibernate_tests",uuid="bpm.uml@_ur_igI_gEeK855GX2Z3x4Q")
@BusinessRole
@Filter(name="noDeletedObjects")
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@AccessType(	"field")
@Table(name="back_office_worker")
@Entity(name="BackOfficeWorker")
public class BackOfficeWorker implements IPersistentObject, IEventGenerator, HibernateEntity, CompositionNode, IBusinessRole, Serializable {
	@Transient
	...
	@TableGenerator(allocationSize=20,name="id_generator",pkColumnName="type",pkColumnValue="back_office_worker",table="hi_value")
	@Id
	@GeneratedValue(generator="id_generator",strategy=javax.persistence.GenerationType.TABLE)
	private Long id;
	static private Set<? extends BackOfficeWorker> mockedAllInstances;
	@Index(columnNames="my_business_id",name="idx_back_office_worker_my_business_id")
	...
	@Where(clause="participant_type='bpm.uml@_ur_igI_gEeK855GX2Z3x4Q'")
	...
	static final private long serialVersionUID = 8031182802450677318l;
	@Where(clause="timed_resource_type='bpm.uml@_ur_igI_gEeK855GX2Z3x4Q'")
	@LazyCollection(	org.hibernate.annotations.LazyCollectionOption.TRUE)
	 ...
	 * @param owningObject 
	 */
	public BackOfficeWorker(MyBusiness owningObject) {
		init(owningObject);
		addToOwningObject();
	}
	
	/** Default constructor for BackOfficeWorker
	 */
	public BackOfficeWorker() {
	}
	...
	public void addToOwningObject() {
		getMyBusiness().z_internalAddToBackOfficeWorker((BackOfficeWorker)this);
	}
	...
	static public Set<? extends BackOfficeWorker> allInstances(AbstractPersistence persistence) {
		if ( mockedAllInstances==null ) {
			return new HashSet(persistence.readAll(bpmmodel.BackOfficeWorker.class));
		} else {
	...
	public void copyShallowState(BackOfficeWorker from, BackOfficeWorker to) {
	...
	public void copyState(BackOfficeWorker from, BackOfficeWorker to) {
		to.setPreferredNotificationType(from.getPreferredNotificationType());
		to.setPreferredEMailAddressType(from.getPreferredEMailAddressType());
		to.setPreferredPhoneNumberType(from.getPreferredPhoneNumberType());
	...
	public boolean equals(Object other) {
		if ( other instanceof BackOfficeWorker ) {
			return other==this || ((BackOfficeWorker)other).getUid().equals(this.getUid());
		}
		return false;
	}
	...
	@PropertyMetaInfo(constraints={},isComposite=false,opaeumId=4050532728711157760l,opposite="backOfficeWorker",uuid="bpm.uml@_yhwTIY_gEeK855GX2Z3x4Q")
	@NumlMetaInfo(uuid="bpm.uml@_yhwTIY_gEeK855GX2Z3x4Q")
	...
	public BackOfficeWorker makeCopy() {
		BackOfficeWorker result = new BackOfficeWorker();
		copyState((BackOfficeWorker)this,result);
		return result;
	}
	
	public BackOfficeWorker makeShallowCopy() {
		BackOfficeWorker result = new BackOfficeWorker();
		copyShallowState((BackOfficeWorker)this,result);
	...
	public void markDeleted() {
		...
		if ( getMyBusiness()!=null ) {
			getMyBusiness().z_internalRemoveFromBackOfficeWorker(this);
		}
	...
	public void setMyBusiness(MyBusiness myBusiness) {
		if ( this.getMyBusiness()!=null ) {
			this.getMyBusiness().z_internalRemoveFromBackOfficeWorker(this);
		}
		if ( myBusiness == null ) {
			this.z_internalRemoveFromMyBusiness(this.getMyBusiness());
		} else {
			this.z_internalAddToMyBusiness(myBusiness);
		}
		if ( myBusiness!=null ) {
			myBusiness.z_internalAddToBackOfficeWorker(this);
	...
	public String toXmlReferenceString() {
		return "<BackOfficeWorker uid=\""+getUid() + "\"/>";
	}
	
	public String toXmlString() {
		StringBuilder sb = new StringBuilder();
		sb.append("<BackOfficeWorker ");
		sb.append("classUuid=\"bpm.uml@_ur_igI_gEeK855GX2Z3x4Q\" ");
		sb.append("className=\"bpmmodel.BackOfficeWorker\" ");
