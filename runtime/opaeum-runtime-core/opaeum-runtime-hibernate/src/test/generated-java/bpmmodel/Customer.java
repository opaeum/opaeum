...
@NumlMetaInfo(applicationIdentifier="opaeum_hibernate_tests",uuid="bpm.uml@_FEtqQI_cEeKWQLWOG6WHmA")
@BusinessActor
...
public class Customer implements IPersistentObject, IEventGenerator, HibernateEntity, CompositionNode, IBusinessActor, Serializable {
	@Index(columnNames="business_collaboration1_id",name="idx_customer_business_collaboration1_id")
	...
	@TableGenerator(allocationSize=20,name="id_generator",pkColumnName="type",pkColumnValue="customer",table="hi_value")
	@Id
	@GeneratedValue(generator="id_generator",strategy=javax.persistence.GenerationType.TABLE)
	private Long id;
	static private Set<? extends Customer> mockedAllInstances;
	@Version
	...
	@Where(clause="participant_type='bpm.uml@_FEtqQI_cEeKWQLWOG6WHmA'")
	...
	static final private long serialVersionUID = 6132824293766425645l;
	private String uid;
	 ...
	 * @param owningObject 
	 */
	public Customer(BusinessCollaboration1 owningObject) {
		init(owningObject);
		addToOwningObject();
	}
	...
	public void addToOwningObject() {
		getBusinessCollaboration1().z_internalAddToCustomer((Customer)this);
	}
	...
	static public Set<? extends Customer> allInstances(AbstractPersistence persistence) {
		if ( mockedAllInstances==null ) {
			return new HashSet(persistence.readAll(bpmmodel.Customer.class));
		} else {
	...
	public boolean equals(Object other) {
		if ( other instanceof Customer ) {
			return other==this || ((Customer)other).getUid().equals(this.getUid());
		}
		return false;
	}
	...
	@PropertyMetaInfo(constraints={},isComposite=false,opaeumId=8937821534310653039l,opposite="customer",uuid="bpm.uml@_mw3b0Y_cEeKWQLWOG6WHmA")
	@NumlMetaInfo(uuid="bpm.uml@_mw3b0Y_cEeKWQLWOG6WHmA")
	...
	public void markDeleted() {
		...
		if ( getBusinessCollaboration1()!=null ) {
			getBusinessCollaboration1().z_internalRemoveFromCustomer(this);
		}
	...
	public void setBusinessCollaboration1(BusinessCollaboration1 businessCollaboration1) {
		...
		if ( oldValue==null ) {
			if ( businessCollaboration1!=null ) {
				Customer oldOther = (Customer)businessCollaboration1.getCustomer();
				businessCollaboration1.z_internalRemoveFromCustomer(oldOther);
				if ( oldOther != null ) {
					oldOther.z_internalRemoveFromBusinessCollaboration1(businessCollaboration1);
				}
				businessCollaboration1.z_internalAddToCustomer((Customer)this);
			}
			this.z_internalAddToBusinessCollaboration1(businessCollaboration1);
		} else {
			if ( !oldValue.equals(businessCollaboration1) ) {
				oldValue.z_internalRemoveFromCustomer(this);
	...
	public String toXmlReferenceString() {
		return "<Customer uid=\""+getUid() + "\"/>";
	}
	
	public String toXmlString() {
		StringBuilder sb = new StringBuilder();
		sb.append("<Customer ");
		sb.append("classUuid=\"bpm.uml@_FEtqQI_cEeKWQLWOG6WHmA\" ");
		sb.append("className=\"bpmmodel.Customer\" ");
