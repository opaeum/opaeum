...
public class BpmmodelFormatter extends AbstractFormatter {
	static final private ThreadLocal<BpmmodelFormatter> INSTANCE = new ThreadLocal<BpmmodelFormatter>();
	...
	static public BpmmodelFormatter getInstance() {
		BpmmodelFormatter result = INSTANCE.get();
		if ( result==null ) {
			INSTANCE.set(result=new BpmmodelFormatter());
		}
		return result;
	}
