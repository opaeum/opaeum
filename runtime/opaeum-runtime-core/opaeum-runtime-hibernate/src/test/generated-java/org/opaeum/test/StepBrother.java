...
@AccessType(	"field")
@Table(name="step_brother",uniqueConstraints=
	@UniqueConstraint(columnNames={"family_id","name","deleted_on"}))
@NamedQueries(value=
	@NamedQuery(name="QueryStepBrotherWithNameForFamily",query="from StepBrother a where a.family = :family and a.name = :name"))
