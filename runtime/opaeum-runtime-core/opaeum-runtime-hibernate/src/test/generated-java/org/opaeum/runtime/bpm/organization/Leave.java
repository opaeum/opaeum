...
@NumlMetaInfo(applicationIdentifier="opaeum_hibernate_tests",uuid="252060@_Pybi0Et3EeGElKTCe2jfDw")
@Filter(name="noDeletedObjects")
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@AccessType(	"field")
@Table(name="leave",schema="bpm")
@Entity(name="Leave")
public class Leave implements IPersistentObject, IEventGenerator, HibernateEntity, CompositionNode, Serializable {
	...
	@TableGenerator(allocationSize=20,name="id_generator",pkColumnName="type",pkColumnValue="leave",table="hi_value")
	@Id
	@GeneratedValue(generator="id_generator",strategy=javax.persistence.GenerationType.TABLE)
	private Long id;
	static private Set<? extends Leave> mockedAllInstances;
	@Version
	...
	public void z_internalRemoveFromFromDate(Date fromDate) {
		if ( getFromDate()!=null && fromDate!=null && fromDate.equals(getFromDate()) ) {
			this.fromDate=null;
			this.fromDate=null;
		}
	}
	...
	public void z_internalRemoveFromToDate(Date toDate) {
		if ( getToDate()!=null && toDate!=null && toDate.equals(getToDate()) ) {
			this.toDate=null;
			this.toDate=null;
		}
	}
