...
@NumlMetaInfo(applicationIdentifier="opaeum_hibernate_tests",uuid="252060@_p2yl4Pl5EeGYn9aDKdPmKA")
...
public class PricePerUnit implements IPersistentObject, IEventGenerator, HibernateEntity, CompositionNode, IPricePerUnit, Serializable {
	...
	public void init(CompositionNode owner) {
		this.z_internalAddToQuantifiedResourcePricePerUnit_quantifiedResource(new QuantifiedResourcePricePerUnit((PricePerUnit)this,(IQuantifiedResource)owner));
	}
	...
	public void markDeleted() {
		...
		if ( getQuantifiedResource()!=null ) {
			QuantifiedResourcePricePerUnit link = getQuantifiedResourcePricePerUnit_quantifiedResource();
			link.getQuantifiedResource().z_internalRemoveFromQuantifiedResourcePricePerUnit_pricePerUnit(link);
			link.markDeleted();
		}
	...
	public void setQuantifiedResource(IQuantifiedResource quantifiedResource) {
		if ( this.getQuantifiedResource()!=null ) {
			this.getQuantifiedResource().z_internalRemoveFromQuantifiedResourcePricePerUnit_pricePerUnit(getQuantifiedResourcePricePerUnit_quantifiedResource());
		}
		if ( quantifiedResource == null ) {
			this.z_internalRemoveFromQuantifiedResourcePricePerUnit_quantifiedResource(this.getQuantifiedResourcePricePerUnit_quantifiedResource());
		} else {
			QuantifiedResourcePricePerUnit quantifiedResourcePricePerUnit_quantifiedResource = new QuantifiedResourcePricePerUnit((PricePerUnit)this,(IQuantifiedResource)quantifiedResource);
			this.z_internalAddToQuantifiedResourcePricePerUnit_quantifiedResource(quantifiedResourcePricePerUnit_quantifiedResource);
			quantifiedResource.z_internalAddToQuantifiedResourcePricePerUnit_pricePerUnit(quantifiedResourcePricePerUnit_quantifiedResource);
		}
	}
	...
	public void z_internalAddToAdditionalCostToCompany(Double additionalCostToCompany) {
		if ( additionalCostToCompanyCurrency!=null && !additionalCostToCompanyCurrency.equals(org.opaeum.opaeum_hibernate_tests.util.Opaeum_hibernate_testsEnvironment.INSTANCE.getDefaultCurrency()) ) {
			throw new CurrencyMismatchException(additionalCostToCompanyCurrency,org.opaeum.opaeum_hibernate_tests.util.Opaeum_hibernate_testsEnvironment.INSTANCE.getDefaultCurrency());
		}
		if ( additionalCostToCompany.equals(this.additionalCostToCompany) ) {
			return;
		}
	...
	public void z_internalAddToEffectiveFrom(Date effectiveFrom) {
		if ( effectiveFrom.equals(this.effectiveFrom) ) {
			return;
		}
	...
	public void z_internalAddToPricePaidByCompany(Double pricePaidByCompany) {
		if ( pricePaidByCompanyCurrency!=null && !pricePaidByCompanyCurrency.equals(org.opaeum.opaeum_hibernate_tests.util.Opaeum_hibernate_testsEnvironment.INSTANCE.getDefaultCurrency()) ) {
			throw new CurrencyMismatchException(pricePaidByCompanyCurrency,org.opaeum.opaeum_hibernate_tests.util.Opaeum_hibernate_testsEnvironment.INSTANCE.getDefaultCurrency());
		}
		if ( pricePaidByCompany.equals(this.pricePaidByCompany) ) {
			return;
		}
	...
	public void z_internalAddToPricePaidByCustomer(Double pricePaidByCustomer) {
		if ( pricePaidByCustomerCurrency!=null && !pricePaidByCustomerCurrency.equals(org.opaeum.opaeum_hibernate_tests.util.Opaeum_hibernate_testsEnvironment.INSTANCE.getDefaultCurrency()) ) {
			throw new CurrencyMismatchException(pricePaidByCustomerCurrency,org.opaeum.opaeum_hibernate_tests.util.Opaeum_hibernate_testsEnvironment.INSTANCE.getDefaultCurrency());
		}
		if ( pricePaidByCustomer.equals(this.pricePaidByCustomer) ) {
			return;
		}
