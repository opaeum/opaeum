...
public class Active<SME extends AbstractRequest> extends StateActivation<SME, AbstractRequestToken<SME>> {
	static public String ID = "252060@_KHZWEPNREeGhGoYzbfvy4A";

	/** Constructor for Active
	 * 
	 * @param region 
	 */
	public Active(Region1<SME> region) {
	super(ID,region);
	}
