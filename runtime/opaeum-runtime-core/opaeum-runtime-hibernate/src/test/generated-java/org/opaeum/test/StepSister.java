...
@NumlMetaInfo(applicationIdentifier="opaeum_hibernate_tests",uuid="Structures.uml@_r-BmsIlZEeKhILqZBrW9Hg")
...
public class StepSister implements StepChild, IPersistentObject, IEventGenerator, HibernateEntity, CompositionNode, Serializable {
	...
	@TableGenerator(allocationSize=20,name="id_generator",pkColumnName="type",pkColumnValue="step_sister",table="hi_value")
	@Id
	@GeneratedValue(generator="id_generator",strategy=javax.persistence.GenerationType.TABLE)
	private Long id;
	static private Set<? extends StepSister> mockedAllInstances;
	@OneToOne(cascade=javax.persistence.CascadeType.ALL,fetch=javax.persistence.FetchType.LAZY)
	...
	@Where(clause="step_sibling1_type='Structures.uml@_r-BmsIlZEeKhILqZBrW9Hg'")
	...
	static public Set<? extends StepSister> allInstances(AbstractPersistence persistence) {
		if ( mockedAllInstances==null ) {
			return new HashSet(persistence.readAll(org.opaeum.test.StepSister.class));
		} else {
