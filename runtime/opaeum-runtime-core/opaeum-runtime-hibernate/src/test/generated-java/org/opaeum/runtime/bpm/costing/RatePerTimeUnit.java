...
@NumlMetaInfo(applicationIdentifier="opaeum_hibernate_tests",uuid="252060@_zQphYPjuEeGEN6Fz86uBYA")
...
public class RatePerTimeUnit implements IPersistentObject, IEventGenerator, HibernateEntity, CompositionNode, IRatePerTimeUnit, Serializable {
	...
	public void init(CompositionNode owner) {
		this.z_internalAddToTimedResourceRatePerTimeUnit_timedResource(new TimedResourceRatePerTimeUnit((RatePerTimeUnit)this,(ITimedResource)owner));
	}
	...
	public void markDeleted() {
		...
		if ( getTimedResource()!=null ) {
			TimedResourceRatePerTimeUnit link = getTimedResourceRatePerTimeUnit_timedResource();
			link.getTimedResource().z_internalRemoveFromTimedResourceRatePerTimeUnit_ratePerTimeUnit(link);
			link.markDeleted();
		}
	...
	public void setTimedResource(ITimedResource timedResource) {
		if ( this.getTimedResource()!=null ) {
			this.getTimedResource().z_internalRemoveFromTimedResourceRatePerTimeUnit_ratePerTimeUnit(getTimedResourceRatePerTimeUnit_timedResource());
		}
		if ( timedResource == null ) {
			this.z_internalRemoveFromTimedResourceRatePerTimeUnit_timedResource(this.getTimedResourceRatePerTimeUnit_timedResource());
		} else {
			TimedResourceRatePerTimeUnit timedResourceRatePerTimeUnit_timedResource = new TimedResourceRatePerTimeUnit((RatePerTimeUnit)this,(ITimedResource)timedResource);
			this.z_internalAddToTimedResourceRatePerTimeUnit_timedResource(timedResourceRatePerTimeUnit_timedResource);
			timedResource.z_internalAddToTimedResourceRatePerTimeUnit_ratePerTimeUnit(timedResourceRatePerTimeUnit_timedResource);
		}
	}
	...
	public void z_internalAddToRatePaidByCompany(Double ratePaidByCompany) {
		if ( ratePaidByCompanyCurrency!=null && !ratePaidByCompanyCurrency.equals(org.opaeum.opaeum_hibernate_tests.util.Opaeum_hibernate_testsEnvironment.INSTANCE.getDefaultCurrency()) ) {
			throw new CurrencyMismatchException(ratePaidByCompanyCurrency,org.opaeum.opaeum_hibernate_tests.util.Opaeum_hibernate_testsEnvironment.INSTANCE.getDefaultCurrency());
		}
		if ( ratePaidByCompany.equals(this.ratePaidByCompany) ) {
			return;
		}
	...
	public void z_internalAddToRatePaidByCustomer(Double ratePaidByCustomer) {
		if ( ratePaidByCustomerCurrency!=null && !ratePaidByCustomerCurrency.equals(org.opaeum.opaeum_hibernate_tests.util.Opaeum_hibernate_testsEnvironment.INSTANCE.getDefaultCurrency()) ) {
			throw new CurrencyMismatchException(ratePaidByCustomerCurrency,org.opaeum.opaeum_hibernate_tests.util.Opaeum_hibernate_testsEnvironment.INSTANCE.getDefaultCurrency());
		}
		if ( ratePaidByCustomer.equals(this.ratePaidByCustomer) ) {
			return;
		}
	...
	public void z_internalAddToTimeUnit(BusinessTimeUnit timeUnit) {
		if ( timeUnit.equals(this.timeUnit) ) {
			return;
		}
