...
@AccessType("field")
public class BusinessCalendar extends BusinessCalendarGenerated implements IBusinessCalendar{
	private static final long serialVersionUID = -161618913396793066L;
	static BusinessCalendar instance = new BusinessCalendar();
	static ThreadLocal<BusinessCalendar> INSTANCE= new ThreadLocal<BusinessCalendar>();
	...
	@Override
	public Double convertBusinessTime(Double cumulativeQuantity,BusinessTimeUnit timeUnit,BusinessTimeUnit timeUnit2){
