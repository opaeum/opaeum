...
public class DurationBasedCost{
	...
	public List<DurationBasedCostEntry> toEventOccurred(Collection<? extends ITimedResourceBase> resources,boolean firstEvent,Environment env){
	...
	public DurationBasedCostEntry addCostEntry(Date fromDate,Date toDate,ITimedResourceBase resource, Environment env){
