...
public class OpaeumWorkbenchWindowAdvisor extends WorkbenchWindowAdvisor{
	private static final Color COLOR_WHITE = Display.getDefault().getSystemColor(SWT.COLOR_WHITE);
	private boolean introActive = true;
	public OpaeumWorkbenchWindowAdvisor(final IWorkbenchWindowConfigurer configurer){
		super(configurer);
	}
	@Override
