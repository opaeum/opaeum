...
public class RMSActionBarAdvisor extends ActionBarAdvisor{
	...
	protected void makeActions(final IWorkbenchWindow window){
		...
		register(this.logoutACtion = new Action("Logout"){
			@Override
			public String getId(){
				return "LogoutAction";
			}
			...
			public void run(){
				...
				activeWorkbenchWindow.getActivePage().setPerspective(desc);
			}
			@Override
	...
	protected void fillMenuBar(final IMenuManager menuBar){
		MenuManager windowMenu = new MenuManager(RMSMessages.get().RMSActionBarAdvisor_Window, IWorkbenchActionConstants.M_WINDOW);
