...
public class MultiUserRoleAllocationMatrix extends Composite{
	...
	private Object[] getEntries(){
		...
		return builSelectionsForContacts(entries, model.getApplication().getEnvironment()).toArray();
	}
	...
	protected void createUserRoleColumns(final TableViewer viewer){
		...
		IOpaeumApplication application = model.getApplication();
	...
	public void testIt() throws Exception{
		...
		if(iterator.hasNext()){
			...
			IBusinessCollaborationBase sb = app.getRootBusinessCollaboration();
