...
public class BehaviorNavigationConstraintImpl extends EObjectImpl implements BehaviorNavigationConstraint {
	...
	public void populateReferencesFromXml(Element xml) {
		...
		while ( i<propertyNodes.getLength() ) {
			...
			if ( currentPropertyNode instanceof Element && currentPropertyNode.getNodeName().equals("parameters") ) {
				((org.opaeum.uim.perspective.ParameterNavigationConstraint)this.eResource().getElement((Element)currentPropertyNode)).populateReferencesFromXml((Element)currentPropertyNode);
			}
		}
	}
