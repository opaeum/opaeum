...
public class GridPanelImpl extends EObjectImpl implements GridPanel {
	...
	public void buildTreeFromXml(Element xml, Map<String, Object> map) {
		...
		if ( xml.getAttribute("numberOfColumns").length()>0 ) {
			setNumberOfColumns(EcoreDataTypeParser.getInstance().parseEIntegerObject(xml.getAttribute("numberOfColumns")));
		}
