...
public class BehaviorExecutionEditorImpl extends EObjectImpl implements BehaviorExecutionEditor {
	...
	public void populateReferencesFromXml(Element xml) {
		...
		while ( i<propertyNodes.getLength() ) {
			...
			if ( currentPropertyNode instanceof Element && currentPropertyNode.getNodeName().equals("menuConfiguration") ) {
				((org.opaeum.uim.editor.MenuConfiguration)this.eResource().getElement((Element)currentPropertyNode)).populateReferencesFromXml((Element)currentPropertyNode);
			}
		}
	}
