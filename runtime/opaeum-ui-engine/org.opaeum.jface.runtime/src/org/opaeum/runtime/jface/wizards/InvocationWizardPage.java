...
public class InvocationWizardPage extends WizardPage{
	private static final long serialVersionUID = 1231231321L;
	private Page opaeumPage;
	private OpaeumRapSession session;
	public InvocationWizardPage(Page opaeumPage,DataBindingContext dataBindingContext,IPersistentObject selectedObject,
			Object objectBeingEdited,OpaeumRapSession session){
