...
public class UMLDiagramEditorPlugin extends AbstractUIPlugin{
	public static final String ID = "org.opaeum.papyrus.usecasediagram"; //$NON-NLS-1$
	...
	/**
	 * Respects images residing in any plug-in. If path is relative, then this bundle is looked up for the image, otherwise, for absolute
	...
	/**
	 * Returns an image for the image file at the given plug-in relative path. Client do not need to dispose this image. Images will be
