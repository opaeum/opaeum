...
/**
 * An instantiation of an annotation, i.e. an annotation assignment or an
 * annotation appplication. Has a type and could have values for its atributes.
 * If no attributes were assigned but values were added directly to the
 * annotation value, the following syntax will be used:
 * '@AnAnnotation({"value1","value2"}). If attribute values were added, the
 * conventional syntax will be used:
