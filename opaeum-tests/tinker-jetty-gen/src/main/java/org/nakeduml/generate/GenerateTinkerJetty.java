...
import net.sf.opaeum.javageneration.auditing.TinkerAuditImplementationStep;
import net.sf.opaeum.javageneration.auditing.TinkerImplementAttributeCacheStep;
