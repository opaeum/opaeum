...
public class GenerateTinkerTestSignals {

	public static void main(String[] args) throws Exception {
		GenerateTinkerTestSignals generateTest = new GenerateTinkerTestSignals();
		generateTest.generate("signalTest");
	...
	public GenerateTinkerTestSignals() {
		String workspaceRoot = "/home/pieter/workspace-apaeum";
		this.resourceSet = EmfWorkspaceLoader.setupStandAloneAppForUML2();
		this.workspaceRoot = workspaceRoot;
		this.cfg = new OpaeumConfig(new File(workspaceRoot + "/nakeduml/opaeum-tests/opaeum-test-models/Models/tinker/tinker-test-signal.properties"));
