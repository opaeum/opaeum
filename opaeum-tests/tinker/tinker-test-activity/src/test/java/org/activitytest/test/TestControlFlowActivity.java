...
//		Root + Customer + homeAddress + workAddress + Activity nodes + 1 Control token
		...
		IActivityNode<? extends Token, ? extends Token> initialNode1 = sendEmailActivityProcess.getNodeForName("InitialNode1");
		...
		db.stopTransaction(Conclusion.SUCCESS);
		Set<IActivityNode<? extends Token, ? extends Token>> completedNodes = sendEmailActivityProcess.getCompletedNodes();
		...
		Set<IActivityNode<? extends Token, ? extends Token>> activeNodes = sendEmailActivityProcess.getActiveNodes();
		Assert.assertEquals(0, activeNodes.size());
		IActivityNode<? extends Token, ? extends Token> sendEmail = sendEmailActivityProcess.getNodeForName("SendEmail");
		...
		IActivityNode<? extends Token, ? extends Token> sendSms = sendEmailActivityProcess.getNodeForName("SendSms");
		...
		IActivityNode<? extends Token, ? extends Token> forkNode1 = sendEmailActivityProcess.getNodeForName("ForkNode1");
		...
		IActivityNode<? extends Token, ? extends Token> opaqueAction1 = sendEmailActivityProcess.getNodeForName("OpaqueAction1");
		...
		IActivityNode<? extends Token, ? extends Token> opaqueAction2 = sendEmailActivityProcess.getNodeForName("OpaqueAction2");
		...
		IActivityNode<? extends Token, ? extends Token> joinNode1 = sendEmailActivityProcess.getNodeForName("JoinNode1");
		...
		IActivityNode<? extends Token, ? extends Token> forkNode2 = sendEmailActivityProcess.getNodeForName("ForkNode2");
		...
		IActivityNode<? extends Token, ? extends Token> opaqueAction3 = sendEmailActivityProcess.getNodeForName("OpaqueAction3");
		...
		IActivityNode<? extends Token, ? extends Token> opaqueAction4 = sendEmailActivityProcess.getNodeForName("OpaqueAction4");
		...
		IActivityNode<? extends Token, ? extends Token> mergeNode1 = sendEmailActivityProcess.getNodeForName("MergeNode1");
		...
		IActivityNode<? extends Token, ? extends Token> decisionNode1 = sendEmailActivityProcess.getNodeForName("DecisionNode1");
		...
		IActivityNode<? extends Token, ? extends Token> opaqueAction6 = sendEmailActivityProcess.getNodeForName("OpaqueAction6");
		...
		IActivityNode<? extends Token, ? extends Token> opaqueAction5 = sendEmailActivityProcess.getNodeForName("OpaqueAction5");
		...
		IActivityNode<? extends Token, ? extends Token> flowFinalNode1 = sendEmailActivityProcess.getNodeForName("FlowFinalNode1");
	...
	private Set<String> extractNames(Set<IActivityNode<? extends Token, ? extends Token>> completedNodes) {
		Set<String> nodeNames = new HashSet<String>();
		for (IActivityNode<? extends Token, ? extends Token> abstractNode : completedNodes) {
