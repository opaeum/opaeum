...
public class Suspended<SME extends AbstractRequest> extends StateActivation<SME, AbstractRequestToken<SME>> {
	static public String ID = "252060@_O2wBIPNREeGhGoYzbfvy4A";

	/** Constructor for Suspended
	 * 
	 * @param region 
	 */
	public Suspended(Region1<SME> region) {
	super(ID,region);
	}
