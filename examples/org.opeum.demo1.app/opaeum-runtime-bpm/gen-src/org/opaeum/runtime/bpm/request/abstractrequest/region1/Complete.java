...
public class Complete<SME extends AbstractRequest> extends StateActivation<SME, AbstractRequestToken<SME>> {
	static public String ID = "252060@_U2MbEPNREeGhGoYzbfvy4A";

	/** Constructor for Complete
	 * 
	 * @param region 
	 */
	public Complete(Region1<SME> region) {
	super(ID,region);
	}
	...
	public void onEntry(AbstractRequestToken token) {
		super.onEntry(token);
