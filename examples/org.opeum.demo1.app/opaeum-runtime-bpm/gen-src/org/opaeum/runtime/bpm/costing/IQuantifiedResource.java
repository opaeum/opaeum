...
@NumlMetaInfo(applicationIdentifier="demo1",uuid="252060@_mKcP8Pl5EeGYn9aDKdPmKA")
public interface IQuantifiedResource extends IQuantifiedResourceBase, HibernateEntity, CompositionNode, Serializable, IPersistentObject {
	...
	public void addToQuantifiedResourcePricePerUnit_pricePerUnit(QuantifiedResourcePricePerUnit quantifiedResourcePricePerUnit_pricePerUnit);
	
	public void buildTreeFromXml(Element xml, Map<String, Object> map);
	
	public void clearPricePerUnit();
	
	public void clearQuantifiedResourcePricePerUnit_pricePerUnit();
	...
	@NumlMetaInfo(uuid="252060@_gDOkpPl6EeGYn9aDKdPmKA")
	public List<? extends PricePerUnit> getPricePerUnit();
	
	@PropertyMetaInfo(constraints={},isComposite=false,opaeumId=8621165129034210297l,opposite="quantifiedResource",uuid="252060@_gDOkoPl6EeGYn9aDKdPmKA")
	...
	public void removeFromQuantifiedResourcePricePerUnit_pricePerUnit(QuantifiedResourcePricePerUnit quantifiedResourcePricePerUnit_pricePerUnit);
	
	public void setPricePerUnit(List<PricePerUnit> pricePerUnit);
	
	public void setQuantifiedResourcePricePerUnit_pricePerUnit(List<QuantifiedResourcePricePerUnit> quantifiedResourcePricePerUnit_pricePerUnit);
