package structuredbusiness.appliancedoctor;
...
public class AddAccountantHandler4272470142100685737 implements ICallEventHandler {
	 ...
	 * @param isEvent 
	 */
	public AddAccountantHandler4272470142100685737(String name, String isChartered, Manager manager, boolean isEvent) {
	...
	public void setChartered(String isChartered) {
		...
		for ( PropertyValue p : ps ) {
			if ( p.getId()==341190338248797855l ) {
				...
				if ( p.getId()==9099761849766142693l ) {
					this.setChartered((String)Value.valueOf(p.getValue(),persistence));
				} else {
