	...
	public void setParticipationParticipant_participant(ParticipationParticipant participationParticipant_participant) {
		...
		if ( oldValue==null ) {
			if ( participationParticipant_participant!=null ) {
				ParticipationInRequest oldOther = (ParticipationInRequest)participationParticipant_participant.getParticipation();
				...
				participationParticipant_participant.z_internalAddToParticipation((ParticipationInRequest)this);
			}
