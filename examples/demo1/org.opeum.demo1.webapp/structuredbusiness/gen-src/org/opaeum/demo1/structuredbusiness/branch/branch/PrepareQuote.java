	...
	public void setContextObject(Branch contextObject) {
		...
		if ( oldValue==null ) {
			if ( contextObject!=null ) {
				PrepareQuote oldOther = (PrepareQuote)contextObject.getPrepareQuote();
				contextObject.z_internalRemoveFromPrepareQuote(oldOther);
				if ( oldOther != null ) {
					oldOther.z_internalRemoveFromContextObject(contextObject);
				}
				contextObject.z_internalAddToPrepareQuote((PrepareQuote)this);
			}
			this.z_internalAddToContextObject(contextObject);
		} else {
			if ( !oldValue.equals(contextObject) ) {
				oldValue.z_internalRemoveFromPrepareQuote(this);
