...
public class StructuredbusinessJavaMetaInfoMap extends JavaMetaInfoMap {
	...
	public StructuredbusinessJavaMetaInfoMap() {
		...
		putClass(org.opaeum.demo1.structuredbusiness.IdBook.class,"914890@_oiVeEGCfEeG6xvYqJACneg");
		putClass(org.opaeum.demo1.structuredbusiness.Manager.class,"914890@_u7lZEGQWEeGbL9nlXe9lTQ");
		putClass(org.opaeum.demo1.structuredbusiness.OnlineCustomer.class,"914890@_xQY8oGFKEeG2AvOqZt1NZQ");
		putClass(org.opaeum.demo1.structuredbusiness.ProductAnnouncement.class,"914890@_o9aQgGCfEeG6xvYqJACneg");
		putClass(org.opaeum.demo1.structuredbusiness.StructuredBusiness.class,"914890@_kqiUQHjtEeKMgr_8va3Mhg");
