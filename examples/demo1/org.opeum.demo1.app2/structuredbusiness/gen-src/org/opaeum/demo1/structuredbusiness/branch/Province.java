...
@NumlMetaInfo(applicationIdentifier="demo1",uuid="914890@_CkljUJJWEeGFkOm2e1MJNQ")
public enum Province implements IEnum, Serializable {
	...
	public void clearCity() {
		Set<City> tmp = new HashSet<City>(getCity());
		for ( City o : tmp ) {
			removeFromCity(o);
		}
	}
