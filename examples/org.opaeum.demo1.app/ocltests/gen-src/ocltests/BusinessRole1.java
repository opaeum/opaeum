...
@NumlMetaInfo(applicationIdentifier="demo1",uuid="ocltests.uml@_b1zFwOIfEeGXVpXEt0fddw")
@BusinessRole
...
public class BusinessRole1 implements IPersistentObject, IEventGenerator, HibernateEntity, CompositionNode, IBusinessRole, Serializable {
	...
	@TableGenerator(allocationSize=20,name="id_generator",pkColumnName="type",pkColumnValue="business_role1",table="hi_value")
	@Id
	@GeneratedValue(generator="id_generator",strategy=javax.persistence.GenerationType.TABLE)
	private Long id;
	static private Set<? extends BusinessRole1> mockedAllInstances;
	@Version
	...
	@Where(clause="timed_resource_type='ocltests.uml@_b1zFwOIfEeGXVpXEt0fddw'")
	@LazyCollection(	org.hibernate.annotations.LazyCollectionOption.TRUE)
	...
	public void setPersonInBusinessRole_representedPerson(PersonInBusinessRole personInBusinessRole_representedPerson) {
		...
		if ( oldValue==null ) {
			if ( personInBusinessRole_representedPerson!=null ) {
				BusinessRole1 oldOther = (BusinessRole1)personInBusinessRole_representedPerson.getBusinessRole();
				...
				personInBusinessRole_representedPerson.z_internalAddToBusinessRole((BusinessRole1)this);
			}
