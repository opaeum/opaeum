...
public class OnlineCustomerActualInstance1_6z5Rcn_JEeK5usaVqVCtXw extends EntityInstanceSimulation<OnlineCustomer> {
	static final public OnlineCustomerActualInstance1_6z5Rcn_JEeK5usaVqVCtXw INSTANCE = new OnlineCustomerActualInstance1_6z5Rcn_JEeK5usaVqVCtXw();
	static final public OnlineCustomer ONLINECUSTOMERACTUALINSTANCE1 = new OnlineCustomer();


	public OnlineCustomer createNewObject(CompositionNode parent) throws Exception {
		OnlineCustomer result = ONLINECUSTOMERACTUALINSTANCE1;
		result.init(parent);
