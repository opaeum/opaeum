...
@NumlMetaInfo(applicationIdentifier="demo1",uuid="914890@_u7lZEGQWEeGbL9nlXe9lTQ")
@BusinessRole
@Filter(name="noDeletedObjects")
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@AccessType(	"field")
@Table(name="manager",schema="structuredbusiness")
@Entity(name="Manager")
public class Manager implements IPersistentObject, IEventGenerator, HibernateEntity, CompositionNode, IBusinessRole, Serializable {
	...
	@TableGenerator(allocationSize=20,name="id_generator",pkColumnName="type",pkColumnValue="manager",table="hi_value")
	@Id
	@GeneratedValue(generator="id_generator",strategy=javax.persistence.GenerationType.TABLE)
	private Long id;
	static private Set<? extends Manager> mockedAllInstances;
	@Column(name="name")
	@Basic
	...
	@Where(clause="timed_resource_type='914890@_u7lZEGQWEeGbL9nlXe9lTQ'")
	@LazyCollection(	org.hibernate.annotations.LazyCollectionOption.TRUE)
	...
	@Basic
	protected Integer yearsInPosition;
	...
	static public Set<? extends Manager> allInstances(AbstractPersistence persistence) {
		if ( mockedAllInstances==null ) {
			return new HashSet(persistence.readAll(org.opaeum.demo1.structuredbusiness.branch.Manager.class));
		} else {
	...
	public void setPersonInBusinessRole_representedPerson(PersonInBusinessRole personInBusinessRole_representedPerson) {
		...
		if ( oldValue==null ) {
			if ( personInBusinessRole_representedPerson!=null ) {
				Manager oldOther = (Manager)personInBusinessRole_representedPerson.getBusinessRole();
				...
				personInBusinessRole_representedPerson.z_internalAddToBusinessRole((Manager)this);
			}
	...
	public String toXmlString() {
		...
		sb.append("className=\"org.opaeum.demo1.structuredbusiness.branch.Manager\" ");
	...
	public void z_internalAddToContactNumber(String contactNumber) {
		if ( contactNumber.equals(getContactNumber()) ) {
			return;
		}
	...
	public void z_internalAddToHourlyRate(Double hourlyRate) {
		if ( hourlyRate.equals(getHourlyRate()) ) {
			return;
		}
	...
	public void z_internalAddToYearsInPosition(Integer yearsInPosition) {
		if ( yearsInPosition.equals(getYearsInPosition()) ) {
			return;
		}
		this.yearsInPosition=yearsInPosition;
	}
	
	public void z_internalRemoveFromContactNumber(String contactNumber) {
		if ( getContactNumber()!=null && contactNumber!=null && contactNumber.equals(getContactNumber()) ) {
	...
	public void z_internalRemoveFromHourlyRate(Double hourlyRate) {
		if ( getHourlyRate()!=null && hourlyRate!=null && hourlyRate.equals(getHourlyRate()) ) {
	...
	public void z_internalRemoveFromYearsInPosition(Integer yearsInPosition) {
		if ( getYearsInPosition()!=null && yearsInPosition!=null && yearsInPosition.equals(getYearsInPosition()) ) {
