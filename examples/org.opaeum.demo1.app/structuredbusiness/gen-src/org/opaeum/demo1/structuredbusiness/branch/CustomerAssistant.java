...
public class CustomerAssistant implements IPersistentObject, IEventGenerator, HibernateEntity, CompositionNode, IBusinessRole, Serializable {
	...
	public boolean consumeFollowLeadOccurrence(@ParameterMetaInfo(name="customer",opaeumId=5501124320077697795l,uuid="914890@_Dzy24JKiEeGiJMBDeZRymA") OnlineCustomer customer, @ParameterMetaInfo(name="timeOfLead",opaeumId=3684593961093410895l,strategyFactory=DateTimeStrategyFactory.class,uuid="914890@_D1Kv4JKiEeGiJMBDeZRymA") Date timeOfLead) {
	...
	public void followLead(@ParameterMetaInfo(name="customer",opaeumId=5501124320077697795l,uuid="914890@_Dzy24JKiEeGiJMBDeZRymA") OnlineCustomer customer, @ParameterMetaInfo(name="timeOfLead",opaeumId=3684593961093410895l,strategyFactory=DateTimeStrategyFactory.class,uuid="914890@_D1Kv4JKiEeGiJMBDeZRymA") Date timeOfLead) throws FailedConstraintsException {
	...
	public void generateFollowLeadEvent(@ParameterMetaInfo(name="customer",opaeumId=5501124320077697795l,uuid="914890@_Dzy24JKiEeGiJMBDeZRymA") OnlineCustomer customer, @ParameterMetaInfo(name="timeOfLead",opaeumId=3684593961093410895l,strategyFactory=DateTimeStrategyFactory.class,uuid="914890@_D1Kv4JKiEeGiJMBDeZRymA") Date timeOfLead) {
	}
