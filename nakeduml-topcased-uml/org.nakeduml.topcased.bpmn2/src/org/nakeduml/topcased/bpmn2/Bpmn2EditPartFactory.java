...
import org.nakeduml.topcased.activitydiagram.bpm.BusinessProcessDiagramEditPart;
...
public class Bpmn2EditPartFactory extends ActivityEditPartFactory{
	...
	private class NodeUMLSwitch extends UMLSwitch<Object>{
		...
		public Object caseAcceptEventAction(org.eclipse.uml2.uml.AcceptEventAction object){
			return new BpmnIntermediateEventEditPart(node);
		}
