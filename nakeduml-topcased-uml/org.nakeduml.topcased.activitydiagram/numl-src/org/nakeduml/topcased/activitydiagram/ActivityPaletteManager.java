 ...
 * @generated
 */
public class ActivityPaletteManager extends ModelerPaletteManager
{
...
//    private PaletteDrawer commentDrawer;
     ...
     * @generated
     */
    public ActivityPaletteManager(ICreationUtils utils)
    {
        super();
...
//        getRoot().remove(commentDrawer);
    ...
    private void createControlDrawer()
    {
        ...
        PaletteStack structuredActivitiesStack = new PaletteStack("Expansion Region", "Expansion Region", ActivityImageRegistry.getImageDescriptor("EXPANSIONREGION"));

        CreationFactory factory;

        factory = new GraphElementCreationFactory(creationUtils, UMLPackage.eINSTANCE.getInitialNode(), "default");
        entries.add(new ModelerCreationToolEntry("Initial Node", "Initial Node", factory, ActivityImageRegistry.getImageDescriptor("INITIALNODE"),
                ActivityImageRegistry.getImageDescriptor("INITIALNODE_LARGE")));
        ...
        entries.add(new ModelerCreationToolEntry("Merge Node", "Merge Node", factory, ActivityImageRegistry.getImageDescriptor("MERGENODE"),
                ActivityImageRegistry.getImageDescriptor("MERGENODE_LARGE")));

        factory = new GraphElementCreationFactory(creationUtils, UMLPackage.eINSTANCE.getForkNode(), "default");
        entries.add(new ModelerCreationToolEntry("Fork Node", "Fork Node", factory, ActivityImageRegistry.getImageDescriptor("FORKNODE"), ActivityImageRegistry.getImageDescriptor("FORKNODE_LARGE")));

        factory = new GraphElementCreationFactory(creationUtils, UMLPackage.eINSTANCE.getJoinNode(), "default");
        entries.add(new ModelerCreationToolEntry("Join Node", "Join Node", factory, ActivityImageRegistry.getImageDescriptor("JOINNODE"), ActivityImageRegistry.getImageDescriptor("JOINNODE_LARGE")));
        ...
        entries.add(new ModelerCreationToolEntry("Flow Final", "Flow Final", factory, ActivityImageRegistry.getImageDescriptor("FLOWFINALNODE"),
                ActivityImageRegistry.getImageDescriptor("FLOWFINALNODE_LARGE")));

        // =================================== StructuredActivities ====================================
//        factory = new GraphElementCreationFactory(creationUtils, UMLPackage.eINSTANCE.getStructuredActivityNode(), "default");
//        structuredActivitiesStack.add(new ModelerCreationToolEntry("Structured Activity Node", "Structured Activity Node", factory, ActivityImageRegistry.getImageDescriptor("STRUCTUREDACTIVITY"),
...
//        structuredActivitiesStack.add(new ModelerCreationToolEntry("Conditional Node", "Conditional Node", factory, ActivityImageRegistry.getImageDescriptor("CONDITIONALNODE"),
//                ActivityImageRegistry.getImageDescriptor("CONDITIONALNODE_LARGE")));
        ...
        PaletteEntry defaultPaletteEntry = new ModelerCreationToolEntry("Expansion Region", "Expansion Region", factory, ActivityImageRegistry.getImageDescriptor("EXPANSIONREGION"),
                ActivityImageRegistry.getImageDescriptor("EXPANSIONREGION_LARGE"));
        ...
        structuredActivitiesStack.add(new ModelerCreationToolEntry("Interruptible Activity Region", "Interruptible Activity Region", factory,
                ActivityImageRegistry.getImageDescriptor("INTERRUPTIBLEACTIVITYREGION"), ActivityImageRegistry.getImageDescriptor("INTERRUPTIBLEACTIVITYREGION_LARGE")));
        // EndFix #809

//        factory = new GraphElementCreationFactory(creationUtils, UMLPackage.eINSTANCE.getLoopNode(), "default");
//        structuredActivitiesStack.add(new ModelerCreationToolEntry("Loop Node", "Loop Node", factory, ActivityImageRegistry.getImageDescriptor("LOOPNODE"),
...
//        structuredActivitiesStack.add(new ModelerCreationToolEntry("Sequence Node", "Sequence Node", factory, ActivityImageRegistry.getImageDescriptor("SEQUENCENODE"),
...
//        PaletteStack intermediateActionsStack = new PaletteStack("Read Link Action", "Read Link Action", ActivityImageRegistry.getImageDescriptor("READLINKACTION"));
        ...
        PaletteStack structuredActionsStack = new PaletteStack("Read Variable Action", "Read Variable Action", ActivityImageRegistry.getImageDescriptor("READVARIABLEACTION"));
        ...
        defaultPaletteEntry = new ModelerCreationToolEntry("Call Behavior Action", "Call Behavior Action", factory, ActivityImageRegistry.getImageDescriptor("CALLBEHAVIORACTION"),
        ...
        basicActionsStack.add(new ModelerCreationToolEntry("Call Operation Action", "Call Operation Action", factory, ActivityImageRegistry.getImageDescriptor("CALLOPERATIONACTION"),
                ActivityImageRegistry.getImageDescriptor("CALLOPERATIONACTION_LARGE")));

        factory = new GraphElementCreationFactory(creationUtils, UMLPackage.eINSTANCE.getSendObjectAction(), "default");
//        basicActionsStack.add(new ModelerCreationToolEntry("Send Object Action", "Send Object Action", factory, ActivityImageRegistry.getImageDescriptor("SENDOBJECTACTION"),
//                ActivityImageRegistry.getImageDescriptor("SENDOBJECTACTION_LARGE")));
        ...
        basicActionsStack.add(new ModelerCreationToolEntry("Send Signal Action", "Send Signal Action", factory, ActivityImageRegistry.getImageDescriptor("SENDSIGNALACTION"),
                ActivityImageRegistry.getImageDescriptor("SENDSIGNALACTION_LARGE")));
...
//        defaultPaletteEntry = new ModelerCreationToolEntry("Read Link Action", "Read Link Action", factory, ActivityImageRegistry.getImageDescriptor("READLINKACTION"),
...
//        intermediateActionsStack.add(new ModelerCreationToolEntry("Read Self Action", "Read Self Action", factory, ActivityImageRegistry.getImageDescriptor("READSELFACTION"),
//                ActivityImageRegistry.getImageDescriptor("READSELFACTION_LARGE")));
        ...
        basicActionsStack.add(new ModelerCreationToolEntry("Create Object Action", "Create Object Action", factory, ActivityImageRegistry.getImageDescriptor("CREATEOBJECTACTION"),
                ActivityImageRegistry.getImageDescriptor("CREATEOBJECTACTION_LARGE")));

//        factory = new GraphElementCreationFactory(creationUtils, UMLPackage.eINSTANCE.getCreateLinkAction(), "default");
//        intermediateActionsStack.add(new ModelerCreationToolEntry("Create Link Action", "Create Link Action", factory, ActivityImageRegistry.getImageDescriptor("CREATELINKACTION"),
...
//        intermediateActionsStack.add(new ModelerCreationToolEntry("Broadcast Signal Action", "Broadcast Signal Action", factory, ActivityImageRegistry.getImageDescriptor("BROADCASTSIGNALACTION"),
...
//        intermediateActionsStack.add(new ModelerCreationToolEntry("Test Identity Action", "Test Identity Action", factory, ActivityImageRegistry.getImageDescriptor("TESTIDENTITYACTION"),
...
//        intermediateActionsStack.add(new ModelerCreationToolEntry("Value Specification Action", "Value Specification Action", factory, ActivityImageRegistry.getImageDescriptor("VALUESPECIFICATIONACTION"),
...
//        intermediateActionsStack.add(new ModelerCreationToolEntry("Clear Association Action", "Clear Association Action", factory, ActivityImageRegistry.getImageDescriptor("CLEARASSOCIATIONACTION"),
...
//        intermediateActionsStack.add(new ModelerCreationToolEntry("Destroy Object Action", "Destroy Object Action", factory, ActivityImageRegistry.getImageDescriptor("DESTROYOBJECTACTION"),
...
//        intermediateActionsStack.add(new ModelerCreationToolEntry("Destroy Link Action", "Destroy Link Action", factory, ActivityImageRegistry.getImageDescriptor("DESTROYLINKACTION"),
//                ActivityImageRegistry.getImageDescriptor("DESTROYLINKACTION_LARGE")));
        ...
        defaultPaletteEntry = new ModelerCreationToolEntry("Accept Event Action", "Accept Event Action", factory, ActivityImageRegistry.getImageDescriptor("ACCEPTEVENTACTION"),
                ActivityImageRegistry.getImageDescriptor("ACCEPTEVENTACTION_LARGE"));
        ...
        completeActionsStack.add(new ModelerCreationToolEntry("Accept Time Event Action", "Accept Time Event Action", factory, ActivityImageRegistry.getImageDescriptor("ACCEPTTIMEEVENTACTION"),
                ActivityImageRegistry.getImageDescriptor("ACCEPTTIMEEVENTACTION_LARGE")));
        // EndFix #807

        factory = new GraphElementCreationFactory(creationUtils, UMLPackage.eINSTANCE.getAcceptCallAction(), "default");
        completeActionsStack.add(new ModelerCreationToolEntry("Accept Call Action", "Accept Call Action", factory, ActivityImageRegistry.getImageDescriptor("ACCEPTCALLACTION"),
...
//        completeActionsStack.add(new ModelerCreationToolEntry("Create Link Object Action", "Create Link Object Action", factory, ActivityImageRegistry.getImageDescriptor("CREATELINKOBJECTACTION"),
...
//        completeActionsStack.add(new ModelerCreationToolEntry("Read Extent Action", "Read Extent Action", factory, ActivityImageRegistry.getImageDescriptor("READEXTENTACTION"),
...
//        completeActionsStack.add(new ModelerCreationToolEntry("Read Is Classified Object Action", "Read Is Classified Object Action", factory,
//                ActivityImageRegistry.getImageDescriptor("READISCLASSIFIEDOBJECTACTION"), ActivityImageRegistry.getImageDescriptor("READISCLASSIFIEDOBJECTACTION_LARGE")));

//        factory = new GraphElementCreationFactory(creationUtils, UMLPackage.eINSTANCE.getReadLinkObjectEndAction(), "default");
//        completeActionsStack.add(new ModelerCreationToolEntry("Read Link Object End Action", "Read Link Object End Action", factory, ActivityImageRegistry.getImageDescriptor("READLINKOBJECTENDACTION"),
...
//        completeActionsStack.add(new ModelerCreationToolEntry("Read Link Object End Qualifier Action", "Read Link Object End Qualifier Action", factory,
//                ActivityImageRegistry.getImageDescriptor("READLINKOBJECTENDQUALIFIERACTION"), ActivityImageRegistry.getImageDescriptor("READLINKOBJECTENDQUALIFIERACTION_LARGE")));
//
//        factory = new GraphElementCreationFactory(creationUtils, UMLPackage.eINSTANCE.getReclassifyObjectAction(), "default");
//        completeActionsStack.add(new ModelerCreationToolEntry("Reclassify Object Action", "Reclassify Object Action", factory, ActivityImageRegistry.getImageDescriptor("RECLASSIFYOBJECTACTION"),
...
//        completeActionsStack.add(new ModelerCreationToolEntry("Reduce Action", "Reduce Action", factory, ActivityImageRegistry.getImageDescriptor("REDUCEACTION"),
//                ActivityImageRegistry.getImageDescriptor("REDUCEACTION_LARGE")));
        ...
        completeActionsStack.add(new ModelerCreationToolEntry("Start Classifier Behavior Action", "Start Classifier Behavior Action", factory,
                ActivityImageRegistry.getImageDescriptor("STARTCLASSIFIERBEHAVIORACTION"), ActivityImageRegistry.getImageDescriptor("STARTCLASSIFIERBEHAVIORACTION_LARGE")));

//        factory = new GraphElementCreationFactory(creationUtils, UMLPackage.eINSTANCE.getUnmarshallAction(), "default");
//        completeActionsStack.add(new ModelerCreationToolEntry("Unmarshall Action", "Unmarshall Action", factory, ActivityImageRegistry.getImageDescriptor("UNMARSHALLACTION"),
//                ActivityImageRegistry.getImageDescriptor("UNMARSHALLACTION_LARGE")));
        ...
        structuralFeatureActionsStack.add(new ModelerCreationToolEntry("Clear Structural Feature Action", "Clear Structural Feature Action", factory,
                ActivityImageRegistry.getImageDescriptor("CLEARSTRUCTURALFEATUREACTION"), ActivityImageRegistry.getImageDescriptor("CLEARSTRUCTURALFEATUREACTION_LARGE")));

        factory = new GraphElementCreationFactory(creationUtils, UMLPackage.eINSTANCE.getReadStructuralFeatureAction(), "default");
        defaultPaletteEntry = new ModelerCreationToolEntry("Read Structural Feature Action", "Read Structural Feature Action", factory,
        ...
        structuralFeatureActionsStack.add(new ModelerCreationToolEntry("Add Structural Feature Value Action", "Add Structural Feature Value Action", factory,
                ActivityImageRegistry.getImageDescriptor("ADDSTRUCTURALFEATUREVALUEACTION"), ActivityImageRegistry.getImageDescriptor("ADDSTRUCTURALFEATUREVALUEACTION_LARGE")));

        factory = new GraphElementCreationFactory(creationUtils, UMLPackage.eINSTANCE.getRemoveStructuralFeatureValueAction(), "default");
        structuralFeatureActionsStack.add(new ModelerCreationToolEntry("Remove Structural Feature Value Action", "Remove Structural Feature Value Action", factory,
                ActivityImageRegistry.getImageDescriptor("REMOVESTRUCTURALFEATUREVALUEACTION"), ActivityImageRegistry.getImageDescriptor("REMOVESTRUCTURALFEATUREVALUEACTION_LARGE")));

        // =================================== StructuredActions ====================================
        factory = new GraphElementCreationFactory(creationUtils, UMLPackage.eINSTANCE.getReadVariableAction(), "default");
        defaultPaletteEntry = new ModelerCreationToolEntry("Read Variable Action", "Read Variable Action", factory, ActivityImageRegistry.getImageDescriptor("READVARIABLEACTION"),
                ActivityImageRegistry.getImageDescriptor("READVARIABLEACTION_LARGE"));
        ...
        structuredActionsStack.add(new ModelerCreationToolEntry("Clear Variable Action", "Clear Variable Action", factory, ActivityImageRegistry.getImageDescriptor("CLEARVARIABLEACTION"),
                ActivityImageRegistry.getImageDescriptor("CLEARVARIABLEACTION_LARGE")));

        factory = new GraphElementCreationFactory(creationUtils, UMLPackage.eINSTANCE.getAddVariableValueAction(), "default");
        structuredActionsStack.add(new ModelerCreationToolEntry("Add Variable Value Action", "Add Variable Value Action", factory, ActivityImageRegistry.getImageDescriptor("ADDVARIABLEVALUEACTION"),
                ActivityImageRegistry.getImageDescriptor("ADDVARIABLEVALUEACTION_LARGE")));

        factory = new GraphElementCreationFactory(creationUtils, UMLPackage.eINSTANCE.getRemoveVariableValueAction(), "default");
        structuredActionsStack.add(new ModelerCreationToolEntry("Remove Variable Value Action", "Remove Variable Value Action", factory,
                ActivityImageRegistry.getImageDescriptor("REMOVEVARIABLEVALUEACTION"), ActivityImageRegistry.getImageDescriptor("REMOVEVARIABLEVALUEACTION_LARGE")));

        factory = new GraphElementCreationFactory(creationUtils, UMLPackage.eINSTANCE.getRaiseExceptionAction(), "default");
        structuredActionsStack.add(new ModelerCreationToolEntry("Raise Exception Action", "Raise Exception Action", factory, ActivityImageRegistry.getImageDescriptor("RAISEEXCEPTIONACTION"),
                ActivityImageRegistry.getImageDescriptor("RAISEEXCEPTIONACTION_LARGE")));
...
//            }
//        };
//        entries.add(new ModelerCreationToolEntry("Central Buffer", "Central Buffer", factory, ActivityImageRegistry.getImageDescriptor("CENTRALBUFFERNODE"),
...
//            }
//        };
//        entries.add(new ModelerCreationToolEntry("DataStore", "DataStore", factory, ActivityImageRegistry.getImageDescriptor("DATASTORENODE"),
//                ActivityImageRegistry.getImageDescriptor("DATASTORENODE_LARGE")));
        ...
        entries.add(new ModelerCreationToolEntry("Expansion", "Expansion", factory, ActivityImageRegistry.getImageDescriptor("EXPANSIONNODE"),
        ...
        entries.add(new ModelerCreationToolEntry("Value Pin", "Value Pin", factory, ActivityImageRegistry.getImageDescriptor("INPUTPIN"), ActivityImageRegistry.getImageDescriptor("INPUTPIN_LARGE")));
        ...
        entries.add(new ModelerCreationToolEntry("Input Pin", "Input Pin", factory, ActivityImageRegistry.getImageDescriptor("INPUTPIN"), ActivityImageRegistry.getImageDescriptor("INPUTPIN_LARGE")));
        ...
        entries.add(new ModelerCreationToolEntry("Output Pin", "Output Pin", factory, ActivityImageRegistry.getImageDescriptor("OUTPUTPIN"),
                ActivityImageRegistry.getImageDescriptor("OUTPUTPIN_LARGE")));
    ...
    private void createConnectionsDrawer()
    {
        ...
        factory = new GraphElementCreationFactory(creationUtils, UMLPackage.eINSTANCE.getControlFlow(), "default")
        {
            public EObject getNewModelObject()
            {
                ...
                LiteralBoolean guard = UMLFactory.eINSTANCE.createLiteralBoolean();
                LiteralInteger weight = UMLFactory.eINSTANCE.createLiteralInteger();
                InterruptibleActivityRegion interrupts = UMLFactory.eINSTANCE.createInterruptibleActivityRegion();
                guard.setValue(false);
                weight.setValue(1);
                element.setGuard(guard);
                element.setWeight(weight);
                element.setInterrupts(interrupts);
                return element;
            }
        };
        entries.add(new ModelerConnectionCreationToolEntry("Interruptible Control Flow", "Interruptible Control Flow", factory, ActivityImageRegistry.getImageDescriptor("CONTROLFLOW"),
                ActivityImageRegistry.getImageDescriptor("CONTROLFLOW_LARGE")));
        */
        // EndFix #809
        ...
        entries.add(new ModelerConnectionCreationToolEntry("Interruptible Object Flow", "Interruptible Object Flow", factory, ActivityImageRegistry.getImageDescriptor("OBJECTFLOW"),
                ActivityImageRegistry.getImageDescriptor("OBJECTFLOW_LARGE")));
        */
        // EndFix #809

        factory = new GraphElementCreationFactory(creationUtils, UMLPackage.eINSTANCE.getExceptionHandler(), "default");
        entries.add(new ModelerConnectionCreationToolEntry("Exception Handler", "Exception Handler", factory, ActivityImageRegistry.getImageDescriptor("EXCEPTIONHANDLER"),
                ActivityImageRegistry.getImageDescriptor("EXCEPTIONHANDLER_LARGE")));
...
//        entries.add(new ModelerCreationToolEntry("Comment", "Comment", factory, ActivityImageRegistry.getImageDescriptor("COMMENT"), ActivityImageRegistry.getImageDescriptor("COMMENT_LARGE")));
//
//        factory = new GraphElementCreationFactory(creationUtils, ActivitySimpleObjectConstants.SIMPLE_OBJECT_COMMENTLINK, "default", false);
//        entries.add(new ModelerConnectionCreationToolEntry("Comment Link", "Comment Link", factory, ActivityImageRegistry.getImageDescriptor("COMMENTLINK"),
...
//        entries.add(new ModelerCreationToolEntry("Constraint", "Constraint", factory, ActivityImageRegistry.getImageDescriptor("CONSTRAINT"), ActivityImageRegistry.getImageDescriptor("CONSTRAINT_LARGE")));
//
//        factory = new GraphElementCreationFactory(creationUtils, ActivitySimpleObjectConstants.SIMPLE_OBJECT_CONSTRAINTLINK, "default", false);
//        entries.add(new ModelerConnectionCreationToolEntry("Constraint Link", "Constraint Link", factory, ActivityImageRegistry.getImageDescriptor("CONSTRAINTLINK"),
