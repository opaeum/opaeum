 ...
 * @generated
 */
public class StereotypeFigure extends org.topcased.draw2d.figures.ClassFigure
{
    /**
    ...
    {
        return new ComposedLabel(new Label("<<stereotype>>"), new EditableLabel(), new Label(), false);
    }
