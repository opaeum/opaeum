 ...
 */
public class IntervalConstraintComposite extends Composite
{
    private IntervalConstraint modelObject;
     ...
     * @param editingDomain
     */
    public IntervalConstraintComposite(TabbedPropertySheetWidgetFactory widgetFactory, Composite parent, final IntervalConstraint modelObj, int style, final EditingDomain editingDomain)
    {
        super(parent, style);
