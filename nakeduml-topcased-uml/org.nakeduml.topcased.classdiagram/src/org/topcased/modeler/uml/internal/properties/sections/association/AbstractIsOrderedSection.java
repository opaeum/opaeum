...
/**
 * The section for the isOrdered property of a Property associated with an Association Object.
 * 
 * Creation 10 avr. 2006
 * 
 * @author jlescot
 */
public abstract class AbstractIsOrderedSection extends MultiplicityElementIsOrderedSection
{
    /**
    ...
    {
        return getProperty((Association) getEObject()).isOrdered();
    }
