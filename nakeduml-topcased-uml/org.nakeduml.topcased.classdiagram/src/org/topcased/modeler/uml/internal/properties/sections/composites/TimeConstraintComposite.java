 ...
 */
public class TimeConstraintComposite extends Composite
{
    private TimeConstraint modelObject;
     ...
     * @param editingDomain
     */
    public TimeConstraintComposite(TabbedPropertySheetWidgetFactory widgetFactory, Composite parent, final TimeConstraint modelObj, int style, final EditingDomain editingDomain)
    {
        super(parent, style);
