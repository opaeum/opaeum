...
public class AssociationEdgeObjectUVEditPolicy extends EdgeObjectUVEditPolicy
{
    ...
    protected boolean isEnd(IEdgeObjectFigure figure)
    {
        ...
        //Fix #1780
        if (figure == associationFigure.getSrcPropertiesEdgeObjectFigure())
        {
            return false;
        }
        if (figure == associationFigure.getTargetPropertiesEdgeObjectFigure())
        {
            return false;
        }
        //EndFix #1780
    ...
    protected Command getMoveEdgeObjectCommand(MoveEdgeObjectRequest request)
    {
          ...
          if (ClassEdgeObjectConstants.SRCPROPERTIES_EDGE_OBJECT_ID.equals(edgeObject.getId()) || 
              ClassEdgeObjectConstants.TARGETPROPERTIES_EDGE_OBJECT_ID.equals(edgeObject.getId()))
          {
              return null;
          }
          //EndFix #1780
