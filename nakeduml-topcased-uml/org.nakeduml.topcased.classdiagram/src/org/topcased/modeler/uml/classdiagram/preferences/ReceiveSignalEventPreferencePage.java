 ...
 * @generated
 */
public class ReceiveSignalEventPreferencePage extends
	...
	protected String getNodeBackgroundColor() {
		return ClassDiagramPreferenceConstants.RECEIVESIGNALEVENT_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ClassDiagramPreferenceConstants.RECEIVESIGNALEVENT_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ClassDiagramPreferenceConstants.RECEIVESIGNALEVENT_DEFAULT_FOREGROUND_COLOR;
	}
