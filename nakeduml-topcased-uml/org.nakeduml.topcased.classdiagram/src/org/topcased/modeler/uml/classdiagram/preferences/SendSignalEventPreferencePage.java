 ...
 * @generated
 */
public class SendSignalEventPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return ClassDiagramPreferenceConstants.SENDSIGNALEVENT_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ClassDiagramPreferenceConstants.SENDSIGNALEVENT_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ClassDiagramPreferenceConstants.SENDSIGNALEVENT_DEFAULT_FOREGROUND_COLOR;
	}
