...
public class GeneralizationEditPart extends EMFGraphEdgeEditPart
{
    ...
    {
        return getPreferenceStore().getString(ClassDiagramPreferenceConstants.GENERALIZATION_EDGE_DEFAULT_ROUTER);
    }
    ...
    {
        String preferenceForeground = getPreferenceStore().getString(ClassDiagramPreferenceConstants.GENERALIZATION_EDGE_DEFAULT_FOREGROUND_COLOR);
    ...
    {
        String preferenceFont = getPreferenceStore().getString(ClassDiagramPreferenceConstants.GENERALIZATION_EDGE_DEFAULT_FONT);
