...
import org.topcased.modeler.uml.classdiagram.commands.EnumerationRestoreConnectionCommand;
import org.topcased.modeler.uml.classdiagram.figures.EnumerationFigure;
import org.topcased.modeler.uml.classdiagram.policies.EnumerationLayoutEditPolicy;
import org.topcased.modeler.uml.classdiagram.preferences.ClassDiagramPreferenceConstants;
import org.topcased.modeler.utils.Utils;

/**
 * The Enumeration object controller <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class EnumerationEditPart extends ClassifierEditPart
{
    ...
    /**
     * Set the name of the enumeration, with the stereotype and the "from"
     * 
    ...
    {
        EnumerationFigure fig = (EnumerationFigure) getFigure();
        ComposedLabel lbl = (ComposedLabel) fig.getLabel();
        Enumeration enumeration = (Enumeration) Utils.getElement(getGraphNode());

        String stereotype = UMLLabel.getStereotypesNotation(enumeration, getPreferenceStore());

        lbl.setPrefix(stereotype + "<<enumeration>>");

        if (enumeration.getName() != null)
        {
            lbl.setMain(enumeration.getName());
        }

        lbl.setSuffix(UMLTools.getFromPackageNotation(enumeration, (Element) Utils.getElement((GraphElement) getParent().getModel())));
    }
    ...
    protected void refreshTextAndFont()
    {
        ...
        // The name of an Enumeration is displayed using a bold Font. When the Enumeration is abstract, it is Italic
        // too.
    ...
    {
        String backgroundColor = getPreferenceStore().getString(ClassDiagramPreferenceConstants.ENUMERATION_DEFAULT_BACKGROUND_COLOR);
    ...
    {
        String foregroundColor = getPreferenceStore().getString(ClassDiagramPreferenceConstants.ENUMERATION_DEFAULT_FOREGROUND_COLOR);
    ...
    {
        String preferenceFont = getPreferenceStore().getString(ClassDiagramPreferenceConstants.ENUMERATION_DEFAULT_FONT);
