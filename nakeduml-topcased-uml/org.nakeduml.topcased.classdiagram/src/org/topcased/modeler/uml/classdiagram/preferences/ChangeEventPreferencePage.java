 ...
 * @generated
 */
public class ChangeEventPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return ClassDiagramPreferenceConstants.CHANGEEVENT_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ClassDiagramPreferenceConstants.CHANGEEVENT_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ClassDiagramPreferenceConstants.CHANGEEVENT_DEFAULT_FOREGROUND_COLOR;
	}
