 ...
 * @generated
 */
public class ReceiveOperationEventPreferencePage extends
	...
	protected String getNodeBackgroundColor() {
		return ClassDiagramPreferenceConstants.RECEIVEOPERATIONEVENT_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ClassDiagramPreferenceConstants.RECEIVEOPERATIONEVENT_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ClassDiagramPreferenceConstants.RECEIVEOPERATIONEVENT_DEFAULT_FOREGROUND_COLOR;
	}
