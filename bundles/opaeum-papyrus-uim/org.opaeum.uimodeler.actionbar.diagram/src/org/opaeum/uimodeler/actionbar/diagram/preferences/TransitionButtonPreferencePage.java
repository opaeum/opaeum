 ...
 * @generated
 */
public class TransitionButtonPreferencePage extends AbstractPapyrusNodePreferencePage{
	/**
	 * @generated
	 */
	public TransitionButtonPreferencePage(){
		super();
		setPreferenceKey(AbstractEditorEditPart.MODEL_ID + "_TransitionButton");
	}
	/**
	 * @generated
	 */
	...
	public static void initDefaults(IPreferenceStore store){
		String key = AbstractEditorEditPart.MODEL_ID + "_TransitionButton";
