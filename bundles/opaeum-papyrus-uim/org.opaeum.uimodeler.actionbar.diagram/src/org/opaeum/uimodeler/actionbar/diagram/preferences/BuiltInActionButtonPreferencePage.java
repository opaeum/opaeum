 ...
 * @generated
 */
public class BuiltInActionButtonPreferencePage extends AbstractPapyrusNodePreferencePage{
	/**
	 * @generated
	 */
	public BuiltInActionButtonPreferencePage(){
		super();
		setPreferenceKey(AbstractEditorEditPart.MODEL_ID + "_BuiltInActionButton");
	}
	/**
	 * @generated
	 */
	...
	public static void initDefaults(IPreferenceStore store){
		String key = AbstractEditorEditPart.MODEL_ID + "_BuiltInActionButton";
