...
public class UimNavigatorLabelProvider extends LabelProvider implements ICommonLabelProvider,ITreePathLabelProvider{
	...
	public Image getImage(View view){
		...
		case AbstractEditorEditPart.VISUAL_ID:
			return getImage("Navigator?Diagram?http://opaeum.org/uimetamodel/editor/1.0?AbstractEditor", UimElementTypes.AbstractEditor_1000); //$NON-NLS-1$
		case ActionBarEditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?http://opaeum.org/uimetamodel/editor/1.0?ActionBar", UimElementTypes.ActionBar_2011); //$NON-NLS-1$
		...
		case InvocationButtonEditPart.VISUAL_ID:
			return getImage("Navigator?Node?http://opaeum.org/uimetamodel/action/1.0?InvocationButton", UimElementTypes.InvocationButton_3003); //$NON-NLS-1$
	...
	public String getText(View view){
		...
		case ActionBarEditPart.VISUAL_ID:
			return getActionBar_2011Text(view);
		case BuiltInLinkEditPart.VISUAL_ID:
			return getBuiltInLink_3001Text(view);
		case LinkToQueryEditPart.VISUAL_ID:
			return getLinkToQuery_3002Text(view);
		case InvocationButtonEditPart.VISUAL_ID:
			return getInvocationButton_3003Text(view);
		case BuiltInActionButtonEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	private String getActionBar_2011Text(View view){
		IParser parser = UimParserProvider.getParser(UimElementTypes.ActionBar_2011,
				view.getElement() != null ? view.getElement() : view, UimVisualIDRegistry.getType(ActionBarNameEditPart.VISUAL_ID));
		if(parser != null){
	 ...
	 * @generated
	 */
	private String getInvocationButton_3003Text(View view){
		IParser parser = UimParserProvider.getParser(UimElementTypes.InvocationButton_3003,
