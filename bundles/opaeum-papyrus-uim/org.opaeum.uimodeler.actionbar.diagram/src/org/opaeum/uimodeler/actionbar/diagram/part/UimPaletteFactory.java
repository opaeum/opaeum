...
public class UimPaletteFactory extends PaletteFactory.Adapter{
	 ...
	 * @generated
	 */
	private final static String CREATEEDITORACTIONBAR1CREATIONTOOL = "createActionBar1CreationTool"; //$NON-NLS-1$
	/**
	 * @generated
	 */
	...
	public Tool createTool(String toolId){
		if(toolId.equals(CREATEEDITORACTIONBAR1CREATIONTOOL)){
			return createActionBar1CreationTool();
		}
	 ...
	 * @generated
	 */
	private Tool createActionBar1CreationTool(){
		List<IElementType> types = new ArrayList<IElementType>(1);
		types.add(UimElementTypes.ActionBar_2011);
	...
	private Tool createOperationCallButton3CreationTool(){
		List<IElementType> types = new ArrayList<IElementType>(1);
		types.add(UimElementTypes.InvocationButton_3003);
		Tool tool = new AspectUnspecifiedTypeCreationTool(types);
		return tool;
	}
	/**
