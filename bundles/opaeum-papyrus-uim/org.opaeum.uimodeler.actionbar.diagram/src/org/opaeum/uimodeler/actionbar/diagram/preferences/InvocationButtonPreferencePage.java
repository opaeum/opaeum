 ...
 * @generated
 */
public class InvocationButtonPreferencePage extends AbstractPapyrusNodePreferencePage{
	/**
	 * @generated
	 */
	public InvocationButtonPreferencePage(){
		super();
		setPreferenceKey(AbstractEditorEditPart.MODEL_ID + "_InvocationButton");
	}
	/**
	 * @generated
	 */
	...
	public static void initDefaults(IPreferenceStore store){
		String key = AbstractEditorEditPart.MODEL_ID + "_InvocationButton";
