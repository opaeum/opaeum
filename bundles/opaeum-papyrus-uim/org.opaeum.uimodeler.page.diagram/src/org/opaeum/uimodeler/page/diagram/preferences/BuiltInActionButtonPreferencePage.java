 ...
 * @generated
 */
public class BuiltInActionButtonPreferencePage extends
	...
	public BuiltInActionButtonPreferencePage() {
		super();
		setPreferenceKey(PageEditPart.MODEL_ID + "_BuiltInActionButton");
	}
	...
	public static void initDefaults(IPreferenceStore store) {
		...
		String key = PageEditPart.MODEL_ID + "_BuiltInActionButton";
