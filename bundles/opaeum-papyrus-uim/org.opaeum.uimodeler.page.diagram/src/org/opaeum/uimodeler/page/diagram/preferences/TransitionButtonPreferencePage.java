 ...
 * @generated
 */
public class TransitionButtonPreferencePage extends
	...
	public TransitionButtonPreferencePage() {
		super();
		setPreferenceKey(PageEditPart.MODEL_ID + "_TransitionButton");
	}
	...
	public static void initDefaults(IPreferenceStore store) {
		...
		String key = PageEditPart.MODEL_ID + "_TransitionButton";
