...
import org.opaeum.uimodeler.page.diagram.edit.commands.GridPanelCreateCommand;
import org.opaeum.uimodeler.page.diagram.edit.commands.HorizontalPanelCreateCommand;
import org.opaeum.uimodeler.page.diagram.edit.commands.VerticalPanelCreateCommand;
import org.opaeum.uimodeler.page.diagram.providers.UimElementTypes;

/**
 * @generated
 */
public class PageItemSemanticEditPolicy extends UimBaseItemSemanticEditPolicy {
	/**
	 * @generated
	 */
	public PageItemSemanticEditPolicy() {
		super(UimElementTypes.Page_1000);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if (UimElementTypes.GridPanel_2001 == baseElementType) {
			if (isExtendedType) {
		...
		if (UimElementTypes.HorizontalPanel_2002 == baseElementType) {
			if (isExtendedType) {
				return getExtendedTypeCreationCommand(req,
						(IExtendedHintedElementType) requestElementType);
			}
		...
		if (UimElementTypes.VerticalPanel_2003 == baseElementType) {
			if (isExtendedType) {
				return getExtendedTypeCreationCommand(req,
						(IExtendedHintedElementType) requestElementType);
			}
