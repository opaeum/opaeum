 ...
 * @generated
 */
public class UimDataTablePreferencePage extends AbstractPapyrusNodePreferencePage{
	/**
	 * @generated
	 */
	public static final String compartments[] = {"DataTableColumnCompartment","TableTableActionBarCompartment"};
	/**
	 * @generated
	 */
	public UimDataTablePreferencePage(){
		super();
		setPreferenceKey(UserInterfaceEditPart.MODEL_ID + "_UimDataTable");
	}
	/**
	 * @generated
	 */
	...
	public static void initDefaults(IPreferenceStore store){
		String key = UserInterfaceEditPart.MODEL_ID + "_UimDataTable";
