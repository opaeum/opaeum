 ...
 * @generated
 */
public class GridPanelGridPanelChildrenCompartment2CanonicalEditPolicy extends
		CanonicalEditPolicy {
	/**
	 * @generated
	 */
	...
	protected List getSemanticChildrenList() {
		...
		List<UimNodeDescriptor> childDescriptors = UimDiagramUpdater
				.getGridPanelGridPanelChildrenCompartment_7008SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UimNodeDescriptor> childDescriptors = UimDiagramUpdater
				.getGridPanelGridPanelChildrenCompartment_7008SemanticChildren((View) getHost()
						.getModel());
