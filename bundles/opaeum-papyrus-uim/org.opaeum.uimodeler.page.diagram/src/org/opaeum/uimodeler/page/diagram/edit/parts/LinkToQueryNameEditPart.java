 ...
 * @generated
 */
public class LinkToQueryNameEditPart extends PapyrusCompartmentEditPart
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UimParserProvider
					.getParser(
							UimElementTypes.LinkToQuery_3034,
							getParserElement(),
							UimVisualIDRegistry
									.getType(org.opaeum.uimodeler.page.diagram.edit.parts.LinkToQueryNameEditPart.VISUAL_ID));
		}
		return parser;
	}
