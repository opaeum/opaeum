...
public class UimDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							Messages.UimDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS.bind(
									Messages.UimDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
									fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = UimDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		progressMonitor.beginTask(
				Messages.UimDiagramEditorUtil_CreateDiagramProgressTask, 3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				editingDomain,
				Messages.UimDiagramEditorUtil_CreateDiagramCommandLabel,
			...
			protected CommandResult doExecuteWithResult(
				...
				try {
					modelResource
							.save(org.opaeum.uimodeler.page.diagram.part.UimDiagramEditorUtil
									.getSaveOptions());
					diagramResource
							.save(org.opaeum.uimodeler.page.diagram.part.UimDiagramEditorUtil
									.getSaveOptions());
