 ...
 * @generated
 */
public class UimInitDiagramFileAction implements IWorkbenchWindowActionDelegate {
	/**
	 * @generated
	 */
	...
	public void run(IAction action) {
		TransactionalEditingDomain editingDomain = GMFEditingDomainFactory.INSTANCE
				.createEditingDomain();
		Resource resource = UimDiagramEditorUtil.openModel(getShell(),
		...
		Wizard wizard = new UimNewDiagramFileWizard(resource.getURI(),
