 ...
 * @generated
 */
public class InvocationButtonPreferencePage extends
	...
	public InvocationButtonPreferencePage() {
		super();
		setPreferenceKey(PageEditPart.MODEL_ID + "_InvocationButton");
	}
	...
	public static void initDefaults(IPreferenceStore store) {
		...
		String key = PageEditPart.MODEL_ID + "_InvocationButton";
