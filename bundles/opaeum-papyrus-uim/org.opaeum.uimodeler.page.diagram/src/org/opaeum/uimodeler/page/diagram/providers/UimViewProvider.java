...
public class UimViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateViewForKindOperation op) {
		...
		if (Node.class.isAssignableFrom(op.getViewKind())) {
			return UimVisualIDRegistry.canCreateNode(op.getContainerView(),
					visualID);
		}
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return PageEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& UimVisualIDRegistry.getDiagramVisualID(getSemanticElement(op
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = UimVisualIDRegistry.getNodeVisualID(
			...
			if (elementType != null) {
				if (elementType instanceof IExtendedHintedElementType) {
					...
					if (!UimElementTypes.isKnownElementType(elementType)
				...
				if (!PageEditPart.MODEL_ID.equals(UimVisualIDRegistry
		...
		return GridPanelEditPart.VISUAL_ID == visualID
				|| HorizontalPanelEditPart.VISUAL_ID == visualID
				|| VerticalPanelEditPart.VISUAL_ID == visualID
				|| UimFieldEditPart.VISUAL_ID == visualID
				|| BuiltInActionButtonEditPart.VISUAL_ID == visualID
				|| HorizontalPanel2EditPart.VISUAL_ID == visualID
				|| VerticalPanel2EditPart.VISUAL_ID == visualID
				|| TransitionButtonEditPart.VISUAL_ID == visualID
				|| InvocationButtonEditPart.VISUAL_ID == visualID
				|| LinkToQueryEditPart.VISUAL_ID == visualID
				|| BuiltInLinkEditPart.VISUAL_ID == visualID
				|| UimDataTableEditPart.VISUAL_ID == visualID
				|| UimField2EditPart.VISUAL_ID == visualID
				|| BuiltInActionButton2EditPart.VISUAL_ID == visualID
				|| InvocationButton2EditPart.VISUAL_ID == visualID
				|| BuiltInActionButton3EditPart.VISUAL_ID == visualID
				|| InvocationButton3EditPart.VISUAL_ID == visualID
				|| BuiltInLink2EditPart.VISUAL_ID == visualID
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		if (elementType instanceof IExtendedHintedElementType) {
			IElementType closestNonExtendedType = ElementTypeUtils
					.getClosestDiagramType(elementType);
			if (!UimElementTypes.isKnownElementType(closestNonExtendedType)
					|| (!(closestNonExtendedType instanceof IHintedType))) {
				return false; // foreign element type.
			}
		} else {
		...
		//if (!org.opaeum.uimodeler.page.diagram.providers.UimElementTypes.isKnownElementType(elementType) || (!(elementType instanceof org.eclipse.gmf.runtime.emf.type.core.IHintedType))) {
		//	return false; // foreign element type
		//}
		// END R.S.
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = UimVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
		...
		switch (visualID) {
		case GridPanelEditPart.VISUAL_ID:
			return createGridPanel_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case HorizontalPanelEditPart.VISUAL_ID:
			return createHorizontalPanel_2002(domainElement, containerView,
					index, persisted, preferencesHint);
		case VerticalPanelEditPart.VISUAL_ID:
			return createVerticalPanel_2003(domainElement, containerView,
					index, persisted, preferencesHint);
		case UimFieldEditPart.VISUAL_ID:
			return createUimField_3028(domainElement, containerView, index,
					persisted, preferencesHint);
		case BuiltInActionButtonEditPart.VISUAL_ID:
			return createBuiltInActionButton_3029(domainElement, containerView,
					index, persisted, preferencesHint);
		case HorizontalPanel2EditPart.VISUAL_ID:
			return createHorizontalPanel_3030(domainElement, containerView,
					index, persisted, preferencesHint);
		case VerticalPanel2EditPart.VISUAL_ID:
			return createVerticalPanel_3031(domainElement, containerView,
					index, persisted, preferencesHint);
		case TransitionButtonEditPart.VISUAL_ID:
			return createTransitionButton_3032(domainElement, containerView,
					index, persisted, preferencesHint);
		case InvocationButtonEditPart.VISUAL_ID:
			return createInvocationButton_3033(domainElement, containerView,
					index, persisted, preferencesHint);
		case LinkToQueryEditPart.VISUAL_ID:
			return createLinkToQuery_3034(domainElement, containerView, index,
					persisted, preferencesHint);
		case BuiltInLinkEditPart.VISUAL_ID:
			return createBuiltInLink_3035(domainElement, containerView, index,
					persisted, preferencesHint);
		case UimDataTableEditPart.VISUAL_ID:
			return createUimDataTable_3036(domainElement, containerView, index,
					persisted, preferencesHint);
		case UimField2EditPart.VISUAL_ID:
			return createUimField_3037(domainElement, containerView, index,
					persisted, preferencesHint);
		case BuiltInActionButton2EditPart.VISUAL_ID:
			return createBuiltInActionButton_3038(domainElement, containerView,
					index, persisted, preferencesHint);
		case InvocationButton2EditPart.VISUAL_ID:
			return createInvocationButton_3039(domainElement, containerView,
					index, persisted, preferencesHint);
		case BuiltInActionButton3EditPart.VISUAL_ID:
			return createBuiltInActionButton_3040(domainElement, containerView,
					index, persisted, preferencesHint);
		case InvocationButton3EditPart.VISUAL_ID:
			return createInvocationButton_3041(domainElement, containerView,
					index, persisted, preferencesHint);
		case BuiltInLink2EditPart.VISUAL_ID:
			return createBuiltInLink_3042(domainElement, containerView, index,
					persisted, preferencesHint);
		case GridPanel2EditPart.VISUAL_ID:
			return createGridPanel_3043(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createGridPanel_2001(EObject domainElement, View containerView,
		...
		createCompartment(
				node,
				UimVisualIDRegistry
						.getType(GridPanelGridPanelChildrenCompartmentEditPart.VISUAL_ID),
				false, false, false, false);

		PreferenceInitializerForElementHelper.initCompartmentsStatusFromPrefs(
				node, prefStore, "GridPanel");
	 ...
	 * @generated
	 */
	public Node createHorizontalPanel_2002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(UimVisualIDRegistry
				.getType(HorizontalPanelEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createVerticalPanel_2003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(UimVisualIDRegistry
				.getType(VerticalPanelEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createUimField_3028(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createBuiltInActionButton_3029(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(UimVisualIDRegistry
				.getType(BuiltInActionButtonEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createHorizontalPanel_3030(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(UimVisualIDRegistry
				.getType(HorizontalPanel2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createVerticalPanel_3031(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(UimVisualIDRegistry
				.getType(VerticalPanel2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createTransitionButton_3032(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(UimVisualIDRegistry
				.getType(TransitionButtonEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label5020 = createLabel(node,
				UimVisualIDRegistry
						.getType(TransitionButtonNameEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createInvocationButton_3033(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(UimVisualIDRegistry
				.getType(InvocationButtonEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createLinkToQuery_3034(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createBuiltInLink_3035(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createUimDataTable_3036(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(UimVisualIDRegistry
				.getType(UimDataTableEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		createCompartment(
				node,
				UimVisualIDRegistry
						.getType(UimDataTableDataTableColumnCompartmentEditPart.VISUAL_ID),
				false, false, false, false);
		createCompartment(
				node,
				UimVisualIDRegistry
						.getType(UimDataTableTableTableActionBarCompartmentEditPart.VISUAL_ID),
				false, false, false, false);

		PreferenceInitializerForElementHelper.initCompartmentsStatusFromPrefs(
				node, prefStore, "UimDataTable");
	 ...
	 * @generated
	 */
	public Node createUimField_3037(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createBuiltInActionButton_3038(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(UimVisualIDRegistry
				.getType(BuiltInActionButton2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createInvocationButton_3039(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(UimVisualIDRegistry
				.getType(InvocationButton2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createBuiltInActionButton_3040(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(UimVisualIDRegistry
				.getType(BuiltInActionButton3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createInvocationButton_3041(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(UimVisualIDRegistry
				.getType(InvocationButton3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label5024 = createLabel(node,
				UimVisualIDRegistry
						.getType(InvocationButtonName2EditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createBuiltInLink_3042(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(UimVisualIDRegistry
				.getType(BuiltInLink2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createGridPanel_3043(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		...
		createCompartment(
				node,
				UimVisualIDRegistry
						.getType(GridPanelGridPanelChildrenCompartment2EditPart.VISUAL_ID),
				false, false, false, false);
