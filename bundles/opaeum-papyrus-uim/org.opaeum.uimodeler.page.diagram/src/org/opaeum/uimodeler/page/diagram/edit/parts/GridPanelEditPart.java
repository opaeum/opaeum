...
public class GridPanelEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new GridPanelItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof GridPanelNameEditPart) {
			((GridPanelNameEditPart) childEditPart).setLabel(getPrimaryShape()
	...
	protected NodeFigure createNodeFigure() {
		...
		NodeFigure figure = new HackedDefaultSizeNodeFigure(shape);
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UimVisualIDRegistry
				.getType(GridPanelNameEditPart.VISUAL_ID));
	}
