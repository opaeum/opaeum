...
public class TransitionButtonEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new TransitionButtonItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new CustomTransitionActionFigure(
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TransitionButtonNameEditPart) {
			((TransitionButtonNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureTransitionActionNameFigure());
			return true;
		}
		return false;
	}
		...
		if (feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()
			...
			if (feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()) {
				prefColor = PreferenceConstantHelper
						.getElementConstant("TransitionButton",
