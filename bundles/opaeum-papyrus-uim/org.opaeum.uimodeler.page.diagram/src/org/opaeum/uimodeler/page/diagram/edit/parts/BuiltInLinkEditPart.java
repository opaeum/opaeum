...
import org.opaeum.uimodeler.page.diagram.edit.policies.BuiltInLinkItemSemanticEditPolicy;
 ...
 * @generated
 */
public class BuiltInLinkEditPart extends ShapeNodeEditPart {
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public BuiltInLinkEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new BuiltInLinkItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new CustomBuiltInLinkFigure(
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof BuiltInLinkNameEditPart) {
			((BuiltInLinkNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureBuiltInLinkNameFigure());
			return true;
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UimVisualIDRegistry
				.getType(BuiltInLinkNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class BuiltInLinkFigure extends RectangleFigure {
		/**
		 * @generated
		 */
		...
		if (feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()
			...
			if (feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()) {
				prefColor = PreferenceConstantHelper.getElementConstant(
						"BuiltInLink", PreferenceConstantHelper.COLOR_LINE);
			} else if (feature == NotationPackage.eINSTANCE
					.getFontStyle_FontColor()) {
				prefColor = PreferenceConstantHelper.getElementConstant(
						"BuiltInLink", PreferenceConstantHelper.COLOR_FONT);
			} else if (feature == NotationPackage.eINSTANCE
					.getFillStyle_FillColor()) {
				prefColor = PreferenceConstantHelper.getElementConstant(
						"BuiltInLink", PreferenceConstantHelper.COLOR_FILL);
			}
			...
			String prefGradient = PreferenceConstantHelper.getElementConstant(
					"BuiltInLink", PreferenceConstantHelper.COLOR_GRADIENT);
