 ...
 * @generated
 */
public class GridPanelGridPanelChildrenCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	/**
	 * @generated
	 */
	...
	protected List getSemanticChildrenList() {
		...
		List<UimNodeDescriptor> childDescriptors = UimDiagramUpdater
				.getGridPanelGridPanelChildrenCompartment_7001SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UimNodeDescriptor> childDescriptors = UimDiagramUpdater
				.getGridPanelGridPanelChildrenCompartment_7001SemanticChildren((View) getHost()
						.getModel());
