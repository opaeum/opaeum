 ...
 * @generated
 */
public class HorizontalPanelPreferencePage extends
	...
	public HorizontalPanelPreferencePage() {
		super();
		setPreferenceKey(PageEditPart.MODEL_ID + "_HorizontalPanel");
	}
	...
	public static void initDefaults(IPreferenceStore store) {
		...
		String key = PageEditPart.MODEL_ID + "_HorizontalPanel";
