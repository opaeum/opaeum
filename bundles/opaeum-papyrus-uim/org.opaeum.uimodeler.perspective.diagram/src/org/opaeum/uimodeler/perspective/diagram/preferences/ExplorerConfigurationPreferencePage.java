...
public class ExplorerConfigurationPreferencePage extends AbstractPapyrusNodePreferencePage{
	...
	public ExplorerConfigurationPreferencePage(){
		super();
		setPreferenceKey(PerspectiveConfigurationEditPart.MODEL_ID + "_ExplorerConfiguration");
	}
	/**
	 * @generated
	 */
	...
	public static void initDefaults(IPreferenceStore store){
		String key = PerspectiveConfigurationEditPart.MODEL_ID + "_ExplorerConfiguration";
