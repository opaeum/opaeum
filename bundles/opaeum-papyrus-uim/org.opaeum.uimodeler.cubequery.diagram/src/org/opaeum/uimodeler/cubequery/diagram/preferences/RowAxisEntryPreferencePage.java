 ...
 * @generated
 */
public class RowAxisEntryPreferencePage extends AbstractPapyrusNodePreferencePage{
	/**
	 * @generated
	 */
	public RowAxisEntryPreferencePage(){
		super();
		setPreferenceKey(CubeQueryEditPart.MODEL_ID + "_RowAxisEntry");
	}
	/**
	 * @generated
	 */
	...
	public static void initDefaults(IPreferenceStore store){
		String key = CubeQueryEditPart.MODEL_ID + "_RowAxisEntry";
