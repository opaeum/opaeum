 ...
 * @generated
 */
public class UimInitDiagramFileAction implements IObjectActionDelegate{
	/**
	 * @generated
	 */
	...
	public void run(IAction action){
		...
		try{
			...
			UimCubeQueryDiagramEditorPlugin.getInstance().logError("Unable to load resource: " + domainModelURI, ex); //$NON-NLS-1$
		}
		if(diagramRoot == null){
		...
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle, CubeQueryEditPart.MODEL_ID));
