...
public class UimCreationWizard extends Wizard implements INewWizard{
	 ...
	 * @generated
	 */
	protected UimCreationWizardPage diagramModelFilePage;
	/**
	 * @generated
	 */
	protected UimCreationWizardPage domainModelFilePage;
	/**
	 * @generated
	 */
	...
	public void init(IWorkbench workbench,IStructuredSelection selection){
		...
		setDefaultPageImageDescriptor(UimCubeQueryDiagramEditorPlugin.getBundledImageDescriptor("icons/wizban/NewCubeWizard.gif")); //$NON-NLS-1$
	...
	public boolean performFinish(){
		...
		try{
			...
			if(e.getTargetException() instanceof CoreException){
				...
				UimCubeQueryDiagramEditorPlugin.getInstance().logError("Error creating diagram", e.getTargetException()); //$NON-NLS-1$
			}
			return false;
		}
		return diagram != null;
