...
/**
 * This is the action bar contributor for the Cube model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CubeActionBarContributor
	extends EditingDomainActionBarContributor
	implements ISelectionChangedListener {
	/**
	 * Action to create objects from the Cube model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static class NewAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			CubeModelWizard wizard = new CubeModelWizard();
	 ...
	 * @generated
	 */
	public CubeActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("cube-settings"));
		toolBarManager.add(new Separator("cube-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(UimEditorPlugin.INSTANCE.getString("_UI_CubeEditor_menu"), "org.opaeum.uim.cubeMenuID");
