...
/**
 * This is the item provider adapter for a {@link org.opaeum.uim.editor.OperationMenuItem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationMenuItemItemProvider
	 ...
	 * @generated
	 */
	public OperationMenuItemItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addHiddenPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OperationMenuItem_hidden_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OperationMenuItem_hidden_feature", "_UI_OperationMenuItem_type"),
				 EditorPackage.Literals.OPERATION_MENU_ITEM__HIDDEN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	/**
	 * This returns OperationMenuItem.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OperationMenuItem"));
	}
	...
	public String getText(Object object) {
		String label = ((OperationMenuItem)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_OperationMenuItem_type") :
			getString("_UI_OperationMenuItem_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OperationMenuItem.class)) {
