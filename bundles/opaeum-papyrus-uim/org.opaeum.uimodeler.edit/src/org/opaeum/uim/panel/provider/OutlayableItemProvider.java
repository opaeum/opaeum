...
/**
 * This is the item provider adapter for a {@link org.opaeum.uim.panel.Outlayable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OutlayableItemProvider
	 ...
	 * @generated
	 */
	public OutlayableItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Outlayable"));
	}
	...
	public String getText(Object object) {
		Integer labelValue = ((Outlayable)object).getPreferredWidth();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_Outlayable_type") :
			getString("_UI_Outlayable_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Outlayable.class)) {
