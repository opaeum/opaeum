...
/**
 * This is the item provider adapter for a {@link org.opaeum.uim.action.AbstractActionButton} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractActionButtonItemProvider
	 ...
	 * @generated
	 */
	public AbstractActionButtonItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractActionButton)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractActionButton_type") :
			getString("_UI_AbstractActionButton_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractActionButton.class)) {
