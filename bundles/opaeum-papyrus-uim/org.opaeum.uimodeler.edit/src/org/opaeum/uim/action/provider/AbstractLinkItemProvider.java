...
import org.opaeum.uim.component.provider.UimComponentItemProvider;
import org.opaeum.uim.panel.PanelPackage;
import org.opaeum.uim.provider.UimEditPlugin;

/**
 * This is the item provider adapter for a {@link org.opaeum.uim.action.AbstractLink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractLinkItemProvider
	...
	public String getText(Object object) {
		String label = ((AbstractLink)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractLink_type") :
			getString("_UI_AbstractLink_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractLink.class)) {
