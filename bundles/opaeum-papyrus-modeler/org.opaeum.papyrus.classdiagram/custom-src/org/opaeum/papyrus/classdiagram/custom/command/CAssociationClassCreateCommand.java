package org.opaeum.papyrus.classdiagram.custom.command;
...
import org.opaeum.papyrus.uml.diagram.clazz.customer.helper.AssociationClassHelper;
...
public class CAssociationClassCreateCommand extends org.eclipse.papyrus.uml.diagram.clazz.edit.commands.AssociationClassLinkCreateCommand{
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,IAdaptable info) throws ExecutionException{
		...
		if(source instanceof Type && target instanceof Type && container instanceof Package){
			AssociationClass newElement = (AssociationClass) AssociationClassHelper.createAssociationClass(getEditingDomain(), (Type) source, (Type) target,
					(Package) container);
