...
public class UseCasePaletteFactory extends UMLPaletteFactory{
	...
	public Tool createTool(String toolId){
		if(toolId.equals("usecase.tool.businessactor")){
			...
			Tool tool = new StereotypeApplyingTypeCreationTool(types, StereotypeNames.BUSINESS_ACTOR);
			return tool;
			...
			Tool tool = new StereotypeApplyingTypeCreationTool(types, StereotypeNames.BUSINESS_USE_CASE);
			return tool;
			...
			Tool tool = new StereotypeApplyingTypeCreationTool(types, StereotypeNames.BUSINESS_COMPONENT);
			return tool;
		}
