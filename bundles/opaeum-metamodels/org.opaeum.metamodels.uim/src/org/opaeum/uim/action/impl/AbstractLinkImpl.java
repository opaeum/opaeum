 ...
 * <ul>
 *   <li>{@link org.opaeum.uim.action.impl.AbstractLinkImpl#getPreferredWidth <em>Preferred Width</em>}</li>
 *   <li>{@link org.opaeum.uim.action.impl.AbstractLinkImpl#getPreferredHeight <em>Preferred Height</em>}</li>
 *   <li>{@link org.opaeum.uim.action.impl.AbstractLinkImpl#getFillHorizontally <em>Fill Horizontally</em>}</li>
 *   <li>{@link org.opaeum.uim.action.impl.AbstractLinkImpl#getFillVertically <em>Fill Vertically</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class AbstractLinkImpl extends UimComponentImpl implements AbstractLink {
	/**
	...
	protected EClass eStaticClass() {
		return ActionPackage.Literals.ABSTRACT_LINK;
	}
	...
	public void setPreferredWidth(Integer newPreferredWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionPackage.ABSTRACT_LINK__PREFERRED_WIDTH, oldPreferredWidth, preferredWidth));
	}
	...
	public void setPreferredHeight(Integer newPreferredHeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionPackage.ABSTRACT_LINK__PREFERRED_HEIGHT, oldPreferredHeight, preferredHeight));
	}
	...
	public void setFillHorizontally(Boolean newFillHorizontally) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionPackage.ABSTRACT_LINK__FILL_HORIZONTALLY, oldFillHorizontally, fillHorizontally));
	}
	...
	public void setFillVertically(Boolean newFillVertically) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionPackage.ABSTRACT_LINK__FILL_VERTICALLY, oldFillVertically, fillVertically));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActionPackage.ABSTRACT_LINK__PREFERRED_WIDTH:
				return getPreferredWidth();
			case ActionPackage.ABSTRACT_LINK__PREFERRED_HEIGHT:
				return getPreferredHeight();
			case ActionPackage.ABSTRACT_LINK__FILL_HORIZONTALLY:
				return getFillHorizontally();
			case ActionPackage.ABSTRACT_LINK__FILL_VERTICALLY:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Outlayable.class) {
			switch (derivedFeatureID) {
				case ActionPackage.ABSTRACT_LINK__PREFERRED_WIDTH: return PanelPackage.OUTLAYABLE__PREFERRED_WIDTH;
				case ActionPackage.ABSTRACT_LINK__PREFERRED_HEIGHT: return PanelPackage.OUTLAYABLE__PREFERRED_HEIGHT;
				case ActionPackage.ABSTRACT_LINK__FILL_HORIZONTALLY: return PanelPackage.OUTLAYABLE__FILL_HORIZONTALLY;
				case ActionPackage.ABSTRACT_LINK__FILL_VERTICALLY: return PanelPackage.OUTLAYABLE__FILL_VERTICALLY;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Outlayable.class) {
			switch (baseFeatureID) {
				case PanelPackage.OUTLAYABLE__PREFERRED_WIDTH: return ActionPackage.ABSTRACT_LINK__PREFERRED_WIDTH;
				case PanelPackage.OUTLAYABLE__PREFERRED_HEIGHT: return ActionPackage.ABSTRACT_LINK__PREFERRED_HEIGHT;
				case PanelPackage.OUTLAYABLE__FILL_HORIZONTALLY: return ActionPackage.ABSTRACT_LINK__FILL_HORIZONTALLY;
				case PanelPackage.OUTLAYABLE__FILL_VERTICALLY: return ActionPackage.ABSTRACT_LINK__FILL_VERTICALLY;
				default: return -1;
			}
		}
