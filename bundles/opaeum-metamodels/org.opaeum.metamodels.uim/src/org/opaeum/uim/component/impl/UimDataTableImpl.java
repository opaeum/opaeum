...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Uim Data Table</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 *   <li>{@link org.opaeum.uim.component.impl.UimDataTableImpl#getPreferredHeight <em>Preferred Height</em>}</li>
 *   <li>{@link org.opaeum.uim.component.impl.UimDataTableImpl#getFillHorizontally <em>Fill Horizontally</em>}</li>
...
public class UimDataTableImpl extends MasterComponentImpl implements UimDataTable {
	...
	protected EClass eStaticClass() {
		return ComponentPackage.Literals.UIM_DATA_TABLE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentPackage.UIM_DATA_TABLE__NAME, oldName, name));
	}
	...
	public void setUnderUserControl(boolean newUnderUserControl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentPackage.UIM_DATA_TABLE__UNDER_USER_CONTROL, oldUnderUserControl, underUserControl));
	}
	...
	public NotificationChain basicSetVisibility(UserInteractionConstraint newVisibility, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ComponentPackage.UIM_DATA_TABLE__VISIBILITY, oldVisibility, newVisibility);
	...
	public void setVisibility(UserInteractionConstraint newVisibility) {
		if (newVisibility != visibility) {
			...
			if (visibility != null)
				msgs = ((InternalEObject)visibility).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ComponentPackage.UIM_DATA_TABLE__VISIBILITY, null, msgs);
			if (newVisibility != null)
				msgs = ((InternalEObject)newVisibility).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ComponentPackage.UIM_DATA_TABLE__VISIBILITY, null, msgs);
			msgs = basicSetVisibility(newVisibility, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentPackage.UIM_DATA_TABLE__VISIBILITY, newVisibility, newVisibility));
	}
	...
	public NotificationChain basicSetEditability(UserInteractionConstraint newEditability, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ComponentPackage.UIM_DATA_TABLE__EDITABILITY, oldEditability, newEditability);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEditability(UserInteractionConstraint newEditability) {
		if (newEditability != editability) {
			NotificationChain msgs = null;
			if (editability != null)
				msgs = ((InternalEObject)editability).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ComponentPackage.UIM_DATA_TABLE__EDITABILITY, null, msgs);
			if (newEditability != null)
				msgs = ((InternalEObject)newEditability).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ComponentPackage.UIM_DATA_TABLE__EDITABILITY, null, msgs);
			msgs = basicSetEditability(newEditability, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentPackage.UIM_DATA_TABLE__EDITABILITY, newEditability, newEditability));
	}
	...
	public EList<UimComponent> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<UimComponent>(UimComponent.class, this, ComponentPackage.UIM_DATA_TABLE__CHILDREN);
		}
		return children;
	}
	...
	public void setPreferredWidth(Integer newPreferredWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentPackage.UIM_DATA_TABLE__PREFERRED_WIDTH, oldPreferredWidth, preferredWidth));
	}
	...
	public void setPreferredHeight(Integer newPreferredHeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentPackage.UIM_DATA_TABLE__PREFERRED_HEIGHT, oldPreferredHeight, preferredHeight));
	}
	...
	public void setFillHorizontally(Boolean newFillHorizontally) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentPackage.UIM_DATA_TABLE__FILL_HORIZONTALLY, oldFillHorizontally, fillHorizontally));
	}
	...
	public void setFillVertically(Boolean newFillVertically) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentPackage.UIM_DATA_TABLE__FILL_VERTICALLY, oldFillVertically, fillVertically));
	}
	...
	public NotificationChain basicSetBinding(TableBinding newBinding, NotificationChain msgs) {
		...
		binding = newBinding;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ComponentPackage.UIM_DATA_TABLE__BINDING, oldBinding, newBinding);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setBinding(TableBinding newBinding) {
		if (newBinding != binding) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentPackage.UIM_DATA_TABLE__BINDING, newBinding, newBinding));
	}
	 ...
	 * @generated
	 */
	public EList<AbstractActionButton> getActionsOnMultipleSelection() {
		if (actionsOnMultipleSelection == null) {
			actionsOnMultipleSelection = new EObjectContainmentEList<AbstractActionButton>(AbstractActionButton.class, this, ComponentPackage.UIM_DATA_TABLE__ACTIONS_ON_MULTIPLE_SELECTION);
		}
	...
	public NotificationChain basicSetLabelOverride(Labels newLabelOverride, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ComponentPackage.UIM_DATA_TABLE__LABEL_OVERRIDE, oldLabelOverride, newLabelOverride);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLabelOverride(Labels newLabelOverride) {
		if (newLabelOverride != labelOverride) {
			...
			if (labelOverride != null)
				msgs = ((InternalEObject)labelOverride).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ComponentPackage.UIM_DATA_TABLE__LABEL_OVERRIDE, null, msgs);
			if (newLabelOverride != null)
				msgs = ((InternalEObject)newLabelOverride).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ComponentPackage.UIM_DATA_TABLE__LABEL_OVERRIDE, null, msgs);
			msgs = basicSetLabelOverride(newLabelOverride, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentPackage.UIM_DATA_TABLE__LABEL_OVERRIDE, newLabelOverride, newLabelOverride));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ComponentPackage.UIM_DATA_TABLE__BINDING:
				if (binding != null)
					msgs = ((InternalEObject)binding).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ComponentPackage.UIM_DATA_TABLE__BINDING, null, msgs);
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == UserInteractionElement.class) {
			switch (derivedFeatureID) {
				case ComponentPackage.UIM_DATA_TABLE__NAME: return UimPackage.USER_INTERACTION_ELEMENT__NAME;
				case ComponentPackage.UIM_DATA_TABLE__UNDER_USER_CONTROL: return UimPackage.USER_INTERACTION_ELEMENT__UNDER_USER_CONTROL;
				default: return -1;
			}
		}
		...
		if (baseClass == EditableConstrainedObject.class) {
			switch (derivedFeatureID) {
				case ComponentPackage.UIM_DATA_TABLE__EDITABILITY: return ConstraintPackage.EDITABLE_CONSTRAINED_OBJECT__EDITABILITY;
				default: return -1;
			}
		}
		if (baseClass == UimContainer.class) {
			switch (derivedFeatureID) {
				case ComponentPackage.UIM_DATA_TABLE__CHILDREN: return ComponentPackage.UIM_CONTAINER__CHILDREN;
				default: return -1;
			}
		}
		if (baseClass == Outlayable.class) {
			switch (derivedFeatureID) {
				case ComponentPackage.UIM_DATA_TABLE__PREFERRED_WIDTH: return PanelPackage.OUTLAYABLE__PREFERRED_WIDTH;
				case ComponentPackage.UIM_DATA_TABLE__PREFERRED_HEIGHT: return PanelPackage.OUTLAYABLE__PREFERRED_HEIGHT;
				case ComponentPackage.UIM_DATA_TABLE__FILL_HORIZONTALLY: return PanelPackage.OUTLAYABLE__FILL_HORIZONTALLY;
				case ComponentPackage.UIM_DATA_TABLE__FILL_VERTICALLY: return PanelPackage.OUTLAYABLE__FILL_VERTICALLY;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == UserInteractionElement.class) {
			switch (baseFeatureID) {
				case UimPackage.USER_INTERACTION_ELEMENT__NAME: return ComponentPackage.UIM_DATA_TABLE__NAME;
				case UimPackage.USER_INTERACTION_ELEMENT__UNDER_USER_CONTROL: return ComponentPackage.UIM_DATA_TABLE__UNDER_USER_CONTROL;
				default: return -1;
			}
		}
		if (baseClass == ConstrainedObject.class) {
		...
		if (baseClass == EditableConstrainedObject.class) {
			switch (baseFeatureID) {
				case ConstraintPackage.EDITABLE_CONSTRAINED_OBJECT__EDITABILITY: return ComponentPackage.UIM_DATA_TABLE__EDITABILITY;
				default: return -1;
			}
		}
		if (baseClass == UimContainer.class) {
			switch (baseFeatureID) {
				case ComponentPackage.UIM_CONTAINER__CHILDREN: return ComponentPackage.UIM_DATA_TABLE__CHILDREN;
				default: return -1;
			}
		}
		if (baseClass == Outlayable.class) {
			switch (baseFeatureID) {
				case PanelPackage.OUTLAYABLE__PREFERRED_WIDTH: return ComponentPackage.UIM_DATA_TABLE__PREFERRED_WIDTH;
				case PanelPackage.OUTLAYABLE__PREFERRED_HEIGHT: return ComponentPackage.UIM_DATA_TABLE__PREFERRED_HEIGHT;
				case PanelPackage.OUTLAYABLE__FILL_HORIZONTALLY: return ComponentPackage.UIM_DATA_TABLE__FILL_HORIZONTALLY;
				case PanelPackage.OUTLAYABLE__FILL_VERTICALLY: return ComponentPackage.UIM_DATA_TABLE__FILL_VERTICALLY;
				default: return -1;
			}
		}
