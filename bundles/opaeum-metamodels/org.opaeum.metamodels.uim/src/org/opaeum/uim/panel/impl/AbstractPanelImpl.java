...
public abstract class AbstractPanelImpl extends UimContainerImpl implements AbstractPanel {
	...
	public void setUmlElementUid(String newUmlElementUid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PanelPackage.ABSTRACT_PANEL__UML_ELEMENT_UID, oldUmlElementUid, umlElementUid));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == UmlReference.class) {
			switch (derivedFeatureID) {
				case PanelPackage.ABSTRACT_PANEL__UML_ELEMENT_UID: return UimPackage.UML_REFERENCE__UML_ELEMENT_UID;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == UmlReference.class) {
			switch (baseFeatureID) {
				case UimPackage.UML_REFERENCE__UML_ELEMENT_UID: return PanelPackage.ABSTRACT_PANEL__UML_ELEMENT_UID;
				default: return -1;
			}
		}
		if (baseClass == LabeledElement.class) {
