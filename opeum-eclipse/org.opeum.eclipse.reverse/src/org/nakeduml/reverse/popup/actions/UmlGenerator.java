...
import net.sf.opeum.emf.extraction.NameSpaceExtractor;
import net.sf.opeum.emf.reverse.EmfElementCreator;
...
public class UmlGenerator{
	...
	private Property createAttribute(Classifier cls,PropertyDescriptor pd){
		...
		if(cls instanceof Interface){
			...
			attr = ((org.eclipse.uml2.uml.Class) cls).getOwnedAttribute(pd.getName(), factory.getClassifierFor(pd.getType()), false,UMLPackage.eINSTANCE.getProperty(),true);
		}else if(cls instanceof DataType){
