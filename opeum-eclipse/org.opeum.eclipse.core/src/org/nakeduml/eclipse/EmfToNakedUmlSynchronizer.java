...
import net.sf.opeum.emf.extraction.StereotypeApplicationExtractor;
...
import net.sf.opeum.feature.Steps;
import net.sf.opeum.feature.TransformationPhase;
import net.sf.opeum.feature.TransformationProcess;
import net.sf.opeum.feature.TransformationProcess.TransformationProgressLog;
import net.sf.opeum.linkage.AbstractModelElementLinker;
import net.sf.opeum.linkage.LinkagePhase;
import net.sf.opeum.linkage.QualifierLogicCalculator;
import net.sf.opeum.linkage.SourcePopulationResolver;
import net.sf.opeum.metamodel.core.INakedRootObject;
import net.sf.opeum.metamodel.core.internal.StereotypeNames;
import net.sf.opeum.metamodel.workspace.INakedModelWorkspace;
import net.sf.opeum.metamodel.workspace.internal.NakedModelWorkspaceImpl;
import net.sf.opeum.validation.ValidationPhase;
import net.sf.opeum.validation.namegeneration.JavaNameRegenerator;
