...
import net.sf.opeum.metamodel.actions.INakedOclAction;
import net.sf.opeum.metamodel.activities.INakedPin;
import net.sf.opeum.metamodel.commonbehaviors.INakedOpaqueBehavior;
import net.sf.opeum.metamodel.core.INakedClassifier;
import net.sf.opeum.metamodel.core.INakedElement;
import net.sf.opeum.metamodel.core.INakedOperation;
import net.sf.opeum.metamodel.core.INakedParameter;
import net.sf.opeum.metamodel.core.INakedProperty;
import net.sf.opeum.metamodel.core.INakedValueSpecification;
